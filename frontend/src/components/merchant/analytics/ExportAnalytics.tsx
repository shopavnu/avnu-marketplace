...
const ExportAnalytics: React.FC<ExportAnalyticsProps> = ({ filters, analyticsData }) => {
  ...
  const convertToCSV = (data: any): string => {
    ...
    // Top products data
    const productHeaders = ['Product ID', 'Product Name', 'Revenue', 'Orders', 'Views', 'Clicks', 'Conversion Rate', 'Click-Through Rate'];
  ...
  return (
    <div className="bg-white shadow rounded-lg p-4">
      <h2 className="text-lg font-medium text-gray-700 mb-4">Export Analytics</h2>
