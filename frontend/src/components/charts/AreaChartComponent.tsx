        ...
        >
          <defs>
            <linearGradient id="colorPrimary" x1="0" y1="0" x2="0" y2="1">
              <stop offset="5%" stopColor={primaryGradientFrom} stopOpacity={0.9}/>
              <stop offset="95%" stopColor={primaryGradientTo} stopOpacity={0.3}/>
            </linearGradient>
            <linearGradient id="colorSecondary" x1="0" y1="0" x2="0" y2="1">
              <stop offset="5%" stopColor={secondaryGradientFrom} stopOpacity={0.9}/>
              <stop offset="95%" stopColor={secondaryGradientTo} stopOpacity={0.3}/>
            </linearGradient>
          </defs>
          ...
          <Tooltip 
            ...
            cursor={{ stroke: brandColors.charcoal, strokeOpacity: 0.5, strokeWidth: 1, strokeDasharray: '5 5' }}
          />
          <Legend 
          ...
          {secondaryYKey && (
            <Area
              ...
              stackId={stackedAreas ? "stack" : undefined}
              activeDot={{ r: 6, fill: secondaryColor, stroke: '#FFFFFF', strokeWidth: 2 }}
              animationDuration={1200}
              animationEasing="ease-in-out"
