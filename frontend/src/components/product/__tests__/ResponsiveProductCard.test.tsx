...
describe('ResponsiveProductCard Component', () => {
  ...
  const mockProducts = {
    complete: {
      ...
      description: 'This is a complete product description with all the necessary details that a customer might want to know.',
      price: 19.99,
    ...
    longContent: {
      id: 'product-3',
      title: 'This is an extremely long product title that should be truncated to maintain consistent card height across all products',
      description: 'This is an extremely long product description that contains a lot of information and should be truncated to maintain consistent card height. It includes details about the product features, specifications, materials, and other important information that a customer might want to know.',
      price: 99.99,
      images: ['https://example.com/image.jpg'],
      categories: ['category-1'],
      merchantId: 'merchant-1',
  ...
  it('renders product with complete information correctly', () => {
    ...
    expect(screen.getByText('Test Product with Complete Information')).toBeInTheDocument();
  ...
  it('handles long content by truncating appropriately', () => {
    ...
    const description = screen.getByText(/This is an extremely long product description/);
    ...
    expect(description.textContent).not.toEqual(mockProducts.longContent.description);
  });
