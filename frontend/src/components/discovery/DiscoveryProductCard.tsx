...
interface DiscoveryProductCardProps {
  product: any; // Using any to accommodate both Product and DiscoveryProduct types
...
const DiscoveryProductCard: React.FC<DiscoveryProductCardProps> = ({
  ...
  return (
    <div className="h-[360px] bg-white rounded-xl sm:rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 group">
      <Link
        href={`/product/${product.id}`}
        className="block h-full flex flex-col"
      >
        <div className="relative w-full h-[200px] overflow-hidden flex-shrink-0 bg-gray-50">
          ...
          <div className="absolute top-3 left-3 flex flex-col gap-2">
            {sectionType === SectionType.NEW_ARRIVALS && (
