 ...
 */
const VerticalConsistentProductCard: React.FC<
  VerticalConsistentProductCardProps
> = ({ product, badges, priority = false }) => {
          ...
          >
            ...
            {mounted && product.rating && (
              <div style={{ display: "flex", alignItems: "center" }}>
                ...
                <span
                  style={{ fontSize: "12px", color: "#666", marginLeft: "2px" }}
                >
