 ...
 */
const FixedHeightProductCard: React.FC<FixedHeightProductCardProps> = ({ product, badges }) => {
      ...
      >
        ...
        <div className="relative w-full h-full">
          ...
          >
            ...
            {/* Title - fixed height */}
            <div style={{ height: '40px', overflow: 'hidden', marginTop: '8px' }}>
            ...
            {/* Price - fixed height */}
            <div style={{ height: '24px', overflow: 'hidden', marginTop: '8px' }}>
