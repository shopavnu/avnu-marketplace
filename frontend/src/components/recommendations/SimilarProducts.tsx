...
const SimilarProducts: React.FC<SimilarProductsProps> = ({
  ...
  if (loading) {
    return (
      <div className="similar-products-container" data-testid="similar-products-loading">
  ...
  if (error) {
    return (
      <div className="similar-products-error" data-testid="similar-products-error">
  ...
  if (similarProducts.length === 0) {
    return (
      <div className="similar-products-empty" data-testid="similar-products-empty">
  ...
  return (
    <div className="similar-products-container" data-testid="similar-products-container">
      <h2 className="similar-products-title">{title}</h2>
      <div className="similar-products-grid">
