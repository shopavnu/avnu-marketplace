...
describe('RecentlyViewedProducts Component', () => {
  ...
  it('should render recently viewed products when loaded', async () => {
    mockProductService.getProductsByIds = jest.fn().mockResolvedValue(mockProducts);
  ...
  it('should respect excludeProductId prop', async () => {
    mockProductService.getProductsByIds = jest.fn().mockResolvedValue([mockProducts[0]]);
    ...
    await waitFor(() => {
      expect(mockProductService.getProductsByIds).toHaveBeenCalledWith(['product-2', 'product-3']);
    });
  });
  ...
  it('should render error state when API call fails', async () => {
    mockProductService.getProductsByIds = jest.fn().mockRejectedValue(new Error('API error'));
