...
const generateMoreProducts = (baseProducts: Product[]): Product[] => {
  ...
  for (let i = 0; i < 5; i++) {
    // Increased from 3 to 5 for more products
    baseProducts.forEach((product, index) => {
      ...
      const isSustainable =
        product.vendor?.isSustainable || Math.random() > 0.7;
      ...
      moreProducts.push({
        ...
        price:
          Math.round(product.price * (0.9 + Math.random() * 0.3) * 100) / 100,
        salePrice,
...
const baseProducts: Product[] = [
  {
    ...
    brand: "Terra & Clay",
    description:
      "Minimalist ceramic vase with organic textures, handcrafted by artisans using traditional techniques. Each piece is unique with subtle variations in glaze and form.",
    price: 89.0,
    image:
  ...
  },
  {
    ...
    brand: "Pure Living",
    description:
      "100% organic linen throw blanket, GOTS certified and ethically made. Perfect for all seasons with its breathable, temperature-regulating properties.",
    price: 129.0,
    salePrice: 109.0,
    image:
  ...
  },
  {
    ...
    brand: "Fiber & Folk",
    description:
      "Contemporary macrame wall art handcrafted by skilled artisans. Each piece is individually made using traditional knotting techniques with a modern design aesthetic.",
    price: 245.0,
    image:
  ...
  },
  {
    ...
    brand: "Lumière",
    description:
      "Modern brass table lamp with hand-blown glass shade. Features energy-efficient LED technology and dimming capabilities for customizable lighting ambiance.",
    price: 329.0,
    image:
  ...
  },
  {
    ...
    brand: "Pure Living",
    description:
      "GOTS certified organic cotton pillowcases with a 400 thread count for luxurious comfort. Naturally hypoallergenic and free from harmful chemicals for a healthier sleep environment.",
    price: 79.0,
    salePrice: 59.0,
    image:
      "https://images.unsplash.com/photo-1584100936595-c0654b55a2e2?auto=format&q=80&fit=crop&w=800",
    ...
    attributes: {
      ...
      sustainabilityFeatures:
        "GOTS certified, plastic-free packaging, fair trade",
    },
    isNew: false,
    isFeatured: false,
    isTrending: true,
  ...
  },
  {
    ...
    brand: "Forest & Table",
    description:
      "Handcrafted walnut serving board made from sustainably harvested American black walnut. Each board is finished with food-safe oils and features unique grain patterns.",
    price: 95.0,
    image:
    ...
    attributes: {
      ...
      madeIn: "United States",
      sustainabilityFeatures:
        "Sustainably harvested wood, plant-based finishes",
    },
    isNew: true,
    isFeatured: false,
    isTrending: false,
  ...
  },
  {
    ...
    brand: "Fiber & Folk",
    description:
      "Artisanal wool rug with geometric patterns, handwoven using traditional techniques. Made with naturally dyed wool from ethically raised sheep.",
    price: 495.0,
    image:
