...
const SimpleCard = ({ product, style = {} }: { product: Product; style?: React.CSSProperties }) => {
  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        <h3 className="text-sm font-medium text-gray-900 mt-1 line-clamp-2">{product.title}</h3>
        {product.description && (
...
const AbsoluteCard = ({ product }: { product: Product }) => {
  return (
    <div className="relative bg-white rounded-xl shadow-sm" style={{ height: '360px' }}>
    ...
    <div className="bg-white rounded-xl shadow-sm" style={{ height: '360px' }}>
      <table className="w-full h-full border-collapse">
        <tbody>
          ...
          <tr>
            <td className="p-4" style={{ height: '160px', verticalAlign: 'top' }}>
              {product.brand && (
                <p className="text-xs text-gray-500 truncate">{product.brand}</p>
              )}
              <h3 className="text-sm font-medium text-gray-900 mt-1 line-clamp-2">{product.title}</h3>
  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <h2 className="text-2xl font-bold mb-4">1. Simple Cards (Natural Height)</h2>
        ...
        <h2 className="text-2xl font-bold mb-4">2. Fixed Height Cards (overflow: hidden)</h2>
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-12">
          {testProducts.map(product => (
        ...
        <h2 className="text-2xl font-bold mb-4">3. Absolute Positioned Cards</h2>
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-12">
          {testProducts.map(product => (
