    ...
    <>
      ...
      <div className="min-h-screen bg-warm-white py-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-charcoal mb-4">Client-Only Test</h1>
            <p className="text-gray-600 mb-2">
              This page only renders content on the client side to avoid hydration mismatches.
            </p>
            {!isClient && (
            ...
            <>
              ...
              <div className="mt-8 p-4 bg-gray-100 rounded-lg">
                ...
                <ul className="list-disc pl-5 text-sm text-gray-700">
                  ...
                  <li>Avoids hydration mismatches by not rendering during SSR</li>
