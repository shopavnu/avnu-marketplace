    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        ...
        <div className="mb-4">
          ...
          <p className="text-gray-600 text-sm mt-1">
            When enabled, products you've already purchased won't appear in
            recommendations.
          </p>
        </div>
        ...
        <div className="mb-4">
          ...
          <p className="text-gray-600 text-sm mt-1">
            Adjust to control how many new products you see versus products
            related to your past interests.
          </p>
        </div>
      </div>
      ...
      <div className="mt-12 bg-blue-50 rounded-lg p-6">
        <h2 className="text-xl font-semibold mb-2">
          About Fresh Recommendations
        </h2>
        <p className="mb-4">
          Our recommendation system now balances showing you products related to
          your interests with introducing you to new, diverse items you might
          not have discovered otherwise.
        </p>
        <p className="mb-4">
          <strong>Freshness:</strong> Controls the balance between showing you
          new products versus products similar to ones you've viewed before. A
          higher freshness value means more new discoveries.
        </p>
        <p>
          <strong>Exclude Purchases:</strong> When enabled, products you've
          already purchased won't appear in your recommendations, making room
          for new items to discover.
        </p>
      </div>
    </div>
  );
