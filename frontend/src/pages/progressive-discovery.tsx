  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Discover products with progressive loading"
        />
      </Head>
          ...
          <section className="mb-12 bg-sage/5 rounded-xl p-8">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-gray-600 mb-6">
                This page demonstrates progressive loading of content as you
                scroll. Only the sections in your viewport (plus a buffer) are
                loaded, and each section loads products progressively to ensure
                smooth performance.
              </p>
