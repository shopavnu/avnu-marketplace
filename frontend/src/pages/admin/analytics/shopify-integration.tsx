    ...
    <AdminLayout title="Shopify Integration Analytics">
      ...
      <Box className="p-6">
        <Alert severity="info" sx={{ mb: 4 }}>
          This dashboard is currently under development. Check back soon for Shopify integration analytics.
        </Alert>
        ...
        <Typography variant="body1">
          This page will track metrics related to Shopify store integrations, sync performance, and cross-platform analytics.
        </Typography>
      </Box>
    </AdminLayout>
  );
