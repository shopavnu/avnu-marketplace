    ...
    <AdminLayout title="Revenue & Financial Analytics">
      ...
      <Box className="p-6">
        <Alert severity="info" sx={{ mb: 4 }}>
          This dashboard is currently under development. Check back soon for financial analytics data.
        </Alert>
        ...
        <Typography variant="body1">
          This page will display revenue metrics, financial performance, and transaction data across the marketplace.
        </Typography>
      </Box>
    </AdminLayout>
  );
