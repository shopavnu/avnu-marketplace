          ...
          <Paper sx={{ p: 3, height: "100%" }}>
            ...
            <Typography variant="h4" color="primary">
              {analyticsData.avgSessionDuration
                ? `${(analyticsData.avgSessionDuration / 60).toFixed(1)} min`
                : "0 min"}
            </Typography>
          </Paper>
        </GridItem>
        ...
        <GridContainer spacing={3}>
          <GridItem xs={12} md={6}>
            <Box sx={{ bgcolor: "#f0f9f0", p: 2, borderRadius: 1 }}>
              ...
              <Typography variant="h5" color="success.main">
                +
                {analyticsData.personalizationImpact?.clickThroughImprovement?.toFixed(
                  1,
                ) || 0}
                %
              </Typography>
          ...
          <GridItem xs={12} md={6}>
            <Box sx={{ bgcolor: "#f0f9f0", p: 2, borderRadius: 1 }}>
              ...
              <Typography variant="h5" color="success.main">
                +
                {analyticsData.personalizationImpact?.conversionImprovement?.toFixed(
                  1,
                ) || 0}
                %
              </Typography>
      ...
      <GridContainer spacing={3} sx={{ mb: 3 }}>
        <GridItem xs={12} md={6}>
          <Paper sx={{ p: 3, height: "100%" }}>
            ...
            <Box sx={{ mt: 2 }}>
              {analyticsData.interactionTypes?.map(
      ...
      <Paper sx={{ p: 3, mb: 3 }}>
        ...
        >
          <Box>
            ...
            <Typography variant="body2" color="textSecondary">
              Check out our performance metrics and user behavior sections for
              in-depth analysis.
            </Typography>
          </Box>
