    ...
    <AdminLayout title="Payment Analytics">
      ...
      <Box className="p-6">
        <Alert severity="info" sx={{ mb: 4 }}>
          This dashboard is currently under development. Check back soon for payment analytics data.
        </Alert>
        ...
        <Typography variant="body1">
          This page will show payment processing metrics, transaction volumes, and financial performance data.
        </Typography>
      </Box>
    </AdminLayout>
  );
