        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold text-charcoal">
                {
                  alerts.filter((alert: Alert) => alert.severity === "HIGH")
                    .length
                }
              </p>
            </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold text-charcoal">
                {
                  alerts.filter((alert: Alert) => alert.severity === "MEDIUM")
                    .length
                }
              </p>
            </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold text-charcoal">
                {
                  alerts.filter((alert: Alert) => alert.severity === "LOW")
                    .length
                }
              </p>
            </div>
              ...
              <div key={alert.id} className="p-6">
                <div className="flex items-start justify-between">
                  <div className="flex items-start space-x-4">
                    <div
                      className={`p-2 rounded-full ${getSeverityClass(alert.severity)}`}
                    >
                    ...
                    <div>
                      ...
                      <div className="mt-2 flex items-center space-x-4">
                        <span
                          className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getSeverityClass(alert.severity)}`}
                        >
                          {alert.severity}
                        </span>
                ...
                {alert.metrics && alert.metrics.length > 0 && (
                  <div className="mt-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      {alert.metrics.map(
                        (metric: AlertMetric, index: number) => (
                          <div
                            key={index}
                          ...
                          >
                            <div className="flex justify-between items-center mb-1">
                              ...
                              <span
                                className={`text-sm font-medium ${metric.changePercentage < 0 ? "text-red-600" : "text-green-600"}`}
                              >
                            ...
                            <div className="mt-2">
                              ...
                              <div className="w-full bg-gray-200 rounded-full h-1.5">
                                <div
                                  ...
                                  style={{
                                    width: `${Math.min(100, Math.abs(metric.changePercentage))}%`,
                                  }}
                                ></div>
                              </div>
                            </div>
                ...
                {/* Affected segments */}
                {alert.affectedSegments &&
                  alert.affectedSegments.length > 0 && (
                    <div className="mt-4">
                      <h4 className="text-sm font-medium text-gray-700 mb-2">
                        Affected Segments
                      </h4>
