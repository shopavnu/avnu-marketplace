    ...
    <AdminLayout title="Search Analytics">
      ...
      <Box className="p-6">
        <Alert severity="info" sx={{ mb: 4 }}>
          This dashboard is currently under development. Check back soon for search analytics data.
        </Alert>
        ...
        <Typography variant="body1">
          This page will provide insights into search patterns, popular queries, and search conversion rates.
        </Typography>
      </Box>
    </AdminLayout>
  );
