...
const ResponsiveTestPageContent = dynamic(
  () =>
    import("../components/product/ResponsiveTestPage").then(
      (mod) => mod.default,
    ),
  { ssr: false },
);
...
const sampleProducts: Product[] = [
  {
    ...
    description:
      "Ergonomic design with premium materials for maximum comfort. Perfect for home office or living room.",
    price: 149.99,
  ...
  },
  {
    ...
    description:
      "Set of 4 handcrafted ceramic mugs. Each piece is unique with subtle variations in glaze and texture.",
    price: 39.99,
  ...
  },
  {
    ...
    description:
      "HD wireless security camera with motion detection, night vision, and two-way audio. Easy to install and connects to your smartphone.",
    price: 79.99,
  ...
  },
  {
    ...
    description:
      "Soft, cozy throw blanket made from 100% organic cotton. Perfect for snuggling on the couch or adding warmth to your bed.",
    price: 59.99,
  ...
  },
  {
    ...
    description:
      "Double-walled insulated water bottle that keeps drinks cold for 24 hours or hot for 12 hours. Leak-proof and eco-friendly.",
    price: 29.99,
  ...
  },
  {
    ...
    description:
      "Premium noise-cancelling headphones with 30-hour battery life. Comfortable over-ear design with memory foam ear cushions.",
    price: 199.99,
    images: ["https://via.placeholder.com/800x800?text=Headphones+Desktop"],
    mobileImages: [
      "https://via.placeholder.com/400x400?text=Headphones+Mobile",
    ],
    tabletImages: [
      "https://via.placeholder.com/600x600?text=Headphones+Tablet",
    ],
