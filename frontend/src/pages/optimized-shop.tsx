...
/**
 * Optimized shop page that uses progressive loading for improved performance
 */
export default function OptimizedShopPage() {
  ...
  // Priority content includes search bar, filters, and first batch of products
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Shop for sustainable and ethical products" />
      </Head>
