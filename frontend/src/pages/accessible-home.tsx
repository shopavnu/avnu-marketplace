  ...
  return (
    ...
    >
      <div ref={mainRef} className="min-h-screen bg-warm-white">
        ...
        >
          <ClientOnly>
            <div style={{ opacity: heroOpacity as any, scale: heroScale as any }}>
              <HeroMasonry />
        ...
        <footer className="py-12 bg-charcoal text-warm-white">
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div>
                <h3 id="footer-shop" className="font-montserrat text-lg mb-4">Shop</h3>
                <ul className="space-y-2 font-inter text-neutral-gray" aria-labelledby="footer-shop">
                  <li><Link href="/shop" className="hover:text-warm-white transition-colors">New Arrivals</Link></li>
                  <li><Link href="/featured" className="hover:text-warm-white transition-colors">Featured</Link></li>
                  <li><Link href="/categories" className="hover:text-warm-white transition-colors">Categories</Link></li>
                  <li><Link href="/brands" className="hover:text-warm-white transition-colors">Brands</Link></li>
                </ul>
              </div>
              <div>
                <h3 id="footer-about" className="font-montserrat text-lg mb-4">About</h3>
                <ul className="space-y-2 font-inter text-neutral-gray" aria-labelledby="footer-about">
                  <li><Link href="/about" className="hover:text-warm-white transition-colors">Our Story</Link></li>
                  <li><Link href="/for-brands" className="hover:text-warm-white transition-colors">For Brands</Link></li>
                  <li><Link href="/blog" className="hover:text-warm-white transition-colors">Blog</Link></li>
                  <li><Link href="/contact" className="hover:text-warm-white transition-colors">Contact</Link></li>
                </ul>
              </div>
              <div>
                <h3 id="footer-newsletter" className="font-montserrat text-lg mb-4">Newsletter</h3>
