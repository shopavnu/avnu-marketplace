    ...
    <>
      ...
      <div className="min-h-screen bg-warm-white py-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-charcoal mb-4">Grid-Only Test</h1>
            <p className="text-gray-600 mb-2">
              This page uses CSS Grid with explicit row heights and no animation components.
            </p>
          </div>
                    ...
                    <div style={{ padding: '16px', flex: '1', display: 'flex', flexDirection: 'column' }}>
                      ...
                      <div style={{ marginTop: 'auto' }}>
                        <p style={{ fontSize: '14px', fontWeight: 500 }}>
                          ...
                          <span className="sr-only">${product.price.toFixed(2)}</span>
                        </p>
                      </div>
                    </div>
                  </Link>
          ...
          <div className="mt-8 p-4 bg-gray-100 rounded-lg">
            ...
            <ul className="list-disc pl-5 text-sm text-gray-700">
              <li>CSS Grid with explicit grid-template-rows instead of gridAutoRows</li>
