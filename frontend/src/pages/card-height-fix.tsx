    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 py-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-4">Card Height Fix</h1>
            <p className="text-gray-600 mb-2">
              This page demonstrates different approaches to fix card height inconsistencies.
            </p>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              {testProducts.map(product => (
                <div key={product.id} className="standard-card w-full h-[360px] bg-white rounded-xl shadow-sm overflow-hidden">
                  <Link href={`/product/${product.id}`} className="block h-full">
                    ...
                    <div className="p-4 h-[160px]">
                      ...
                      <p className="text-sm font-medium text-gray-900 mt-auto">
                        {mounted ? `$${product.price.toFixed(2)}` : <span className="opacity-0">$0.00</span>}
                      </p>
                    </div>
                  </Link>
                </div>
          ...
          <div className="mb-12">
            <h2 className="text-xl font-semibold mb-4">2. CSS Containment Cards</h2>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              {testProducts.map(product => (
                <div 
                  key={product.id} 
                  ...
                  >
                    ...
                    <div style={{ 
                      ...
                      <p style={{ fontSize: '14px', fontWeight: 500 }}>
                        {mounted ? `$${product.price.toFixed(2)}` : <span style={{ opacity: 0 }}>$0.00</span>}
                      </p>
                    </div>
                  </Link>
                </div>
          ...
          <div className="mb-12">
            <h2 className="text-xl font-semibold mb-4">4. Absolute Positioning Cards</h2>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              {testProducts.map(product => (
                <div 
                  key={product.id} 
          ...
          <div className="mt-8 p-4 bg-gray-100 rounded-lg">
            ...
            <ul className="list-disc pl-5 text-sm text-gray-700">
              ...
              <li>CSS containment isolates card layout from parent influences</li>
              <li>Client-side price rendering avoids hydration mismatches</li>
              <li>Different layout techniques (flex, grid, absolute) for comparison</li>
