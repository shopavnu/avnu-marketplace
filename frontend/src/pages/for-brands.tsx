...
export default function ForBrands() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Validate form
    if (!formData.businessName || !formData.email || !formData.website || formData.categories.length === 0) {
  ...
  return (
    <div className="min-h-screen bg-warm-white">
      <Head>
        ...
        <meta name="description" content="Join av | nu marketplace as a brand partner" />
      </Head>
      ...
      <main>
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/2 mb-8 md:mb-0 md:pr-8">
                ...
                >
                  We partner with exceptional independent brands that share our values of quality, sustainability, and authentic craftsmanship.
                </motion.p>
                <motion.div
                  className="space-y-3"
                  initial={{ opacity: 0, y: 20 }}
                ...
                >
                  <div className="flex items-start">
                    ...
                    <p className="text-gray-700">Reach a curated audience of discerning shoppers</p>
                  </div>
                  <div className="flex items-start">
                    <CheckCircleIcon className="w-6 h-6 text-sage mr-2 flex-shrink-0 mt-0.5" />
                    <p className="text-gray-700">Showcase your brand story and values</p>
                  </div>
                  <div className="flex items-start">
                    <CheckCircleIcon className="w-6 h-6 text-sage mr-2 flex-shrink-0 mt-0.5" />
                    <p className="text-gray-700">Seamless integration with your existing e-commerce platform</p>
                  </div>
                  <div className="flex items-start">
                    <CheckCircleIcon className="w-6 h-6 text-sage mr-2 flex-shrink-0 mt-0.5" />
                    <p className="text-gray-700">Join a community of like-minded independent creators</p>
                  </div>
                </motion.div>
              </div>
        ...
        <section className="py-16 max-w-4xl mx-auto px-4">
          <div className="mb-12 text-center">
            <h2 className="font-montserrat text-3xl font-bold text-charcoal mb-4">Apply to Join</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Complete the form below to apply to become a brand partner. Our team will review your application and get back to you within 5 business days.
            </p>
          </div>
                  ...
                  {categories.map(category => (
                    <div key={category.id} className="flex items-center">
                      <input
                        ...
                        onChange={(e) => handleCheckboxChange(e, formData.categories)}
              ...
              <div className="mb-6">
                ...
                <div className="space-y-2">
                  {shippingOptions.map(option => (
                    <div key={option.id} className="flex items-center">
                      ...
                      />
                      <label htmlFor={`shipping-${option.id}`} className="ml-2 text-sm text-gray-700">
                        {option.name}
                      </label>
                    </div>
                  ))}
                ...
                {formData.shippingOption === 'threshold' && (
                  <div className="mt-3 ml-6">
                    <label htmlFor="shippingThreshold" className="block text-sm font-medium text-gray-700 mb-1">
                  ...
                  {causes.map(cause => (
                    <div key={cause.id} className="flex items-center">
                      <input
                        ...
                        onChange={(e) => handleCheckboxChange(e, formData.causes)}
                        className="h-4 w-4 text-sage focus:ring-sage border-gray-300 rounded"
                      />
                      <label htmlFor={`cause-${cause.id}`} className="ml-2 text-sm text-gray-700">
                        {cause.name}
                      </label>
                    </div>
                  ))}
              ...
              <div className="flex justify-center">
                <button
                  ...
                  className={`px-8 py-3 rounded-full font-medium text-white transition-colors ${
                    isSubmitting ? 'bg-gray-400 cursor-not-allowed' : 'bg-sage hover:bg-sage/90'
                  }`}
                >
        ...
        <section className="py-16 bg-sage/5">
          <div className="max-w-4xl mx-auto px-4">
            <h2 className="font-montserrat text-3xl font-bold text-charcoal mb-8 text-center">Frequently Asked Questions</h2>
            
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-xl shadow-sm">
                <h3 className="font-montserrat text-xl font-medium text-charcoal mb-2">What are the requirements to join av | nu?</h3>
                <p className="text-gray-600">
                  We look for brands that align with our values of quality, sustainability, and authentic craftsmanship. 
                  Your products should be well-designed, thoughtfully made, and offer something unique to our customers.
                </p>
              </div>
              
              <div className="bg-white p-6 rounded-xl shadow-sm">
                <h3 className="font-montserrat text-xl font-medium text-charcoal mb-2">How does the integration process work?</h3>
                <p className="text-gray-600">
                  We integrate directly with your existing e-commerce platform (Shopify, WooCommerce, etc.). 
                  This allows us to showcase your products while you maintain control of inventory, fulfillment, and customer service.
                </p>
              </div>
              
              <div className="bg-white p-6 rounded-xl shadow-sm">
                <h3 className="font-montserrat text-xl font-medium text-charcoal mb-2">What are the fees associated with joining?</h3>
                <p className="text-gray-600">
                  We operate on a commission-based model, taking a small percentage of sales generated through our platform. 
                  There are no upfront costs or monthly fees to join. We only succeed when you succeed.
                </p>
              </div>
