...
const AdvertisingPage = () => {
  ...
  const [showBatchConfirmation, setShowBatchConfirmation] =
      ...
      switch (batchAction) {
        case "pause":
          await Promise.all(
            selectedCampaigns.map((id) =>
              updateCampaignStatus({
                variables: { id, status: CampaignStatus.PAUSED },
              }),
            ),
          );
          break;
        case "resume":
          await Promise.all(
            selectedCampaigns.map((id) =>
              updateCampaignStatus({
                variables: { id, status: CampaignStatus.ACTIVE },
              }),
            ),
          );
          break;
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      ...
                      <span className={actionColor}>{actionText}</span> {count}{" "}
                      selected campaign{count !== 1 ? "s" : ""}?
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Manage your advertising campaigns on av|nu marketplace"
        />
      </Head>
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd>
                        <div className="text-lg font-medium text-gray-900">
                          {campaigns
                            .reduce((sum, campaign) => sum + campaign.clicks, 0)
                            .toLocaleString()}
                        </div>
                      </dd>
                    </dl>
            ...
            <div className="overflow-x-auto">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          ...
                          <div className="mt-1 relative pt-1">
                            <div className="overflow-hidden h-2 text-xs flex rounded bg-gray-200">
                              <div
                                style={{
                                  width: `${((campaign.spent / campaign.budget) * 100).toFixed(0)}%`,
                                }}
              ...
              <div className="px-6 py-4 bg-white border-t border-gray-200">
                <div className="text-sm text-gray-700">
                  ...
                  of <span className="font-medium">{campaigns.length}</span>{" "}
                  campaigns
                </div>
              </div>
            </div>
