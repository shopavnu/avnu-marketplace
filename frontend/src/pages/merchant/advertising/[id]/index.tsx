...
const mockPerformanceData = {
  daily: [
    { date: '2025-04-01', impressions: 520, clicks: 28, conversions: 2, spent: 10.45 },
    { date: '2025-04-02', impressions: 480, clicks: 25, conversions: 2, spent: 9.75 },
    { date: '2025-04-03', impressions: 510, clicks: 30, conversions: 3, spent: 11.20 },
    { date: '2025-04-04', impressions: 550, clicks: 32, conversions: 2, spent: 12.10 },
    { date: '2025-04-05', impressions: 490, clicks: 26, conversions: 2, spent: 10.25 },
    { date: '2025-04-06', impressions: 470, clicks: 24, conversions: 1, spent: 9.50 },
    { date: '2025-04-07', impressions: 530, clicks: 31, conversions: 3, spent: 11.80 },
    { date: '2025-04-08', impressions: 560, clicks: 35, conversions: 3, spent: 12.90 },
    { date: '2025-04-09', impressions: 540, clicks: 33, conversions: 2, spent: 12.30 },
    { date: '2025-04-10', impressions: 580, clicks: 36, conversions: 3, spent: 13.20 },
    { date: '2025-04-11', impressions: 600, clicks: 38, conversions: 4, spent: 14.50 },
    { date: '2025-04-12', impressions: 590, clicks: 37, conversions: 3, spent: 13.90 },
    { date: '2025-04-13', impressions: 570, clicks: 34, conversions: 3, spent: 12.80 },
    { date: '2025-04-14', impressions: 610, clicks: 39, conversions: 4, spent: 14.75 },
    { date: '2025-04-15', impressions: 630, clicks: 42, conversions: 5, spent: 15.90 },
  ]
};
...
const CampaignDetailPage = () => {
  ...
  // Query for products
  const { data: productsData, loading: productsLoading } = useQuery(GET_MERCHANT_PRODUCTS, {
    onCompleted: (data) => {
      if (data?.merchantProducts && campaign) {
        // Filter products to only those in the campaign
        const campaignProducts = data.merchantProducts.filter(
          (p: Product) => campaign.productIds.includes(p.id)
        );
  ...
  const [updateCampaignStatus, { loading: statusUpdateLoading }] = useMutation(UPDATE_CAMPAIGN_STATUS, {
    onCompleted: (data) => {
  ...
  const [deleteCampaign, { loading: deleteLoading }] = useMutation(DELETE_AD_CAMPAIGN, {
    onCompleted: () => {
  ...
  const handleStatusChange = (newStatus: 'pause' | 'resume') => {
    ...
    const newStatusValue = newStatus === 'resume' ? CampaignStatus.ACTIVE : CampaignStatus.PAUSED;
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
            ...
            <div className="bg-white shadow overflow-hidden sm:rounded-lg mb-6">
              <div className="px-4 py-5 sm:px-6 flex justify-between items-center">
                <div>
                  <h3 className="text-lg leading-6 font-medium text-gray-900">Campaign Overview</h3>
              ...
              <div className="border-t border-gray-200 px-4 py-5 sm:p-0">
                <dl className="sm:divide-y sm:divide-gray-200">
                  ...
                  <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                      {campaign.type === CampaignType.PRODUCT_PROMOTION ? 'Product Promotion' : 
                       campaign.type === CampaignType.RETARGETING ? 'Retargeting' : 'Brand Awareness'}
                    </dd>
                  </div>
                  <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                  ...
                  <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                      ...
                      <span className="ml-2 text-gray-500">
                        (${campaign.spent.toFixed(2)} spent, ${(campaign.budget - campaign.spent).toFixed(2)} remaining)
                      </span>
                    </dd>
                  </div>
                  <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                      {campaign.targetAudience === TargetAudience.ALL ? 'All Visitors' : 
                       campaign.targetAudience === TargetAudience.PREVIOUS_VISITORS ? 'Previous Visitors' : 
                       campaign.targetAudience === TargetAudience.CART_ABANDONERS ? 'Cart Abandoners' : 'Previous Customers'}
                    </dd>
                  </div>
                </dl>
              </div>
              ...
              <div className="border-t border-gray-200">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-6">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <p className="mt-1 text-3xl font-semibold text-gray-900">{campaign.impressions.toLocaleString()}</p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <p className="text-sm font-medium text-gray-500">Clicks</p>
                    <p className="mt-1 text-3xl font-semibold text-gray-900">{campaign.clicks.toLocaleString()}</p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <p className="text-sm font-medium text-gray-500">CTR</p>
                    <p className="mt-1 text-3xl font-semibold text-gray-900">{campaign.ctr.toFixed(2)}%</p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <p className="text-sm font-medium text-gray-500">Conversions</p>
                    <p className="mt-1 text-3xl font-semibold text-gray-900">{campaign.conversions.toLocaleString()}</p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <p className="text-sm font-medium text-gray-500">Conversion Rate</p>
                    <p className="mt-1 text-3xl font-semibold text-gray-900">{campaign.conversionRate.toFixed(2)}%</p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <p className="text-sm font-medium text-gray-500">Spent</p>
                    <p className="mt-1 text-3xl font-semibold text-gray-900">${campaign.spent.toFixed(2)}</p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <p className="text-sm font-medium text-gray-500">ROI</p>
                    <p className="mt-1 text-3xl font-semibold text-gray-900">{campaign.roi.toFixed(1)}x</p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="px-6 pb-6">
                  <div className="flex justify-between items-center mb-4">
                    <h4 className="text-md font-medium text-gray-900">Performance Over Time</h4>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg h-64 flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="mt-2 text-sm text-gray-500">
                        Performance chart would be rendered here with actual data.
                      </p>
                      <p className="text-xs text-gray-400">
                        Using {performanceTimeframe} data from {formatDate(campaign.startDate)} to {formatDate(campaign.endDate)}
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-white shadow overflow-hidden sm:rounded-lg mb-6">
              <div className="px-4 py-5 sm:px-6">
                <h3 className="text-lg leading-6 font-medium text-gray-900">Promoted Products</h3>
                <p className="mt-1 max-w-2xl text-sm text-gray-500">
              ...
              <div className="border-t border-gray-200">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 p-6">
                  {selectedProducts.map((product) => (
                    <div key={product.id} className="border rounded-lg p-4 flex items-start space-x-4">
            ...
            <div className="bg-white shadow overflow-hidden sm:rounded-lg mb-6">
              <div className="px-4 py-5 sm:px-6">
                <h3 className="text-lg leading-6 font-medium text-gray-900">Targeting Settings</h3>
                <p className="mt-1 max-w-2xl text-sm text-gray-500">
                  ...
                  <div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <div className="flex flex-wrap gap-2 mb-4">
                        {campaign.targetDemographics && campaign.targetDemographics.length > 0 ? (
                          ...
                          <span className="text-sm text-gray-500">All age ranges</span>
                        )}
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <div className="flex flex-wrap gap-2">
                        {campaign.targetLocations && campaign.targetLocations.length > 0 ? (
                          ...
                          <span className="text-sm text-gray-500">Global targeting</span>
                        )}
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <div className="flex flex-wrap gap-2">
                        {campaign.targetInterests && campaign.targetInterests.length > 0 ? (
                          ...
                          <span className="text-sm text-gray-500">No specific interests targeted</span>
                        )}
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <span className="px-2 py-1 bg-indigo-100 text-indigo-800 text-xs rounded-full">
                        {campaign.targetAudience === 'all' ? 'All Visitors' : 
                         campaign.targetAudience === 'previous_visitors' ? 'Previous Visitors' : 
                         campaign.targetAudience === 'cart_abandoners' ? 'Cart Abandoners' : 'Previous Customers'}
                      </span>
                    </div>
                  </div>
                </div>
