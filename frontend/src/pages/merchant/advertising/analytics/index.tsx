                ...
                <div className="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
                  ...
                  <PerformanceMetricCard
                    ...
                    change={getPerformanceChange(
                      ...
                      analyticsData.previousPeriod.totalImpressions,
                    )}
                  ...
                  <PerformanceMetricCard
                    ...
                    change={getPerformanceChange(
                      ...
                      analyticsData.previousPeriod.totalClicks,
                    )}
                    icon={
                  ...
                  <PerformanceMetricCard
                    ...
                    change={getPerformanceChange(
                      ...
                      analyticsData.previousPeriod.totalConversions,
                    )}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <div className="mt-2 flex items-baseline">
                        ...
                        <p
                          className={`ml-2 text-sm ${analyticsData.ctr > analyticsData.previousPeriod.ctr ? "text-green-600" : "text-red-600"}`}
                        >
                          {analyticsData.ctr >
                          analyticsData.previousPeriod.ctr ? (
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <div className="mt-2 flex items-baseline">
                        ...
                        <p
                          className={`ml-2 text-sm ${analyticsData.conversionRate > analyticsData.previousPeriod.conversionRate ? "text-green-600" : "text-red-600"}`}
                        >
                          {analyticsData.conversionRate >
                          analyticsData.previousPeriod.conversionRate ? (
                            <ArrowUpIcon className="inline h-4 w-4 mr-1" />
                          ) : (
                            <ArrowDownIcon className="inline h-4 w-4 mr-1" />
                          )}
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <div className="mt-2 flex items-baseline">
                        ...
                        <p
                          className={`ml-2 text-sm ${analyticsData.roi > analyticsData.previousPeriod.roi ? "text-green-600" : "text-red-600"}`}
                        >
                          {analyticsData.roi >
                          analyticsData.previousPeriod.roi ? (
                            <ArrowUpIcon className="inline h-4 w-4 mr-1" />
                          ) : (
                            <ArrowDownIcon className="inline h-4 w-4 mr-1" />
                          )}
