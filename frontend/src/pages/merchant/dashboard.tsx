  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Merchant dashboard for av|nu marketplace"
        />
      </Head>
                ...
                <div className="bg-gray-50 px-5 py-3">
                  <div className="text-sm">
                    <div className="font-medium text-sage truncate flex items-center">
                      ...
                      <span
                        className={`px-2 py-1 text-xs rounded-full ${stat.color}`}
                      >
            ...
            <div className="bg-white shadow rounded-lg">
              <div className="px-5 py-4 border-b border-gray-200 flex items-center justify-between">
                ...
                <Link
                  ...
                  className="text-sm font-medium text-sage hover:text-sage/80 flex items-center"
                >
                  View all
