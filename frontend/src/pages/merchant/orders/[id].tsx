        ...
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="sm:flex sm:items-center sm:justify-between">
            <div className="flex items-center">
              ...
              <h1 className="text-2xl font-semibold text-gray-900">Order {orderData.id}</h1>
            </div>
          ...
          <div className="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-3">
              ...
              <div className="bg-white shadow rounded-lg overflow-hidden">
                <div className="px-4 py-5 sm:px-6 border-b border-gray-200 flex justify-between items-center">
                  ...
                  <div className="flex space-x-2">
                    ...
                    <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${getPaymentStatusColor(orderData.paymentStatus)}`}>
                ...
                <div className="px-4 py-5 sm:p-6">
                  <div className="flex flex-wrap gap-3">
                    <button
                      type="button"
                      disabled={isUpdatingStatus || orderStatus === 'Processing'}
                  ...
                  {orderData.trackingNumber && (
                    <div className="mt-4">
                      <p className="text-sm font-medium text-gray-500">Tracking Information</p>
                          ...
                          <div className="ml-4 flex-1 flex flex-col">
                            <div>
                              <div className="flex justify-between text-base font-medium text-gray-900">
                                <h3>
                                  <Link href={`/merchant/products/${item.id}`} className="hover:text-sage">
                                    {item.name}
                                  </Link>
                                </h3>
                  ...
                  <div className="flow-root">
                    ...
                    {orderData.discount > 0 && (
                      <div className="flex justify-between text-sm mt-2">
                        ...
                        <p className="font-medium text-green-600">-${orderData.discount.toFixed(2)}</p>
                      </div>
                    )}
                    <div className="flex justify-between text-base font-medium mt-4 pt-4 border-t border-gray-200">
                      <p className="text-gray-900">Total</p>
                      <p className="text-gray-900">${orderData.total.toFixed(2)}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white shadow rounded-lg overflow-hidden">
                ...
                <div className="px-4 py-5 sm:p-6">
                  <div className="text-sm">
                    ...
                    <p className="text-gray-500 mt-1">{orderData.customerEmail}</p>
                    {orderData.customerPhone && (
                      <p className="text-gray-500 mt-1">{orderData.customerPhone}</p>
                    )}
                    <div className="mt-4">
                      <Link 
                        href="#" 
              ...
              <div className="bg-white shadow rounded-lg overflow-hidden">
                ...
                <div className="px-4 py-5 sm:p-6">
                  <div className="flex items-center">
                    <TruckIcon className="h-5 w-5 text-gray-400 mr-2" aria-hidden="true" />
                    <span className="text-sm text-gray-900">{orderData.shippingMethod}</span>
                  </div>
                  <div className="mt-4">
          ...
          <div className="mt-6 bg-white shadow rounded-lg overflow-hidden">
            <div className="px-4 py-5 sm:px-6 border-b border-gray-200">
              <h3 className="text-lg font-medium leading-6 text-gray-900">Order Timeline</h3>
              <p className="mt-1 max-w-2xl text-sm text-gray-500">
