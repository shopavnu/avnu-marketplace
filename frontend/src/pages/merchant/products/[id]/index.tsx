...
const mockProduct = {
  ...
  description:
    "Stylish jacket made from recycled denim materials. Eco-friendly and sustainable fashion choice for the conscious consumer. Features multiple pockets and adjustable cuffs.",
  price: 79.99,
...
const mockMetadata = {
  ...
  metaDescription:
    "Shop our eco-friendly Recycled Denim Jacket made from sustainable materials. Stylish, comfortable, and good for the planet. Free shipping available.",
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content={`Manage ${product.name} on av|nu marketplace`}
        />
      </Head>
