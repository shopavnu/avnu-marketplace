...
const SuppressedProductsPage = () => {
    ...
    selectedIssueType === "All"
      ...
      : products.filter(
          (product) =>
            ...
            product.suppressedFrom.some((issue) =>
              issue.includes(selectedIssueType.toLowerCase()),
            ),
        );
  ...
  const handleBulkEdit = (productIds: string[]) => {
    ...
    alert(
      `Bulk editing ${productIds.length} products (would navigate to bulk edit page)`,
    );
  };
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Manage suppressed products on av|nu marketplace"
        />
      </Head>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-gray-700">
                Products with missing or invalid data that are hidden from
                customers
              </p>
            </div>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-yellow-700">
                  <p>
                    These products are hidden from customers because they're
                    missing key information. Fix the issues to make them visible
                    in the marketplace.
                  </p>
                </div>
              </div>
              ...
              <ul className="divide-y divide-gray-200">
                ...
                {filteredProducts.map((product) => {
                  ...
                  const revalidationState =
                    revalidationStatus[product.id] || "idle";

                  return (
                    <li
                      key={product.id}
                      className={isSelected ? "bg-sage-50" : ""}
                    >
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex space-x-2">
                            <button
                              type="button"
                              onClick={() =>
                                handleRevalidateProduct(product.id)
                              }
