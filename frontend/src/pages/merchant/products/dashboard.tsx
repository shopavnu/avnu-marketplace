  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Manage your products and view performance metrics"
        />
      </Head>
          ...
          {selectedProduct && getSelectedProductMetrics() && (
            <div className="mt-6">
              <ProductMetricsCard
                ...
                conversionRate={
                  getSelectedProductMetrics()!.metrics.conversionRate
                }
              />
            </div>
          )}
                  ...
                  {currentProducts.length > 0 ? (
                    currentProducts.map((product) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm text-gray-900">
                            {product.metrics.views.value.toLocaleString()}
                          </div>
                          <div
                            className={`text-xs ${
                              product.metrics.views.changeType === "increase"
                                ? "text-green-600"
                                : "text-red-600"
                            }`}
                          >
                            {product.metrics.views.changeType === "increase"
                              ? "+"
                              : "-"}
                            {product.metrics.views.change}%
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm text-gray-900">
                            {product.metrics.conversionRate.toFixed(2)}%
                          </div>
