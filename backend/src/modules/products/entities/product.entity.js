...
var Product = (function () {
  ...
  var Product = (_classThis = /** @class */ (function () {
    function Product_1() {
      ...
      this.price =
        ...
        __runInitializers(this, _price_initializers, void 0));
      this.compareAtPrice =
        (__runInitializers(this, _price_extraInitializers),
        __runInitializers(this, _compareAtPrice_initializers, void 0));
      this.images =
        (__runInitializers(this, _compareAtPrice_extraInitializers),
        __runInitializers(this, _images_initializers, void 0));
      this.thumbnail =
        (__runInitializers(this, _images_extraInitializers),
        __runInitializers(this, _thumbnail_initializers, void 0));
      this.categories =
        (__runInitializers(this, _thumbnail_extraInitializers),
        __runInitializers(this, _categories_initializers, void 0));
      this.tags =
      ...
      this.merchantId =
        ...
        __runInitializers(this, _merchantId_initializers, void 0));
      this.brandName =
        (__runInitializers(this, _merchantId_extraInitializers),
        __runInitializers(this, _brandName_initializers, void 0));
      this.isActive =
        (__runInitializers(this, _brandName_extraInitializers),
        __runInitializers(this, _isActive_initializers, void 0));
      this.inStock =
        (__runInitializers(this, _isActive_extraInitializers),
        __runInitializers(this, _inStock_initializers, void 0));
      this.quantity =
        (__runInitializers(this, _inStock_extraInitializers),
        __runInitializers(this, _quantity_initializers, void 0));
      this.values =
        (__runInitializers(this, _quantity_extraInitializers),
        __runInitializers(this, _values_initializers, void 0));
      this.externalId =
        (__runInitializers(this, _values_extraInitializers),
        __runInitializers(this, _externalId_initializers, void 0));
      this.externalSource =
        (__runInitializers(this, _externalId_extraInitializers),
        __runInitializers(this, _externalSource_initializers, void 0));
      this.createdAt =
        (__runInitializers(this, _externalSource_extraInitializers),
  ...
  (function () {
    ...
    _get_isOnSale_decorators = [
      (0, graphql_1.Field)(function () {
        return Boolean;
      }),
    ];
    _get_discountPercentage_decorators = [
      (0, graphql_1.Field)(
        function () {
          return graphql_1.Float;
        },
    ...
    __esDecorate(
      ...
      _get_discountPercentage_decorators,
      {
        ...
        access: {
          has: function (obj) {
            return 'discountPercentage' in obj;
          },
          get: function (obj) {
    ...
    __esDecorate(
      ...
      _compareAtPrice_decorators,
      {
        ...
        access: {
          has: function (obj) {
            return 'compareAtPrice' in obj;
          },
          get: function (obj) {
            return obj.compareAtPrice;
          },
          set: function (obj, value) {
            obj.compareAtPrice = value;
          },
        },
        metadata: _metadata,
      },
      _compareAtPrice_initializers,
      _compareAtPrice_extraInitializers,
    );
    __esDecorate(
      null,
      null,
    ...
    __esDecorate(
      ...
      _thumbnail_initializers,
      _thumbnail_extraInitializers,
    );
    __esDecorate(
      null,
      null,
    ...
    __esDecorate(
      ...
      _merchantId_decorators,
      {
        ...
        access: {
          ...
          set: function (obj, value) {
            obj.merchantId = value;
          },
        },
        metadata: _metadata,
      },
      _merchantId_initializers,
      _merchantId_extraInitializers,
    );
    __esDecorate(
      null,
      null,
      _brandName_decorators,
      {
        kind: 'field',
        name: 'brandName',
        static: false,
      ...
      _brandName_initializers,
      _brandName_extraInitializers,
    );
    __esDecorate(
      null,
      null,
    ...
    __esDecorate(
      ...
      _inStock_initializers,
      _inStock_extraInitializers,
    );
    __esDecorate(
      null,
      null,
      ...
      _quantity_initializers,
      _quantity_extraInitializers,
    );
    __esDecorate(
      null,
      null,
      ...
      _values_initializers,
      _values_extraInitializers,
    );
    __esDecorate(
      null,
      null,
      _externalId_decorators,
      {
        kind: 'field',
        name: 'externalId',
        static: false,
      ...
      _externalId_initializers,
      _externalId_extraInitializers,
    );
    __esDecorate(
      null,
      null,
      _externalSource_decorators,
      {
        kind: 'field',
        name: 'externalSource',
        static: false,
        ...
        access: {
          has: function (obj) {
            return 'externalSource' in obj;
          },
          get: function (obj) {
            return obj.externalSource;
          },
          set: function (obj, value) {
            obj.externalSource = value;
          },
        },
        metadata: _metadata,
      },
      _externalSource_initializers,
      _externalSource_extraInitializers,
    );
    __esDecorate(
      null,
      null,
