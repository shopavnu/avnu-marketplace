...
var SearchService = (function () {
  ...
  var SearchService = (_classThis = /** @class */ (function () {
     ...
     */
    SearchService_1.prototype.searchProducts = function (
      query,
      paginationDto,
      filters,
      sort,
        ...
        return __generator(this, function (_m) {
          switch (_m.label) {
            case 0:
              ...
              (_a = paginationDto.page),
                (page = _a === void 0 ? 1 : _a),
                (_b = paginationDto.limit),
                (limit = _b === void 0 ? 10 : _b);
              (_c = options || {}),
                (_d = _c.enableNlp),
                (enableNlp = _d === void 0 ? false : _d),
                (_e = _c.enablePersonalization),
                (enablePersonalization = _e === void 0 ? false : _e),
                (_f = _c.enableABTesting),
                (enableABTesting = _f === void 0 ? false : _f),
                (_g = _c.enableAnalytics),
                (enableAnalytics = _g === void 0 ? false : _g),
                (_h = _c.personalizationStrength),
                (personalizationStrength = _h === void 0 ? 1.0 : _h),
                (_j = _c.clientId),
                (clientId = _j === void 0 ? this.googleAnalyticsService.generateClientId() : _j),
                (_k = _c.user),
                (user = _k === void 0 ? undefined : _k);
              searchMetadata = {};
              startTime = Date.now();
              nlpData = void 0;
            ...
            case 2:
              ...
              intent =
                typeof nlpResult.intent === 'string'
                  ? nlpResult.intent
                  : ((_l = nlpResult.intent) === null || _l === void 0 ? void 0 : _l.primary) ||
                    'general';
              entities = Array.isArray(nlpResult.entities) ? nlpResult.entities : [];
              nlpData = {
                intent: intent,
            ...
            case 4:
              ...
              searchQuery = this.elasticsearchService.buildProductSearchQuery(
                query,
                filters,
                page,
                limit,
            ...
            case 8:
              return [
                4 /*yield*/,
                this.elasticsearchService.performSearch('products', enhancedQuery),
              ];
            case 9:
              result = _m.sent();
              productIds = result.items.map(function (item) {
                return item.id;
              });
            ...
            case 10:
              ...
              sortedProducts = productIds
                .map(function (id) {
                  return products_1.find(function (product) {
            ...
            case 13:
              ...
              this.logger.warn(
                'Failed to track search in analytics: '.concat(analyticsError_1.message),
              );
              return [3 /*break*/, 14];
            case 14:
              return [
      ...
      return __awaiter(this, arguments, void 0, function (productId, limit) {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              result = _a.sent();
              productIds = result.map(function (item) {
                return item.id;
              });
              // If no products found, return empty array
              if (productIds.length === 0) {
            ...
            case 2:
              ...
              sortedProducts = productIds
                .map(function (id) {
                  return products_2.find(function (product) {
                    return product.id === id;
                  });
                })
                .filter(Boolean);
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 2:
              ...
              sortedProducts = productIds
                .map(function (id) {
                  return products_3.find(function (product) {
                    return product.id === id;
                  });
                })
                .filter(Boolean);
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                this.elasticsearchService.getDiscoveryProducts(userId, limit, values),
              ];
            case 1:
              result = _a.sent();
              productIds = result.map(function (item) {
            ...
            case 2:
              ...
              sortedProducts = productIds
                .map(function (id) {
                  return products_4.find(function (product) {
                    return product.id === id;
                  });
                })
                .filter(Boolean);
     ...
     */
    SearchService_1.prototype.naturalLanguageSearch = function (
      query,
      paginationDto,
      user,
      clientId,
          ...
          switch (_c.label) {
            ...
            case 1:
              ...
              intent =
                typeof nlpResult.intent === 'string'
                  ? nlpResult.intent
                  : ((_b = nlpResult.intent) === null || _b === void 0 ? void 0 : _b.primary) ||
                    'general';
              entities = Array.isArray(nlpResult.entities) ? nlpResult.entities : [];
              this.logger.log(
                'NLP processing complete. Intent: '
                  .concat(intent, ', Entities: ')
              ...
              return [
                2 /*return*/,
                this.searchProducts(query, paginationDto, filters, sort, {
                  enableNlp: true,
            ...
            case 2:
              error_9 = _c.sent();
              this.logger.error(
                'Failed to perform natural language search: '.concat(error_9.message),
              );
              throw error_9;
            case 3:
              return [2 /*return*/];
          ...
          switch (_h.label) {
            case 0:
              ...
              (_a = paginationDto.page),
                ...
                (_b = paginationDto.limit),
                (limit = _b === void 0 ? 10 : _b);
              productsPromise = this.searchProducts(
                query,
                ...
                {
                  enableNlp:
                    (_d = options === null || options === void 0 ? void 0 : options.enableNlp) !==
                      null && _d !== void 0
                      ? _d
                      : false,
                  enablePersonalization:
                    (_e =
                      options === null || options === void 0
                        ? void 0
                        : options.enablePersonalization) !== null && _e !== void 0
                      ? _e
                      : false,
                  enableABTesting:
                    (_f =
                      options === null || options === void 0 ? void 0 : options.enableABTesting) !==
                      null && _f !== void 0
                      ? _f
                      : false,
                  enableAnalytics:
              ...
              return [4 /*yield*/, Promise.all([productsPromise, merchantsPromise, brandsPromise])];
            case 1:
