...
var SearchRelevanceService = function () {
    ...
    var SearchRelevanceService = _classThis = /** @class */ (function () {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    try {
                        ...
                        this.logger.error("Failed to get user preferences for user ".concat(userId, ": ").concat(error.message));
         ...
         */
        SearchRelevanceService_1.prototype.applyScoringProfile = function (query, profileName, user, intent, entities) {
            ...
            if (profile.functions.length > 0 || Object.keys(profile.boostFactors).length > 0) {
                ...
                for (var _i = 0, _a = Object.entries(profile.boostFactors); _i < _a.length; _i++) {
                    var _b = _a[_i], field = _b[0], boost = _b[1];
                    functionScoreQuery.function_score.functions.push(__assign(__assign({}, ({ filter: { exists: { field: field } } })), { weight: boost }));
                }
        ...
        SearchRelevanceService_1.prototype.applyUserPreferenceBoosts = function (query, user) {
            return __awaiter(this, void 0, void 0, function () {
                var preferences, functions, _i, _a, _b, category, weight, _c, _d, _e, brand, weight, _f, _g, _h, value, weight, _j, _k, range;
        ...
        SearchRelevanceService_1.prototype.selectABTestVariant = function (testId, userId) {
            var test = this.activeABTests.find(function (t) { return t.id === testId && t.isActive; });
            if (!test)
                return null;
         ...
         */
        SearchRelevanceService_1.prototype.generateAnalyticsData = function (testInfo, searchQuery, resultCount) {
            return {
        ...
        SearchRelevanceService_1.prototype.getActiveABTests = function () {
            return this.activeABTests.filter(function (test) { return test.isActive; });
        };
