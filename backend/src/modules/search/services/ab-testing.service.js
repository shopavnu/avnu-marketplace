...
var ABTestingService = (function () {
  ...
  var ABTestingService = (_classThis = /** @class */ (function () {
    ...
    ABTestingService_1.prototype.getActiveTests = function () {
      return Array.from(this.activeTests.values()).filter(function (test) {
        return (
          test.isActive &&
    ...
    ABTestingService_1.prototype.assignUserToVariant = function (testId, userId, clientId) {
      ...
      if (userTestAssignments.has(testId)) {
        ...
        var variant_1 = test.variants.find(function (v) {
          return v.id === variantId_1;
        });
        if (variant_1) {
          return {
    ...
    ABTestingService_1.prototype.selectVariantByWeight = function (variants) {
      var totalWeight = variants.reduce(function (sum, variant) {
     ...
     */
    ABTestingService_1.prototype.trackVariantAssignment = function (
      clientId,
      test,
      variantId,
      userId,
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                this.googleAnalyticsService.trackABTestImpression(
                  clientId,
                  test.id,
                  variantId,
                  {
     ...
     */
    ABTestingService_1.prototype.trackSearchResults = function (
      clientId,
      testId,
      variantId,
      searchTerm,
     ...
     */
    ABTestingService_1.prototype.trackSearchClick = function (
      clientId,
      testId,
      variantId,
      searchTerm,
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              return [
                4 /*yield*/,
                this.googleAnalyticsService.trackSearchClick(
                  clientId,
                  searchTerm,
                  productId,
                  position,
