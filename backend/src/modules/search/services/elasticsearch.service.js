...
var ElasticsearchService = (function () {
  ...
  var ElasticsearchService = (_classThis = /** @class */ (function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                this.indexDocument('products', product.id, {
                  id: product.id,
                  title: product.title,
            ...
            case 2:
              error_2 = _a.sent();
              this._logger.error(
                'Failed to index product '.concat(product.id, ': ').concat(error_2.message),
              );
              throw error_2;
            case 3:
              return [2 /*return*/];
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              body = products.flatMap(function (product) {
                return [
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                this.updateDocument('products', product.id, {
                  doc: {
                    title: product.title,
                    description: product.description,
                    price: product.price,
            ...
            case 2:
              error_4 = _a.sent();
              this._logger.error(
                'Failed to update product '.concat(product.id, ': ').concat(error_4.message),
              );
              throw error_4;
            case 3:
              return [2 /*return*/];
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 2:
              error_5 = _a.sent();
              this._logger.error(
                'Failed to delete product '.concat(productId, ': ').concat(error_5.message),
              );
              throw error_5;
            case 3:
              return [2 /*return*/];
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              if (response.suggest) {
                Object.values(response.suggest).forEach(function (suggestionCategory) {
                  if (Array.isArray(suggestionCategory)) {
                    suggestions_1 = suggestions_1.concat(
                      suggestionCategory.flatMap(function (suggestion) {
              ...
              return [
                2 /*return*/,
                suggestions_1.map(function (option) {
                  return option.text;
                }) || [],
              ];
            case 2:
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            ...
            case 1:
              ...
              likeTexts = __spreadArray(
                __spreadArray(
                  [sourceProduct.title, sourceProduct.description],
            ...
            case 3:
              ...
              if (
                error_9 &&
                ((_a = error_9.meta) === null || _a === void 0 ? void 0 : _a.statusCode) === 404
              ) {
                this._logger.warn('Product '.concat(productId, ' not found for related search.'));
                return [2 /*return*/, []];
              }
              this._logger.error(
                'Failed to get related products for '
                  .concat(productId, ': ')
                  .concat(error_9.message),
              );
              throw error_9;
            case 4:
              return [2 /*return*/];
     ...
     */
    ElasticsearchService_1.prototype.buildProductSearchQuery = function (
      query,
      filters,
      page,
      limit,
        ...
        return __generator(this, function (_c) {
          switch (_c.label) {
            ...
            case 2:
              error_12 = _c.sent();
              this._logger.error(
                'Failed to perform search on index '.concat(index, ': ').concat(error_12.message),
              );
              throw error_12;
            case 3:
              return [2 /*return*/];
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                this._client.index({ index: index, id: id, body: body, refresh: refresh }),
              ];
            case 1:
              return [2 /*return*/, _a.sent()];
            case 2:
    ...
    ElasticsearchService_1.prototype.updateDocument = function (index_1, id_1, body_1) {
      return __awaiter(
        ...
        function (
          index,
          id,
          body, // Should contain { doc: ... } or script
          refresh,
        ) {
          var error_16;
          if (refresh === void 0) {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                ...
                return [
                  4 /*yield*/,
                  this._client.update({ index: index, id: id, body: body, refresh: refresh }),
                ];
              case 1:
                return [2 /*return*/, _a.sent()];
              case 2:
            ...
            case 2:
              ...
              this._logger.error(
                'Failed to delete document '
                  .concat(id, ' from index ')
                  .concat(index, ': ')
                  .concat(error_17.message),
              );
              throw error_17;
            case 3:
              return [2 /*return*/];
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            ...
            case 2:
              ...
              if (
                error_19 &&
                typeof error_19 === 'object' &&
                ((_a = error_19.meta) === null || _a === void 0 ? void 0 : _a.statusCode) === 404
              ) {
                return [2 /*return*/, false];
              }
              this._logger.error(
                'Failed to check existence of index '.concat(index, ': ').concat(error_19.message),
              );
              throw error_19;
            case 3:
              return [2 /*return*/];
        ...
        return __generator(this, function (_c) {
          switch (_c.label) {
            case 0:
              ...
              return [3 /*break*/, 3];
            case 1:
              return [4 /*yield*/, this._getMappingForIndex(index)];
            case 2:
              _b = _c.sent();
              _c.label = 3;
            case 3:
            ...
            case 5:
              error_20 = _c.sent();
              this._logger.error(
                'Failed to create index '.concat(index, ': ').concat(error_20.message),
              );
              throw error_20;
            case 6:
              return [2 /*return*/];
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 2:
              error_23 = _a.sent();
              this._logger.error(
                'Failed to update settings for index '.concat(index, ': ').concat(error_23.message),
              );
              throw error_23;
            case 3:
              return [2 /*return*/];
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 2:
              error_24 = _a.sent();
              this._logger.error(
                'Failed to refresh index '.concat(index, ': ').concat(error_24.message),
              );
              throw error_24;
            case 3:
              return [2 /*return*/];
