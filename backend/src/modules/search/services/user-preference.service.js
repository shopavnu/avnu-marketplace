...
var UserPreferenceService = (function () {
  ...
  var UserPreferenceService = (_classThis = /** @class */ (function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 2:
              ...
              _a.label = 3;
            case 3:
              return [4 /*yield*/, this.indexExists(this.interactionsIndex)];
            case 4:
            ...
            case 7:
              error_1 = _a.sent();
              this.logger.error(
                'Failed to initialize user preference indices: '.concat(error_1.message),
              );
              return [3 /*break*/, 8];
            case 8:
              return [2 /*return*/];
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 2:
              error_2 = _a.sent();
              this.logger.error(
                'Error checking if index '.concat(indexName, ' exists: ').concat(error_2.message),
              );
        ...
        return __generator(this, function (_c) {
          switch (_c.label) {
            ...
            case 2:
              ...
              if (
                ((_b = hits === null || hits === void 0 ? void 0 : hits.hits) === null ||
                _b === void 0
                  ? void 0
                  : _b.length) > 0
              ) {
            ...
            case 4:
              error_5 = _c.sent();
              this.logger.error(
                'Failed to get user preferences for '.concat(userId, ': ').concat(error_5.message),
              );
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 6:
              error_6 = _a.sent();
              this.logger.error(
                'Failed to save user preferences for '
                  .concat(preferences.userId, ': ')
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                this.elasticsearchService.exists({
                  index: this.preferencesIndex,
                  id: userId,
                }),
              ];
            ...
            case 2:
              error_7 = _a.sent();
              this.logger.error(
                'Error checking if user preferences exist for '
                  .concat(userId, ': ')
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              switch (interaction.type) {
                ...
                case UserInteractionType.CLICK_BRAND:
                  this.updateFromCategoryOrBrandClick(
                    preferences,
                    interaction.data,
                    interaction.type,
                  );
            ...
            case 3:
              error_9 = _a.sent();
              this.logger.error(
                'Failed to update preferences from interaction: '.concat(error_9.message),
              );
              return [3 /*break*/, 4];
            case 4:
              return [2 /*return*/];
    ...
    UserPreferenceService_1.prototype.updateFromProductView = function (preferences, data) {
      ...
      var existingIndex = preferences.recentlyViewedProducts.findIndex(function (item) {
      ...
      if (data.categories && Array.isArray(data.categories)) {
        data.categories.forEach(function (category) {
          ...
          preferences.categories[categoryLower] =
            (preferences.categories[categoryLower] || 0) + 0.1;
        });
      }
      // Update brand weight
      if (data.brand) {
     ...
     */
    UserPreferenceService_1.prototype.updateFromPurchaseActivity = function (
      preferences,
      data,
      type,
    ) {
    ...
    UserPreferenceService_1.prototype.updateFromFilterApply = function (preferences, data) {
      ...
      if (data.categories && Array.isArray(data.categories)) {
        data.categories.forEach(function (category) {
          var categoryLower = category.toLowerCase();
          preferences.categories[categoryLower] =
            (preferences.categories[categoryLower] || 0) + 0.15;
        });
      }
      ...
      if (data.priceMin !== undefined && data.priceMax !== undefined) {
        var existingRangeIndex = preferences.priceRanges.findIndex(function (range) {
          return range.min === data.priceMin && range.max === data.priceMax;
        });
        if (existingRangeIndex >= 0) {
          ...
          preferences.priceRanges.sort(function (a, b) {
     ...
     */
    UserPreferenceService_1.prototype.updateFromCategoryOrBrandClick = function (
      preferences,
      data,
      type,
    ) {
     ...
     */
    UserPreferenceService_1.prototype.updatePriceRangePreference = function (
      preferences,
      price,
      weight,
    ) {
      ...
      var _loop_1 = function (range) {
        if (price >= range.min && price < range.max) {
          var existingRangeIndex = preferences.priceRanges.findIndex(function (r) {
            return r.min === range.min && r.max === range.max;
          });
          if (existingRangeIndex >= 0) {
            // Update existing range weight
     ...
     */
    UserPreferenceService_1.prototype.applyPreferencesToQuery = function (
      query,
      preferences,
      preferenceWeight,
    ) {
      if (preferenceWeight === void 0) {
      ...
      if (preferences.recentlyViewedProducts.length > 0) {
        var recentProductIds = preferences.recentlyViewedProducts.slice(0, 10).map(function (item) {
