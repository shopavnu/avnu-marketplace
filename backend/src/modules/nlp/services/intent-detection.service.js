    ...
    IntentDetectionService_1.prototype.detectIntent = function (query, tokens) {
      try {
        ...
        if (totalKeywordMatches > 0) {
          ...
          // Sort by confidence
          keywordIntents.sort(function (a, b) {
            return b.confidence - a.confidence;
          });
          if (
            keywordIntents.length > 0 &&
            keywordIntents[0].confidence >= this.confidenceThreshold
          ) {
            return {
        ...
        if (classifications.length > 0 && classifications[0].value >= this.confidenceThreshold) {
          return {
            ...
            subIntents: classifications.slice(1).map(function (c) {
              return { intent: c.label, confidence: c.value };
            }),
          };
        }
    ...
    IntentDetectionService_1.prototype.getSearchParameters = function (intent, entities, query) {
      ...
      switch (intent) {
        ...
        case 'category_browse':
          ...
          var categoryEntities = entities.filter(function (e) {
            return e.type === 'category';
          });
          if (categoryEntities.length > 0) {
            searchParams.filters = __assign(__assign({}, searchParams.filters), {
              categories: categoryEntities.map(function (e) {
                return e.value;
              }),
            });
          }
        ...
        case 'brand_specific':
          ...
          var brandEntities = entities.filter(function (e) {
            return e.type === 'brand';
          });
          if (brandEntities.length > 0) {
            searchParams.filters = __assign(__assign({}, searchParams.filters), {
              brands: brandEntities.map(function (e) {
                return e.value;
              }),
            });
          }
        ...
        case 'price_query':
          ...
          var priceEntities = entities.filter(function (e) {
            return e.type === 'price';
          });
        ...
        case 'value_driven':
          ...
          var valueEntities = entities.filter(function (e) {
            return e.type === 'value';
          });
          if (valueEntities.length > 0) {
            searchParams.filters = __assign(__assign({}, searchParams.filters), {
              values: valueEntities.map(function (e) {
                return e.value;
              }),
            });
          }
          ...
          entities.forEach(function (entity) {
            switch (entity.type) {
              ...
              case 'brand': {
                ...
                searchParams.filters = __assign(__assign({}, searchParams.filters), {
                  brands: __spreadArray(__spreadArray([], brands, true), [entity.value], false),
                });
                break;
              }
              case 'value': {
                ...
                searchParams.filters = __assign(__assign({}, searchParams.filters), {
                  values: __spreadArray(__spreadArray([], values, true), [entity.value], false),
                });
                break;
              }
              case 'price': {
              ...
              case 'color': {
                ...
                searchParams.filters = __assign(__assign({}, searchParams.filters), {
                  colors: __spreadArray(__spreadArray([], colors, true), [entity.value], false),
                });
                break;
              }
              case 'size': {
                ...
                searchParams.filters = __assign(__assign({}, searchParams.filters), {
                  sizes: __spreadArray(__spreadArray([], sizes, true), [entity.value], false),
                });
                break;
              }
              case 'material': {
                ...
                searchParams.filters = __assign(__assign({}, searchParams.filters), {
                  materials: __spreadArray(
                    __spreadArray([], materials, true),
                    [entity.value],
                    false,
                  ),
                });
