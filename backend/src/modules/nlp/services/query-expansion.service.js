    ...
    var QueryExpansionService = _classThis = /** @class */ (function () {
        ...
        QueryExpansionService_1.prototype.expandQuery = function (query, tokens) {
            return __awaiter(this, void 0, void 0, function () {
                var expansionSource, expandedTerms, _i, tokens_1, token, synonyms, wordnetSynonyms, token, elasticsearchTerms, expandedQuery, error_1;
                    ...
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            for (_i = 0, tokens_1 = tokens; _i < tokens_1.length; _i++) {
                                ...
                                if (this.domainSpecificSynonyms[token.toLowerCase()]) {
                                    synonyms = this.domainSpecificSynonyms[token.toLowerCase()].slice(0, this.maxSynonymsPerTerm);
                                    expansionSource[token] = __spreadArray(__spreadArray([], (expansionSource[token] || []), true), synonyms, true);
                                    expandedTerms = __spreadArray(__spreadArray([], expandedTerms, true), synonyms, true);
                                }
                            }
                        ...
                        case 2:
                            ...
                            for (token in wordnetSynonyms) {
                                expansionSource[token] = __spreadArray(__spreadArray([], (expansionSource[token] || []), true), wordnetSynonyms[token], true);
                                expandedTerms = __spreadArray(__spreadArray([], expandedTerms, true), wordnetSynonyms[token], true);
                            }
                        ...
                        case 3:
                            ...
                            if (elasticsearchTerms.length > 0) {
                                ...
                                expandedTerms = __spreadArray(__spreadArray([], expandedTerms, true), elasticsearchTerms, true);
                            }
                            // Deduplicate and limit
                            expandedTerms = __spreadArray([], new Set(expandedTerms), true).slice(0, this.maxExpansionTerms);
                    ...
                    switch (_c.label) {
                        ...
                        case 1:
                            ...
                            if ('aggregations' in response && response.aggregations) {
                                ...
                                aggregations = (_a = anyResponse.body) === null || _a === void 0 ? void 0 : _a.aggregations;
                            }
                            buckets = ((_b = aggregations === null || aggregations === void 0 ? void 0 : aggregations.significant_terms) === null || _b === void 0 ? void 0 : _b.buckets) || [];
                            return [2 /*return*/, buckets.map(function (bucket) { return bucket.key; }).slice(0, this.maxExpansionTerms)];
                        case 2:
                            error_2 = _c.sent();
                            this.logger.error("Failed to get Elasticsearch related terms: ".concat(error_2.message));
                            return [2 /*return*/, []];
         ...
         */
        QueryExpansionService_1.prototype.buildExpandedQuery = function (originalQuery, expansionTerms) {
        ...
        QueryExpansionService_1.prototype.getExpansionInfo = function (query, tokens) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.expandQuery(query, tokens)];
                        case 1:
                            expansion = _a.sent();
                            return [2 /*return*/, {
                                    originalQuery: query,
