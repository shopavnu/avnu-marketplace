        ...
        return __generator(this, function (_e) {
          switch (_e.label) {
            ...
            case 1:
              ...
              categoryBuckets =
                ((_b =
                  categoryAggregations === null || categoryAggregations === void 0
                    ? void 0
                    : categoryAggregations.categories) === null || _b === void 0
                  ? void 0
                  : _b.buckets) || [];
            ...
            case 2:
              ...
              if ('aggregations' in brandResponse && brandResponse.aggregations) {
                ...
                brandAggregations =
                  (_c = anyResponse.body) === null || _c === void 0 ? void 0 : _c.aggregations;
              }
              brandBuckets =
                ((_d =
                  brandAggregations === null || brandAggregations === void 0
                    ? void 0
                    : brandAggregations.brands) === null || _d === void 0
                  ? void 0
                  : _d.buckets) || [];
              ...
              this.logger.log(
                'Loaded '
                  .concat(this.knownCategories.size, ' categories and ')
                  .concat(this.knownBrands.size, ' brands from Elasticsearch'),
              );
              return [3 /*break*/, 4];
            case 3:
              error_1 = _e.sent();
              this.logger.error(
                'Failed to load entities from Elasticsearch: '.concat(error_1.message),
              );
              return [3 /*break*/, 4];
            case 4:
              return [2 /*return*/];
      ...
      var _loop_1 = function (token) {
        if (this_1.knownCategories.has(token.toLowerCase())) {
          var exists = categories.some(function (cat) {
            return cat.value === token.toLowerCase();
          });
          if (!exists) {
    ...
    EntityRecognitionService_1.prototype.extractBrands = function (query, tokens) {
      ...
      var _loop_3 = function (token) {
        if (this_3.knownBrands.has(token.toLowerCase())) {
          var exists = brands.some(function (brand) {
            return brand.value === token.toLowerCase();
          });
          if (!exists) {
      ...
      var _loop_4 = function (i) {
        ...
        if (this_4.knownBrands.has(bigramValue)) {
          var exists = brands.some(function (brand) {
            return brand.value === bigramValue;
          });
          if (!exists) {
    ...
    EntityRecognitionService_1.prototype.extractValues = function (query, tokens) {
      ...
      var _loop_5 = function (token) {
        if (this_5.knownValues.has(token.toLowerCase())) {
          var exists = values.some(function (val) {
            return val.value === token.toLowerCase();
          });
          if (!exists) {
    ...
    EntityRecognitionService_1.prototype.extractColors = function (query, tokens) {
      ...
      var _loop_7 = function (token) {
        if (this_7.knownColors.has(token.toLowerCase())) {
          var exists = colors.some(function (col) {
            return col.value === token.toLowerCase();
          });
          if (!exists) {
    ...
    EntityRecognitionService_1.prototype.extractMaterials = function (query, tokens) {
      ...
      var _loop_8 = function (token) {
        if (this_8.knownMaterials.has(token.toLowerCase())) {
          var exists = materials.some(function (mat) {
            return mat.value === token.toLowerCase();
          });
          if (!exists) {
