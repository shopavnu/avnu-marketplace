...
var EnhancedNlpService = (function () {
  ...
  var EnhancedNlpService = (_classThis = /** @class */ (function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              stems = tokens.map(function (token) {
            ...
            case 1:
              ...
              searchParameters = this.intentDetectionService.getSearchParameters(
                intentResult.intent,
                entities,
              );
     ...
     */
    EnhancedNlpService_1.prototype.buildProcessedQuery = function (
      originalQuery,
      tokens,
      entities,
    ) {
