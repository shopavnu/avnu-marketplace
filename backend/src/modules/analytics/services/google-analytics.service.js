...
var GoogleAnalyticsService = (function () {
  ...
  var GoogleAnalyticsService = (_classThis = /** @class */ (function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              _a.trys.push([1, 3, , 4]);
              url = ''
                .concat(this.endpoint, '?measurement_id=')
                .concat(this.measurementId, '&api_secret=')
            ...
            case 2:
              ...
              if (response.status === 204) {
                this.logger.debug(
                  'Successfully sent event "'.concat(event.name, '" to Google Analytics'),
                );
                return [2 /*return*/, true];
              } else {
                this.logger.warn(
                  'Unexpected response from Google Analytics: '.concat(response.status),
                );
                return [2 /*return*/, false];
              }
              return [3 /*break*/, 4];
            case 3:
              error_1 = _a.sent();
              this.logger.error(
                'Failed to send event to Google Analytics: '.concat(error_1.message),
              );
              return [2 /*return*/, false];
            case 4:
              return [2 /*return*/];
     ...
     * @param userId Optional user ID for authenticated users
     */
    GoogleAnalyticsService_1.prototype.trackSearch = function (
      clientId,
      searchTerm,
      resultCount,
      testInfo,
     ...
     * @param userId Optional user ID for authenticated users
     */
    GoogleAnalyticsService_1.prototype.trackSearchClick = function (
      clientId,
      searchTerm,
      productId,
      position,
     ...
     * @param userId Optional user ID for authenticated users
     */
    GoogleAnalyticsService_1.prototype.trackSearchRefinement = function (
      clientId,
      originalSearchTerm,
      refinedSearchTerm,
      filterApplied,
     ...
     * @param userId Optional user ID for authenticated users
     */
    GoogleAnalyticsService_1.prototype.trackABTestImpression = function (
      clientId,
      testId,
      variantId,
      context,
    ...
    GoogleAnalyticsService_1.prototype.generateClientId = function () {
      return (
        'GA1.1.' + Math.floor(Math.random() * 2147483647) + '.' + Math.floor(Date.now() / 1000)
      );
    };
