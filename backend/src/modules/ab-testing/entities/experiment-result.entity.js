...
var ExperimentResult = (function () {
  ...
  var ExperimentResult = (_classThis = /** @class */ (function () {
    function ExperimentResult_1() {
      ...
      this.variantId =
        ...
        __runInitializers(this, _variantId_initializers, void 0));
      this.variant =
        (__runInitializers(this, _variantId_extraInitializers),
        __runInitializers(this, _variant_initializers, void 0));
      this.userId =
      ...
      this.sessionId =
        ...
        __runInitializers(this, _sessionId_initializers, void 0));
      this.resultType =
        (__runInitializers(this, _sessionId_extraInitializers),
        __runInitializers(this, _resultType_initializers, void 0));
      this.value =
        (__runInitializers(this, _resultType_extraInitializers),
        __runInitializers(this, _value_initializers, void 0));
      this.context =
        (__runInitializers(this, _value_extraInitializers),
        __runInitializers(this, _context_initializers, void 0));
      this.metadata =
        (__runInitializers(this, _context_extraInitializers),
        __runInitializers(this, _metadata_initializers, void 0));
      this.timestamp =
        (__runInitializers(this, _metadata_extraInitializers),
        __runInitializers(this, _timestamp_initializers, void 0));
  ...
  (function () {
    ...
    __esDecorate(
      ...
      _variantId_initializers,
      _variantId_extraInitializers,
    );
    __esDecorate(
      null,
      null,
    ...
    __esDecorate(
      ...
      _sessionId_initializers,
      _sessionId_extraInitializers,
    );
    __esDecorate(
      null,
      null,
      ...
      _resultType_initializers,
      _resultType_extraInitializers,
    );
    __esDecorate(
      null,
      null,
    ...
    __esDecorate(
      ...
      _context_initializers,
      _context_extraInitializers,
    );
    __esDecorate(
      null,
      null,
    ...
    __esDecorate(
      ...
      _timestamp_initializers,
      _timestamp_extraInitializers,
    );
    __esDecorate(
      null,
