...
import { createRepositoryFactory, createRepositoryProvider } from '../../../utils/decorator-compatibility';

/**
 * Factory providers for merchant repositories
 */
export const merchantRepositoryFactories = [
  createRepositoryFactory(MerchantAnalytics),
];
