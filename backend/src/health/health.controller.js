          ...
          return [
            ...
            this.health
              .check([
                ...
                function () {
                  return _this.db.pingCheck('database');
                },
                // Memory usage check
                function () {
                  return _this.memory.checkHeap('memory_heap', 200 * 1024 * 1024);
                }, // 200MB
                // Elasticsearch health check
                function () {
                  return _this.http.pingCheck(
                    'elasticsearch',
                    _this.configService.get('ELASTICSEARCH_NODE'),
                  );
                },
