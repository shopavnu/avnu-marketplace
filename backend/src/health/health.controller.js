...
var HealthController = function () {
    ...
    var HealthController = _classThis = /** @class */ (function () {
        function HealthController_1(health, http, db, memory, configService, logger) {
        ...
        HealthController_1.prototype.check = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    return [2 /*return*/, this.health
                            .check([
                            // Database health check
                            function () { return _this.db.pingCheck('database'); },
                            // Memory usage check
                            function () { return _this.memory.checkHeap('memory_heap', 200 * 1024 * 1024); }, // 200MB
                            // Elasticsearch health check
                            function () {
                                return _this.http.pingCheck('elasticsearch', _this.configService.get('ELASTICSEARCH_NODE'));
                            },
                            // Redis health check - if we have a Redis client service, we could use a custom health indicator
                        ])
                            .then(function (result) {
                            _this.logger.debug('Health check completed successfully');
                            return result;
                        })
                            .catch(function (error) {
                            _this.logger.error("Health check failed: ".concat(error.message), error.stack);
                            throw error;
                        })];
                });
            });
