...
export class AddRecommendationTables1714600000000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // Create recommendation_configs table
    await queryRunner.query(`
    ...
    // Insert default recommendation configurations
    await queryRunner.query(`
    ...
    // Update session_interaction_type enum to include recommendation interactions
    await queryRunner.query(`
