...
if (typeof globalThis.crypto === 'undefined') {
  // @ts-ignore - We're explicitly adding crypto to the global scope
  globalThis.crypto = cryptoModule;
}

// Ensure randomUUID is available (used by @nestjs/schedule)
if (typeof globalThis.crypto.randomUUID !== 'function' && typeof cryptoModule.randomUUID === 'function') {
  // @ts-ignore - Adding missing function
