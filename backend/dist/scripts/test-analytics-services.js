...
async function runTests() {
  ...
  const revenueAnalyticsService =
    new merchant_revenue_analytics_service_1.MerchantRevenueAnalyticsService(mockRepository);
  const demographicAnalyticsService =
    new merchant_demographic_analytics_service_1.MerchantDemographicAnalyticsService(
      mockRepository,
    );
