...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, logger, connection, brandIds, brandIdMap, merchantIds, merchantIdMap, elasticsearchModule, error_1, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 25:
                    ...
                    return [3 /*break*/, 28];
                case 26: return [4 /*yield*/, app.close()];
                case 27:
                    _a.sent();
                    return [7 /*endfinally*/];
