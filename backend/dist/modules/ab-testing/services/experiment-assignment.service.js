...
let ExperimentAssignmentService =
  (ExperimentAssignmentService_1 = class ExperimentAssignmentService {
    ...
    async getActiveExperiments(experimentType) {
      try {
        const isValidType = Object.values(experiment_entity_1.ExperimentType).includes(
          experimentType,
        );
        if (!isValidType) {
...
exports.ExperimentAssignmentService =
  ExperimentAssignmentService =
  ExperimentAssignmentService_1 =
    __decorate(
      [
