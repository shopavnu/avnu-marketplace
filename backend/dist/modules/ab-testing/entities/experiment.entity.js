...
__decorate([
    ...
    (0, typeorm_1.Column)({ nullable: true }),
    __metadata("design:type", String)
], Experiment.prototype, "targetAudience", void 0);
__decorate([
    (0, graphql_1.Field)(() => graphql_1.Int, { nullable: true }),
    (0, typeorm_1.Column)({ nullable: true }),
    __metadata("design:type", Number)
], Experiment.prototype, "audiencePercentage", void 0);
__decorate([
    (0, graphql_1.Field)(() => graphql_1.GraphQLISODateTime, { nullable: true }),
    (0, typeorm_1.Column)({ nullable: true }),
    __metadata("design:type", Date)
], Experiment.prototype, "startDate", void 0);
__decorate([
    (0, graphql_1.Field)(() => graphql_1.GraphQLISODateTime, { nullable: true }),
    (0, typeorm_1.Column)({ nullable: true }),
    __metadata("design:type", Date)
], Experiment.prototype, "endDate", void 0);
__decorate([
    (0, graphql_1.Field)(() => String, { nullable: true }),
    (0, typeorm_1.Column)({ nullable: true }),
    __metadata("design:type", String)
], Experiment.prototype, "hypothesis", void 0);
__decorate([
    (0, graphql_1.Field)(() => String, { nullable: true }),
    (0, typeorm_1.Column)({ nullable: true }),
    __metadata("design:type", String)
], Experiment.prototype, "primaryMetric", void 0);
__decorate([
    (0, graphql_1.Field)(() => [String], { nullable: true }),
    (0, typeorm_1.Column)('simple-array', { nullable: true }),
    __metadata("design:type", Array)
], Experiment.prototype, "secondaryMetrics", void 0);
__decorate([
    (0, graphql_1.Field)(() => Boolean),
    (0, typeorm_1.Column)({ default: false }),
    __metadata("design:type", Boolean)
], Experiment.prototype, "hasWinner", void 0);
__decorate([
    (0, graphql_1.Field)(() => String, { nullable: true }),
    (0, typeorm_1.Column)({ nullable: true }),
    __metadata("design:type", String)
], Experiment.prototype, "winningVariantId", void 0);
__decorate([
    (0, graphql_1.Field)(() => String, { nullable: true }),
    (0, typeorm_1.Column)({ type: 'json', nullable: true }),
    __metadata("design:type", String)
], Experiment.prototype, "segmentation", void 0);
__decorate([
    (0, graphql_1.Field)(() => [experiment_variant_entity_1.ExperimentVariant], { nullable: true }),
    (0, typeorm_1.OneToMany)(() => experiment_variant_entity_1.ExperimentVariant, variant => variant.experiment, {
        cascade: true,
        eager: true,
    }),
    __metadata("design:type", Array)
], Experiment.prototype, "variants", void 0);
__decorate([
    (0, graphql_1.Field)(() => graphql_1.GraphQLISODateTime),
    (0, typeorm_1.CreateDateColumn)(),
    __metadata("design:type", Date)
], Experiment.prototype, "createdAt", void 0);
__decorate([
    (0, graphql_1.Field)(() => graphql_1.GraphQLISODateTime),
    (0, typeorm_1.UpdateDateColumn)(),
    __metadata("design:type", Date)
], Experiment.prototype, "updatedAt", void 0);
exports.Experiment = Experiment = __decorate([
    (0, graphql_1.ObjectType)(),
    (0, typeorm_1.Entity)('experiments')
], Experiment);
