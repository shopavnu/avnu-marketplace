...
], AnalyticsDashboardResolver.prototype, "dashboardOverview", null);
__decorate([
    (0, graphql_1.Query)(() => JSON),
    (0, roles_decorator_1.Roles)(user_entity_1.UserRole.ADMIN),
    __param(0, (0, graphql_1.Args)('period', { type: () => graphql_1.Int, defaultValue: 30 })),
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], AnalyticsDashboardResolver.prototype, "searchPerformance", null);
__decorate([
    (0, graphql_1.Query)(() => JSON),
    (0, roles_decorator_1.Roles)(user_entity_1.UserRole.ADMIN),
    __param(0, (0, graphql_1.Args)('period', { type: () => graphql_1.Int, defaultValue: 30 })),
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], AnalyticsDashboardResolver.prototype, "entitySearchPerformance", null);
__decorate([
    (0, graphql_1.Query)(() => JSON),
    (0, roles_decorator_1.Roles)(user_entity_1.UserRole.ADMIN),
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], AnalyticsDashboardResolver.prototype, "userPreferenceAnalytics", null);
__decorate([
    (0, graphql_1.Query)(() => JSON),
    (0, roles_decorator_1.Roles)(user_entity_1.UserRole.ADMIN),
    __metadata("design:type", Function),
    ...
    __metadata("design:returntype", Promise)
], AnalyticsDashboardResolver.prototype, "abTestingAnalytics", null);
__decorate([
    (0, graphql_1.Query)(() => JSON),
    (0, roles_decorator_1.Roles)(user_entity_1.UserRole.ADMIN),
    __param(0, (0, graphql_1.Args)('period', { type: () => graphql_1.Int, defaultValue: 30 })),
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], AnalyticsDashboardResolver.prototype, "personalizationEffectiveness", null);
