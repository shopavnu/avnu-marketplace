...
export declare class AlertsService {
    ...
    constructor(alertRepository: Repository<AlertEntity>, alertMetricRepository: Repository<AlertMetricEntity>, searchAnalyticsService: SearchAnalyticsService, sessionAnalyticsService: SessionAnalyticsService, abTestingService: ABTestingService, configService: ConfigService);
    ...
    createAlert(type: AlertType, title: string, description: string, severity: AlertSeverity, metrics: Partial<AlertMetricEntity>[], affectedSegments?: any[]): Promise<AlertEntity>;
