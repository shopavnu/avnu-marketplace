...
let MultiEntitySearchResolver = (MultiEntitySearchResolver_1 = class MultiEntitySearchResolver {
  ...
  async multiEntitySearch(input, user) {
    this.logger.log(
      ...
      MultiEntitySearchResolver_1.name,
    );
...
__decorate(
  [
    ...
    __metadata('design:paramtypes', [
      entity_specific_filters_input_1.EnhancedSearchInput,
      user_entity_1.User,
    ]),
    __metadata('design:returntype', Promise),
  ],
  MultiEntitySearchResolver.prototype,
  'multiEntitySearch',
  null,
);
exports.MultiEntitySearchResolver =
  MultiEntitySearchResolver =
  MultiEntitySearchResolver_1 =
    __decorate(
      [
