...
__decorate([
    (0, graphql_1.Query)(() => search_response_type_1.SearchResponseType, { name: 'relatedProducts' }),
...
], RelatedProductsResolver.prototype, "getRelatedProducts", null);
__decorate([
    (0, graphql_1.Query)(() => search_response_type_1.SearchResponseType, { name: 'complementaryProducts' }),
    __param(0, (0, graphql_1.Args)('productId')),
    __param(1, (0, graphql_1.Args)('limit', { nullable: true })),
    __param(2, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Number, user_entity_1.User]),
    __metadata("design:returntype", Promise)
], RelatedProductsResolver.prototype, "getComplementaryProducts", null);
__decorate([
    (0, graphql_1.Query)(() => search_response_type_1.SearchResponseType, { name: 'frequentlyBoughtTogether' }),
    __param(0, (0, graphql_1.Args)('productId')),
    __param(1, (0, graphql_1.Args)('limit', { nullable: true })),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Number]),
    __metadata("design:returntype", Promise)
], RelatedProductsResolver.prototype, "getFrequentlyBoughtTogether", null);
