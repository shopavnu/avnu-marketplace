...
let SearchSuggestionResolver = (SearchSuggestionResolver_1 = class SearchSuggestionResolver {
  ...
  async getSuggestions(input, user) {
    this.logger.log(
      ...
      SearchSuggestionResolver_1.name,
    );
...
__decorate(
  [
    (0, graphql_1.Query)(() => search_suggestion_type_1.SearchSuggestionsResponseType, {
    ...
    __metadata('design:paramtypes', [
      search_suggestion_input_1.SearchSuggestionInput,
      user_entity_1.User,
    ]),
    __metadata('design:returntype', Promise),
  ],
  SearchSuggestionResolver.prototype,
  'getSuggestions',
  null,
);
exports.SearchSuggestionResolver =
  SearchSuggestionResolver =
  SearchSuggestionResolver_1 =
    __decorate(
      [
