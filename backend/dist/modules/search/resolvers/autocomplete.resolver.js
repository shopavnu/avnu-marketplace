...
let AutocompleteResolver = class AutocompleteResolver {
    ...
    async trackSuggestionSelection(query, selectedSuggestion, suggestionType, context, user) {
        const userId = user?.id;
        const sessionId = context.req?.headers['x-session-id'] || null;
        await this.autocompleteService.trackSuggestionSelection(query, selectedSuggestion, suggestionType, userId, sessionId);
        return true;
    }
};
exports.AutocompleteResolver = AutocompleteResolver;
__decorate([
    (0, graphql_1.Query)(() => autocomplete_suggestions_type_1.AutocompleteSuggestionsType, { name: 'autocompleteSuggestions' }),
    __param(0, (0, graphql_1.Args)('query')),
    __param(1, (0, graphql_1.Context)()),
    __param(2, (0, graphql_1.Args)('options', { nullable: true })),
    __param(3, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object, autocomplete_options_input_1.AutocompleteOptionsInput,
        user_entity_1.User]),
    __metadata("design:returntype", Promise)
], AutocompleteResolver.prototype, "getAutocompleteSuggestions", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], AutocompleteResolver.prototype, "trackSuggestionSelection", null);
