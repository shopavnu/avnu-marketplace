...
let MultiEntitySearchController = MultiEntitySearchController_1 = class MultiEntitySearchController {
    constructor(nlpSearchService, analyticsService, searchAnalyticsService, entityFacetGenerator, entityRelevanceScorer) {
    ...
    async enhancedProductSearch(query, page, limit, enableNlp, personalized, categoriesStr, tagsStr, valuesStr, brandIdsStr, merchantIdsStr, minPrice, maxPrice, minRating, inStock, onSale, colorsStr, sizesStr, materialsStr, request) {
    ...
    async enhancedMerchantSearch(query, page, limit, enableNlp, personalized, categoriesStr, valuesStr, locationsStr, minRating, verifiedOnly, activeOnly, minProductCount, request) {
        const categories = categoriesStr ? categoriesStr.split(',') : undefined;
        const values = valuesStr ? valuesStr.split(',') : undefined;
    ...
    async enhancedBrandSearch(query, page, limit, enableNlp, personalized, categoriesStr, valuesStr, locationsStr, verifiedOnly, activeOnly, minFoundedYear, maxFoundedYear, minProductCount, request) {
        const categories = categoriesStr ? categoriesStr.split(',') : undefined;
        const values = valuesStr ? valuesStr.split(',') : undefined;
        const locations = locationsStr ? locationsStr.split(',') : undefined;
    ...
    async enhancedMultiEntitySearch(query, page, limit, enableNlp, personalized, productBoost, merchantBoost, brandBoost, request) {
    ...
    convertToSearchOptions(options) {
        const { query, page, limit, enableNlp, personalized, productFilters, merchantFilters, brandFilters, entityBoosting, boostByValues, includeSponsoredContent, experimentId, } = options;
        let filters = [];
        let rangeFilters = [];
        if (productFilters) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [entity_specific_filters_dto_1.EnhancedSearchOptionsDto, Object]),
    __metadata("design:returntype", Promise)
], MultiEntitySearchController.prototype, "enhancedSearch", null);
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'page', required: false, description: 'Page number (0-indexed)' }),
    ...
    (0, swagger_1.ApiQuery)({ name: 'personalized', required: false, description: 'Include personalized results' }),
    (0, swagger_1.ApiQuery)({
        name: 'categories',
        required: false,
    ...
    (0, swagger_1.ApiQuery)({ name: 'values', required: false, description: 'Filter by values (comma-separated)' }),
    (0, swagger_1.ApiQuery)({
        name: 'brandIds',
        required: false,
    ...
    (0, swagger_1.ApiQuery)({ name: 'minPrice', required: false, description: 'Filter by minimum price' }),
    (0, swagger_1.ApiQuery)({ name: 'maxPrice', required: false, description: 'Filter by maximum price' }),
    (0, swagger_1.ApiQuery)({ name: 'minRating', required: false, description: 'Filter by minimum rating' }),
    (0, swagger_1.ApiQuery)({ name: 'inStock', required: false, description: 'Filter by product availability' }),
    (0, swagger_1.ApiQuery)({ name: 'onSale', required: false, description: 'Filter by products on sale' }),
    (0, swagger_1.ApiQuery)({ name: 'colors', required: false, description: 'Filter by colors (comma-separated)' }),
    (0, swagger_1.ApiQuery)({ name: 'sizes', required: false, description: 'Filter by sizes (comma-separated)' }),
    (0, swagger_1.ApiQuery)({
        name: 'materials',
        required: false,
    ...
    __param(3, (0, common_1.Query)('enableNlp', new common_1.DefaultValuePipe(false), common_1.ParseBoolPipe)),
    __param(4, (0, common_1.Query)('personalized', new common_1.DefaultValuePipe(true), common_1.ParseBoolPipe)),
    ...
    __param(10, (0, common_1.Query)('minPrice', new common_1.DefaultValuePipe(undefined), common_1.ParseIntPipe)),
    __param(11, (0, common_1.Query)('maxPrice', new common_1.DefaultValuePipe(undefined), common_1.ParseIntPipe)),
    __param(12, (0, common_1.Query)('minRating', new common_1.DefaultValuePipe(undefined), common_1.ParseIntPipe)),
    __param(13, (0, common_1.Query)('inStock', new common_1.DefaultValuePipe(undefined), common_1.ParseBoolPipe)),
    __param(14, (0, common_1.Query)('onSale', new common_1.DefaultValuePipe(undefined), common_1.ParseBoolPipe)),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Number, Number, Boolean, Boolean, String, String, String, String, String, Number, Number, Number, Boolean, Boolean, String, String, String, Object]),
    __metadata("design:returntype", Promise)
], MultiEntitySearchController.prototype, "enhancedProductSearch", null);
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'activeOnly', required: false, description: 'Filter by active merchants only' }),
    (0, swagger_1.ApiQuery)({
    ...
    __param(8, (0, common_1.Query)('minRating', new common_1.DefaultValuePipe(undefined), common_1.ParseIntPipe)),
    __param(9, (0, common_1.Query)('verifiedOnly', new common_1.DefaultValuePipe(undefined), common_1.ParseBoolPipe)),
    __param(10, (0, common_1.Query)('activeOnly', new common_1.DefaultValuePipe(undefined), common_1.ParseBoolPipe)),
    __param(11, (0, common_1.Query)('minProductCount', new common_1.DefaultValuePipe(undefined), common_1.ParseIntPipe)),
    __param(12, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Number, Number, Boolean, Boolean, String, String, String, Number, Boolean, Boolean, Number, Object]),
    __metadata("design:returntype", Promise)
], MultiEntitySearchController.prototype, "enhancedMerchantSearch", null);
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'activeOnly', required: false, description: 'Filter by active brands only' }),
    (0, swagger_1.ApiQuery)({
        name: 'minFoundedYear',
        required: false,
    ...
    __param(6, (0, common_1.Query)('values')),
    __param(7, (0, common_1.Query)('locations')),
    __param(8, (0, common_1.Query)('verifiedOnly', new common_1.DefaultValuePipe(undefined), common_1.ParseBoolPipe)),
    __param(9, (0, common_1.Query)('activeOnly', new common_1.DefaultValuePipe(undefined), common_1.ParseBoolPipe)),
    __param(10, (0, common_1.Query)('minFoundedYear', new common_1.DefaultValuePipe(undefined), common_1.ParseIntPipe)),
    __param(11, (0, common_1.Query)('maxFoundedYear', new common_1.DefaultValuePipe(undefined), common_1.ParseIntPipe)),
    __param(12, (0, common_1.Query)('minProductCount', new common_1.DefaultValuePipe(undefined), common_1.ParseIntPipe)),
    __param(13, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Number, Number, Boolean, Boolean, String, String, String, Boolean, Boolean, Number, Number, Number, Object]),
    __metadata("design:returntype", Promise)
], MultiEntitySearchController.prototype, "enhancedBrandSearch", null);
__decorate([
    (0, common_1.Get)('all'),
    (0, swagger_1.ApiOperation)({ summary: 'Enhanced search across all entity types with entity boosting' }),
    (0, swagger_1.ApiQuery)({ name: 'query', required: false, description: 'Search query' }),
    (0, swagger_1.ApiQuery)({ name: 'page', required: false, description: 'Page number (0-indexed)' }),
    (0, swagger_1.ApiQuery)({ name: 'limit', required: false, description: 'Items per page (max 100)' }),
    (0, swagger_1.ApiQuery)({
    ...
    (0, swagger_1.ApiQuery)({ name: 'personalized', required: false, description: 'Include personalized results' }),
    (0, swagger_1.ApiQuery)({ name: 'productBoost', required: false, description: 'Boost factor for products' }),
    (0, swagger_1.ApiQuery)({ name: 'merchantBoost', required: false, description: 'Boost factor for merchants' }),
    (0, swagger_1.ApiQuery)({ name: 'brandBoost', required: false, description: 'Boost factor for brands' }),
    (0, swagger_1.ApiResponse)({
        status: 200,
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Number, Number, Boolean, Boolean, Number, Number, Number, Object]),
    __metadata("design:returntype", Promise)
], MultiEntitySearchController.prototype, "enhancedMultiEntitySearch", null);
exports.MultiEntitySearchController = MultiEntitySearchController = MultiEntitySearchController_1 = __decorate([
