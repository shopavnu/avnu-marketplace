...
export declare class SearchIndexListener {
    ...
    constructor(elasticsearchService: ElasticsearchService, elasticsearchIndexingService: ElasticsearchIndexingService, configService: ConfigService, productRepository: Repository<Product>, merchantRepository: Repository<Merchant>, brandRepository: Repository<Brand>, loggerService: LoggerService);
    ...
    handleProductsBulkIndexEvent(payload: {
        productIds: string[];
    }): Promise<void>;
    ...
    handleMerchantsBulkIndexEvent(payload: {
        merchantIds: string[];
    }): Promise<void>;
    ...
    handleBrandsBulkIndexEvent(payload: {
        brandIds: string[];
    }): Promise<void>;
    handleReindexAllEvent(payload: {
        entityType?: string;
    }): Promise<void>;
