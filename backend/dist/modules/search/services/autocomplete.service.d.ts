...
export declare class AutocompleteService {
    ...
    constructor(elasticsearchService: ElasticsearchService, searchAnalyticsService: SearchAnalyticsService, personalizationService: PersonalizationService, abTestingService: AbTestingService);
    getAutocompleteSuggestions(query: string, userId?: string, sessionId?: string, options?: {
        limit?: number;
    ...
    trackSuggestionSelection(query: string, selectedSuggestion: string, suggestionType: string, userId?: string, sessionId?: string): Promise<void>;
}
