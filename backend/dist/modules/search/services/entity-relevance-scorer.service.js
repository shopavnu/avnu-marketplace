...
let EntityRelevanceScorerService =
  (EntityRelevanceScorerService_1 = class EntityRelevanceScorerService {
    constructor(configService) {
      ...
      this.userPreferencesBoostFactor = this.configService.get(
...
exports.EntityRelevanceScorerService =
  EntityRelevanceScorerService =
  EntityRelevanceScorerService_1 =
    __decorate(
