...
], QueryEntity.prototype, "type", void 0);
__decorate([
    (0, graphql_1.Field)(),
    __metadata("design:type", String)
], QueryEntity.prototype, "value", void 0);
...
], QueryFilters.prototype, "categories", void 0);
__decorate([
    (0, graphql_1.Field)(() => graphql_1.Int, { nullable: true }),
    __metadata("design:type", Number)
], QueryFilters.prototype, "priceMin", void 0);
__decorate([
    (0, graphql_1.Field)(() => graphql_1.Int, { nullable: true }),
    __metadata("design:type", Number)
], QueryFilters.prototype, "priceMax", void 0);
__decorate([
    (0, graphql_1.Field)({ nullable: true }),
    __metadata("design:type", String)
], QueryFilters.prototype, "brandName", void 0);
__decorate([
    (0, graphql_1.Field)({ nullable: true }),
    __metadata("design:type", Boolean)
], QueryFilters.prototype, "inStock", void 0);
__decorate([
    (0, graphql_1.Field)(() => [String], { nullable: true }),
    __metadata("design:type", Array)
], QueryFilters.prototype, "values", void 0);
QueryFilters = __decorate([
    (0, graphql_1.ObjectType)()
], QueryFilters);
...
__decorate([
    (0, graphql_1.Field)(),
    __metadata("design:type", String)
], ProcessedQueryResult.prototype, "originalQuery", void 0);
__decorate([
    (0, graphql_1.Field)(),
    __metadata("design:type", String)
], ProcessedQueryResult.prototype, "processedQuery", void 0);
__decorate([
    (0, graphql_1.Field)(() => [String]),
    __metadata("design:type", Array)
], ProcessedQueryResult.prototype, "tokens", void 0);
__decorate([
    (0, graphql_1.Field)(() => [String]),
    __metadata("design:type", Array)
], ProcessedQueryResult.prototype, "stems", void 0);
__decorate([
    (0, graphql_1.Field)(() => [QueryEntity]),
    __metadata("design:type", Array)
], ProcessedQueryResult.prototype, "entities", void 0);
__decorate([
    (0, graphql_1.Field)(),
    __metadata("design:type", String)
], ProcessedQueryResult.prototype, "intent", void 0);
__decorate([
    (0, graphql_1.Field)(() => QueryFilters),
    __metadata("design:type", QueryFilters)
], ProcessedQueryResult.prototype, "filters", void 0);
ProcessedQueryResult = __decorate([
    (0, graphql_1.ObjectType)()
...
__decorate([
    ...
    __metadata("design:type", Array)
], NlpSearchResult.prototype, "items", void 0);
__decorate([
    (0, graphql_1.Field)(() => graphql_1.Int),
    __metadata("design:type", Number)
], NlpSearchResult.prototype, "total", void 0);
__decorate([
    (0, graphql_1.Field)(),
    __metadata("design:type", String)
], NlpSearchResult.prototype, "enhancedQuery", void 0);
__decorate([
    (0, graphql_1.Field)(() => QueryFilters),
    __metadata("design:type", QueryFilters)
], NlpSearchResult.prototype, "detectedFilters", void 0);
NlpSearchResult = __decorate([
    (0, graphql_1.ObjectType)()
], NlpSearchResult);
...
__decorate([
    (0, graphql_1.Field)(() => [String], { nullable: true }),
    __metadata("design:type", Array)
], UserPreferencesInput.prototype, "favoriteCategories", void 0);
__decorate([
    (0, graphql_1.Field)(() => [String], { nullable: true }),
    __metadata("design:type", Array)
], UserPreferencesInput.prototype, "favoriteValues", void 0);
__decorate([
    (0, graphql_1.Field)(() => String, { nullable: true }),
    __metadata("design:type", String)
], UserPreferencesInput.prototype, "priceSensitivity", void 0);
UserPreferencesInput = __decorate([
...
__decorate([
    (0, graphql_1.Field)(() => [String]),
    __metadata("design:type", Array)
], KeywordsResult.prototype, "keywords", void 0);
KeywordsResult = __decorate([
    (0, graphql_1.ObjectType)()
], KeywordsResult);
...
__decorate([
    ...
    __metadata("design:type", Number)
], SimilarityResult.prototype, "similarity", void 0);
SimilarityResult = __decorate([
    (0, graphql_1.ObjectType)()
], SimilarityResult);
...
__decorate([
    (0, graphql_1.Field)(),
    __metadata("design:type", String)
], ClassificationResult.prototype, "category", void 0);
ClassificationResult = __decorate([
    (0, graphql_1.ObjectType)()
...
__decorate([
    (0, graphql_1.Field)(() => graphql_1.Float),
    __metadata("design:type", Number)
], _RelevanceScore.prototype, "score", void 0);
_RelevanceScore = __decorate([
    (0, graphql_1.ObjectType)()
], _RelevanceScore);
let NlpResolver = class NlpResolver {
    ...
    async searchProducts(query, paginationDto) {
        return this.naturalLanguageSearchService.searchProducts(query, paginationDto || { page: 1, limit: 10 });
    }
    analyzeQuery(query) {
    ...
    async getPersonalizedSearchResults(query, userPreferences, paginationDto) {
        return this.naturalLanguageSearchService.getPersonalizedSearchResults(query, userPreferences, paginationDto || { page: 1, limit: 10 });
    }
...
], NlpResolver.prototype, "searchProducts", null);
__decorate([
...
], NlpResolver.prototype, "analyzeQuery", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], NlpResolver.prototype, "generateSearchSuggestions", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], NlpResolver.prototype, "classifySearchQuery", null);
__decorate([
    (0, graphql_1.Mutation)(() => [product_entity_1.Product], { name: 'getRecommendationsFromDescription' }),
    __param(0, (0, graphql_1.Args)('description')),
    __param(1, (0, graphql_1.Args)('limit', { type: () => graphql_1.Int, nullable: true })),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Number]),
    __metadata("design:returntype", Promise)
], NlpResolver.prototype, "getRecommendationsFromDescription", null);
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, UserPreferencesInput,
        pagination_dto_1.PaginationDto]),
    __metadata("design:returntype", Promise)
], NlpResolver.prototype, "getPersonalizedSearchResults", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String, Number]),
    __metadata("design:returntype", void 0)
], NlpResolver.prototype, "extractKeywords", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], NlpResolver.prototype, "calculateSimilarity", null);
