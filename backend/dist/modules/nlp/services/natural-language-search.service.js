...
let NaturalLanguageSearchService =
  (NaturalLanguageSearchService_1 = class NaturalLanguageSearchService {
    ...
    async getPersonalizedSearchResults(query, userPreferences, paginationDto) {
      try {
        ...
        if (
          userPreferences.priceSensitivity &&
          !mergedFilters.priceMin &&
          !mergedFilters.priceMax
        ) {
    ...
    async generateSearchSuggestions(partialQuery, limit = 5) {
      try {
        const basicSuggestions = await this.searchService.getProductSuggestions(
          partialQuery,
          limit,
        );
...
exports.NaturalLanguageSearchService =
  NaturalLanguageSearchService =
  NaturalLanguageSearchService_1 =
    __decorate(
      [
        (0, common_1.Injectable)(),
        __metadata('design:paramtypes', [nlp_service_1.NlpService, search_service_1.SearchService]),
      ],
      NaturalLanguageSearchService,
    );
