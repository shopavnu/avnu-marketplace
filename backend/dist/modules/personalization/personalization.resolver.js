...
let PersonalizationResolver = class PersonalizationResolver {
    ...
    async trackEntityView(entityType, entityId, context) {
        await this.personalizationService.trackInteractionAndUpdatePreferences(context.req.user.id, user_behavior_entity_2.BehaviorType.VIEW, entityId, entityType);
        return true;
    }
    async trackEntityFavorite(entityType, entityId, context) {
        await this.personalizationService.trackInteractionAndUpdatePreferences(context.req.user.id, user_behavior_entity_2.BehaviorType.FAVORITE, entityId, entityType);
        return true;
    }
    async trackSearch(query, context) {
        await this.personalizationService.trackInteractionAndUpdatePreferences(context.req.user.id, user_behavior_entity_2.BehaviorType.SEARCH, query, 'search', query);
        return true;
    }
    async trackAddToCart(context, productId, quantity) {
        const metadata = quantity ? JSON.stringify({ quantity }) : undefined;
        await this.personalizationService.trackInteractionAndUpdatePreferences(context.req.user.id, user_behavior_entity_2.BehaviorType.ADD_TO_CART, productId, 'product', metadata);
        return true;
    }
    async trackPurchase(context, productId, quantity, price) {
        ...
        await this.personalizationService.trackInteractionAndUpdatePreferences(context.req.user.id, user_behavior_entity_2.BehaviorType.PURCHASE, productId, 'product', metadata);
        return true;
    }
    async getPersonalizedRecommendations(context, limit) {
        return this.personalizationService.generatePersonalizedRecommendations(context.req.user.id, limit || 10);
    }
...
__decorate([
    ...
    __metadata("design:paramtypes", [create_user_preferences_dto_1.CreateUserPreferencesDto, Object]),
    __metadata("design:returntype", Promise)
], PersonalizationResolver.prototype, "createUserPreferences", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], PersonalizationResolver.prototype, "getUserPreferences", null);
__decorate([
    (0, graphql_1.Mutation)(() => user_preferences_entity_1.UserPreferences),
    (0, common_1.UseGuards)(gql_auth_guard_1.GqlAuthGuard),
    __param(0, (0, graphql_1.Args)('input')),
    __param(1, (0, graphql_1.Context)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [update_user_preferences_dto_1.UpdateUserPreferencesDto, Object]),
    __metadata("design:returntype", Promise)
], PersonalizationResolver.prototype, "updateUserPreferences", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], PersonalizationResolver.prototype, "trackEntityView", null);
__decorate([
    (0, graphql_1.Mutation)(() => Boolean),
    (0, common_1.UseGuards)(gql_auth_guard_1.GqlAuthGuard),
    __param(0, (0, graphql_1.Args)('entityType')),
    ...
    __metadata("design:paramtypes", [String, String, Object]),
    __metadata("design:returntype", Promise)
], PersonalizationResolver.prototype, "trackEntityFavorite", null);
__decorate([
    (0, graphql_1.Mutation)(() => Boolean),
    (0, common_1.UseGuards)(gql_auth_guard_1.GqlAuthGuard),
    ...
    __metadata("design:returntype", Promise)
], PersonalizationResolver.prototype, "trackSearch", null);
__decorate([
    (0, graphql_1.Mutation)(() => Boolean),
    (0, common_1.UseGuards)(gql_auth_guard_1.GqlAuthGuard),
    __param(0, (0, graphql_1.Context)()),
    ...
    __metadata("design:returntype", Promise)
], PersonalizationResolver.prototype, "trackAddToCart", null);
__decorate([
    (0, graphql_1.Mutation)(() => Boolean),
    (0, common_1.UseGuards)(gql_auth_guard_1.GqlAuthGuard),
    __param(0, (0, graphql_1.Context)()),
    ...
    __metadata("design:returntype", Promise)
], PersonalizationResolver.prototype, "trackPurchase", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], PersonalizationResolver.prototype, "getPersonalizedRecommendations", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], PersonalizationResolver.prototype, "getMostViewedProducts", null);
__decorate([
    (0, graphql_1.Query)(() => [user_behavior_entity_1.UserBehavior]),
    (0, common_1.UseGuards)(gql_auth_guard_1.GqlAuthGuard),
    __param(0, (0, graphql_1.Context)()),
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], PersonalizationResolver.prototype, "getFavoriteProducts", null);
__decorate([
    (0, graphql_1.Query)(() => [user_behavior_entity_1.UserBehavior]),
    (0, common_1.UseGuards)(gql_auth_guard_1.GqlAuthGuard),
    __param(0, (0, graphql_1.Context)()),
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], PersonalizationResolver.prototype, "getRecentSearches", null);
