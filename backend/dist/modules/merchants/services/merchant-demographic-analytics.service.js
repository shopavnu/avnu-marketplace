...
let MerchantDemographicAnalyticsService = MerchantDemographicAnalyticsService_1 = class MerchantDemographicAnalyticsService {
    ...
    async getDemographicAnalytics(merchantId, timeFrame = 'monthly', startDate, endDate, filters) {
        try {
            ...
            const filteredAnalytics = filters && filters.length > 0
...
exports.MerchantDemographicAnalyticsService = MerchantDemographicAnalyticsService = MerchantDemographicAnalyticsService_1 = __decorate([
