...
let AdBudgetManagementService = (AdBudgetManagementService_1 = class AdBudgetManagementService {
  ...
  async recordAdSpend(campaignId, amount, impressionCount = 1) {
    ...
    if (
      budgetExhausted &&
      campaign.status === merchant_ad_campaign_entity_1.CampaignStatus.ACTIVE
    ) {
      await this.adCampaignRepository.update(
        { id: campaignId },
        { status: merchant_ad_campaign_entity_1.CampaignStatus.PAUSED },
      );
...
exports.AdBudgetManagementService =
  AdBudgetManagementService =
  AdBudgetManagementService_1 =
    __decorate(
      [
        (0, common_1.Injectable)(),
        __param(
          0,
          (0, typeorm_1.InjectRepository)(merchant_ad_campaign_entity_1.MerchantAdCampaign),
        ),
