...
], MerchantAdCampaignResolver.prototype, "merchantAdCampaigns", null);
__decorate([
    (0, merchant_only_decorator_1.MerchantOnly)(),
    (0, graphql_1.Query)(() => merchant_ad_campaign_entity_1.MerchantAdCampaign),
    ...
    __metadata("design:returntype", Promise)
], MerchantAdCampaignResolver.prototype, "merchantAdCampaign", null);
__decorate([
    (0, merchant_only_decorator_1.MerchantOnly)(),
    (0, graphql_1.Query)(() => [merchant_ad_campaign_entity_1.MerchantAdCampaign]),
    __param(0, (0, graphql_1.Args)('merchantId', { type: () => graphql_1.ID })),
    ...
    __metadata("design:paramtypes", [String, user_entity_1.User]),
    __metadata("design:returntype", Promise)
], MerchantAdCampaignResolver.prototype, "activeMerchantAdCampaigns", null);
__decorate([
    (0, merchant_only_decorator_1.MerchantOnly)(),
    (0, graphql_1.Query)(() => [merchant_ad_campaign_entity_1.MerchantAdCampaign]),
    __param(0, (0, graphql_1.Args)('merchantId', { type: () => graphql_1.ID })),
    __param(1, (0, graphql_1.Args)('type', { type: () => merchant_ad_campaign_entity_1.CampaignType })),
    __param(2, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, user_entity_1.User]),
    __metadata("design:returntype", Promise)
], MerchantAdCampaignResolver.prototype, "merchantAdCampaignsByType", null);
__decorate([
    (0, merchant_only_decorator_1.MerchantOnly)(),
    (0, graphql_1.Query)(() => [merchant_ad_campaign_entity_1.MerchantAdCampaign]),
    __param(0, (0, graphql_1.Args)('merchantId', { type: () => graphql_1.ID })),
    ...
    __metadata("design:paramtypes", [String, String, user_entity_1.User]),
    __metadata("design:returntype", Promise)
], MerchantAdCampaignResolver.prototype, "merchantAdCampaignsForProduct", null);
__decorate([
    (0, merchant_only_decorator_1.MerchantOnly)(),
    ...
    __param(2, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, dto_1.CreateAdCampaignInput,
        user_entity_1.User]),
    __metadata("design:returntype", Promise)
], MerchantAdCampaignResolver.prototype, "createMerchantAdCampaign", null);
__decorate([
    (0, merchant_only_decorator_1.MerchantOnly)(),
    (0, graphql_1.Mutation)(() => merchant_ad_campaign_entity_1.MerchantAdCampaign),
    __param(0, (0, graphql_1.Args)('id', { type: () => graphql_1.ID })),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, dto_1.UpdateAdCampaignInput,
        user_entity_1.User]),
    __metadata("design:returntype", Promise)
], MerchantAdCampaignResolver.prototype, "updateMerchantAdCampaign", null);
__decorate([
    (0, merchant_only_decorator_1.MerchantOnly)(),
    (0, graphql_1.Mutation)(() => merchant_ad_campaign_entity_1.MerchantAdCampaign),
    __param(0, (0, graphql_1.Args)('id', { type: () => graphql_1.ID })),
    __param(1, (0, graphql_1.Args)('merchantId', { type: () => graphql_1.ID })),
    __param(2, (0, graphql_1.Args)('status', { type: () => merchant_ad_campaign_entity_1.CampaignStatus })),
    __param(3, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String, user_entity_1.User]),
    __metadata("design:returntype", Promise)
], MerchantAdCampaignResolver.prototype, "updateMerchantAdCampaignStatus", null);
__decorate([
    (0, merchant_only_decorator_1.MerchantOnly)(),
    ...
    __metadata("design:paramtypes", [String, String, user_entity_1.User]),
    __metadata("design:returntype", Promise)
], MerchantAdCampaignResolver.prototype, "deleteMerchantAdCampaign", null);
__decorate([
    (0, merchant_only_decorator_1.MerchantOnly)(),
    (0, graphql_1.Mutation)(() => merchant_ad_campaign_entity_1.MerchantAdCampaign),
    __param(0, (0, graphql_1.Args)('merchantId', { type: () => graphql_1.ID })),
    ...
    __metadata("design:returntype", Promise)
], MerchantAdCampaignResolver.prototype, "createRetargetingCampaign", null);
exports.MerchantAdCampaignResolver = MerchantAdCampaignResolver = __decorate([
    ...
    __metadata("design:paramtypes", [merchant_ad_campaign_service_1.MerchantAdCampaignService,
