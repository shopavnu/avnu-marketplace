...
export declare class VendorApplicationStatusController {
    ...
    constructor(_vendorRegistrationService: VendorRegistrationService, _applicationReviewService: ApplicationReviewService, _documentVerificationService: DocumentVerificationService);
    getApplicationStatus(id: string): Promise<ApplicationStatusResponse>;
    getApplicationDetails(id: string, req: {
