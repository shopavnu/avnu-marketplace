...
let VendorDocumentsController = class VendorDocumentsController {
  ...
  async runAutoVerification(id) {
    try {
      ...
      throw new common_1.BadRequestException(
        `Automated verification failed: ${error instanceof Error ? error.message : 'Unknown error'}`,
      );
    }
  }
...
__decorate(
  [
    ...
    __metadata('design:paramtypes', [
      typeof (_a = typeof common_1.UploadedFile !== 'undefined' && common_1.UploadedFile) ===
      'function'
        ? _a
        : Object,
      Object,
  ...
  VendorDocumentsController.prototype,
  'uploadDocument',
  null,
);
__decorate(
