...
let DocumentVerificationService =
  (DocumentVerificationService_1 = class DocumentVerificationService {
    ...
    async areAllDocumentsVerified(applicationId) {
      ...
      return documents.every(
        doc => doc.status === vendor_document_entity_1.DocumentStatus.VERIFIED,
      );
    }
