...
let VendorCreationService = VendorCreationService_1 = class VendorCreationService {
    ...
    async _createVendorEntity(entityManager, application) {
    ...
    async _createBankingDetails(entityManager, vendor, formData) {
    ...
    async _createAddressIfProvided(entityManager, vendor, formData) {
    ...
    async _linkDocumentsToVendor(entityManager, vendorId, applicationId) {
    ...
    async _updateApplicationWithVendorId(entityManager, application, vendorId) {
...
exports.VendorCreationService = VendorCreationService = VendorCreationService_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [VendorRepositories,
