...
export declare class RecommendationController {
    ...
    constructor(productSimilarityService: ProductSimilarityService, enhancedPersonalizationService: EnhancedPersonalizationService);
    getSimilarProducts(productId: string, type?: SimilarityType, limit?: number): Promise<{
        success: boolean;
    ...
    getPersonalizedRecommendations(req: RequestWithUser, limit?: number, refresh?: boolean, excludePurchased?: boolean, freshness?: number): Promise<{
        success: boolean;
        data: import("../../products").Product[];
        meta: {
            count: number;
    ...
    getTrendingProducts(req: RequestWithUser, limit?: number, excludePurchased?: boolean): Promise<{
        success: boolean;
        data: import("../../products").Product[];
        meta: {
            count: number;
