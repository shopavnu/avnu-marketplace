...
exports.RecommendationsModule = RecommendationsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([product_similarity_entity_1.ProductSimilarity, product_recommendation_entity_1.ProductRecommendation, recommendation_config_entity_1.RecommendationConfig]),
            products_module_1.ProductsModule,
            personalization_module_1.PersonalizationModule,
            ab_testing_module_1.AbTestingModule,
        ],
        providers: [product_similarity_service_1.ProductSimilarityService, enhanced_personalization_service_1.EnhancedPersonalizationService, recommendation_resolver_1.RecommendationResolver],
        controllers: [recommendation_controller_1.RecommendationController],
        exports: [product_similarity_service_1.ProductSimilarityService, enhanced_personalization_service_1.EnhancedPersonalizationService],
    })
