...
let EnhancedPersonalizationService =
  (EnhancedPersonalizationService_1 = class EnhancedPersonalizationService {
    constructor(
      productRecommendationRepository,
      recommendationConfigRepository,
    ...
    async generatePersonalizedRecommendations(userId, limit = 10, algorithmId) {
      try {
        const userProfile =
          await this.userPreferenceProfileService.getUserPreferenceProfile(userId);
    ...
    async generateCollaborativeFilteringRecommendations(
      _userId,
      _userProfile,
      _algorithmId,
      _limit,
    ...
    async getUserPurchasedProducts(userId) {
      try {
        const queryBuilder = this.productRecommendationRepository.manager
          ...
          .andWhere('ub.behaviorType = :behaviorType', {
...
exports.EnhancedPersonalizationService =
  EnhancedPersonalizationService =
  EnhancedPersonalizationService_1 =
    __decorate(
      [
        (0, common_1.Injectable)(),
        __param(
          0,
          (0, typeorm_1.InjectRepository)(product_recommendation_entity_1.ProductRecommendation),
        ),
        __param(
          1,
          (0, typeorm_1.InjectRepository)(recommendation_config_entity_1.RecommendationConfig),
        ),
