...
export declare class EnhancedPersonalizationService {
    ...
    constructor(productRecommendationRepository: Repository<ProductRecommendation>, recommendationConfigRepository: Repository<RecommendationConfig>, productSimilarityService: ProductSimilarityService, userPreferenceProfileService: UserPreferenceProfileService, productService: ProductService);
    getPersonalizedRecommendations(userId: string, limit?: number, refresh?: boolean, excludePurchased?: boolean, freshness?: number): Promise<Product[]>;
    getTrendingProducts(userId: string, limit?: number, excludePurchased?: boolean): Promise<Product[]>;
