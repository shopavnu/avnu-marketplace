...
let RecommendationExperimentService = RecommendationExperimentService_1 = class RecommendationExperimentService {
    ...
    async recordEvent(userId, experimentId, variant, event, metadata) {
        this.logger.log(`Experiment event: ${experimentId}, user: ${userId}, variant: ${variant}, event: ${event}`, metadata);
    }
    hashString(str) {
        let hash = 0;
...
exports.RecommendationExperimentService = RecommendationExperimentService = RecommendationExperimentService_1 = __decorate([
