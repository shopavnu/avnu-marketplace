...
export declare class ProductSimilarityService {
    ...
    constructor(productSimilarityRepository: Repository<ProductSimilarity>, productService: ProductService, userBehaviorService: UserBehaviorService);
    calculateAttributeBasedSimilarity(productId: string, limit?: number): Promise<ProductSimilarity[]>;
    ...
    getSimilarProducts(productId: string, similarityType?: SimilarityType, limit?: number): Promise<Product[]>;
