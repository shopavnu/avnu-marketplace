...
let AnonymousUserController = class AnonymousUserController {
    ...
    async getRecentlyViewedProducts(req, res, limit) {
        ...
        const recentlyViewed = await this.anonymousUserService.getRecentlyViewedProducts(req, res, limitNumber);
    ...
    async getPersonalizedRecommendations(req, res, limit) {
        ...
        const recommendedProducts = await this.productsService.getRecommendedProducts(virtualUserId, limitNumber);
...
], AnonymousUserController.prototype, "trackInteraction", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], AnonymousUserController.prototype, "getRecentSearches", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object, Number]),
    __metadata("design:returntype", Promise)
], AnonymousUserController.prototype, "getRecentlyViewedProducts", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object, Number]),
    __metadata("design:returntype", Promise)
], AnonymousUserController.prototype, "getPersonalizedRecommendations", null);
__decorate([
...
], AnonymousUserController.prototype, "clearAnonymousUserData", null);
exports.AnonymousUserController = AnonymousUserController = __decorate([
    (0, common_1.Controller)('api/personalization'),
    __metadata("design:paramtypes", [anonymous_user_service_1.AnonymousUserService,
