...
let PersonalizationController = class PersonalizationController {
    ...
    async trackView(req, entityType, entityId) {
        await this.personalizationService.trackInteractionAndUpdatePreferences(req.user.id, user_behavior_entity_1.BehaviorType.VIEW, entityId, entityType);
        return { success: true };
    }
    async trackFavorite(req, entityType, entityId) {
        await this.personalizationService.trackInteractionAndUpdatePreferences(req.user.id, user_behavior_entity_1.BehaviorType.FAVORITE, entityId, entityType);
        return { success: true };
    }
    async trackSearch(req, body) {
        await this.personalizationService.trackInteractionAndUpdatePreferences(req.user.id, user_behavior_entity_1.BehaviorType.SEARCH, body.query, 'search', body.query);
        return { success: true };
    }
    async trackAddToCart(req, productId, body) {
        const metadata = body.quantity ? JSON.stringify({ quantity: body.quantity }) : undefined;
        await this.personalizationService.trackInteractionAndUpdatePreferences(req.user.id, user_behavior_entity_1.BehaviorType.ADD_TO_CART, productId, 'product', metadata);
        return { success: true };
    }
    async trackPurchase(req, productId, body) {
        ...
        await this.personalizationService.trackInteractionAndUpdatePreferences(req.user.id, user_behavior_entity_1.BehaviorType.PURCHASE, productId, 'product', metadata);
        return { success: true };
    }
    async getRecommendations(req) {
        const productIds = await this.personalizationService.generatePersonalizedRecommendations(req.user.id);
        return { productIds };
    }
    async enhanceSearch(req, body) {
        return this.personalizationService.enhanceSearchWithPersonalization(req.user.id, body.query, body.params);
    }
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'User preferences created successfully' }),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, create_user_preferences_dto_1.CreateUserPreferencesDto]),
    __metadata("design:returntype", Promise)
], PersonalizationController.prototype, "createPreferences", null);
__decorate([
    (0, common_1.Get)('preferences'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get user preferences' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'User preferences retrieved successfully' }),
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], PersonalizationController.prototype, "getPreferences", null);
__decorate([
    (0, common_1.Put)('preferences'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Update user preferences' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'User preferences updated successfully' }),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, update_user_preferences_dto_1.UpdateUserPreferencesDto]),
    __metadata("design:returntype", Promise)
], PersonalizationController.prototype, "updatePreferences", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], PersonalizationController.prototype, "trackView", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, String, String]),
    __metadata("design:returntype", Promise)
], PersonalizationController.prototype, "trackFavorite", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], PersonalizationController.prototype, "trackSearch", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], PersonalizationController.prototype, "trackAddToCart", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, String, Object]),
    __metadata("design:returntype", Promise)
], PersonalizationController.prototype, "trackPurchase", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], PersonalizationController.prototype, "getRecommendations", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], PersonalizationController.prototype, "enhanceSearch", null);
__decorate([
    (0, common_1.Get)('behavior/viewed-products'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get most viewed products' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Most viewed products retrieved successfully' }),
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], PersonalizationController.prototype, "getMostViewedProducts", null);
__decorate([
    (0, common_1.Get)('behavior/favorite-products'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get favorite products' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Favorite products retrieved successfully' }),
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], PersonalizationController.prototype, "getFavoriteProducts", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], PersonalizationController.prototype, "getRecentSearches", null);
