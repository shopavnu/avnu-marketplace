...
exports.AnonymousUserMetricsDto =
  exports.TimeframeMetricsDto =
  exports.SearchTermDto =
  exports.BrandPreferenceDto =
  exports.CategoryPreferenceDto =
  exports.InteractionTypeMetricsDto =
  exports.AnonymousUserOverviewDto =
    void 0;
...
__decorate(
  ...
  AnonymousUserOverviewDto.prototype,
  'totalAnonymousUsers',
  void 0,
);
__decorate(
...
__decorate(
  ...
  InteractionTypeMetricsDto.prototype,
  'type',
  void 0,
);
__decorate(
...
__decorate(
  [(0, graphql_1.Field)(), __metadata('design:type', String)],
  CategoryPreferenceDto.prototype,
  'categoryId',
  void 0,
);
__decorate(
...
exports.SearchTermDto = SearchTermDto = __decorate([(0, graphql_1.ObjectType)()], SearchTermDto);
let TimeframeMetricsDto = class TimeframeMetricsDto {};
exports.TimeframeMetricsDto = TimeframeMetricsDto;
__decorate(
  [(0, graphql_1.Field)(), __metadata('design:type', String)],
  TimeframeMetricsDto.prototype,
  'date',
  void 0,
);
__decorate(
...
__decorate(
  ...
  AnonymousUserMetricsDto.prototype,
  'overview',
  void 0,
);
__decorate(
  [(0, graphql_1.Field)(() => [InteractionTypeMetricsDto]), __metadata('design:type', Array)],
  AnonymousUserMetricsDto.prototype,
  'interactionsByType',
  void 0,
);
__decorate(
  [(0, graphql_1.Field)(() => [CategoryPreferenceDto]), __metadata('design:type', Array)],
  AnonymousUserMetricsDto.prototype,
  'topCategoryPreferences',
  void 0,
);
__decorate(
  [(0, graphql_1.Field)(() => [BrandPreferenceDto]), __metadata('design:type', Array)],
  AnonymousUserMetricsDto.prototype,
  'topBrandPreferences',
  void 0,
);
__decorate(
  [(0, graphql_1.Field)(() => [SearchTermDto]), __metadata('design:type', Array)],
  AnonymousUserMetricsDto.prototype,
  'topSearchTerms',
  void 0,
);
__decorate(
  [(0, graphql_1.Field)(() => [TimeframeMetricsDto]), __metadata('design:type', Array)],
  AnonymousUserMetricsDto.prototype,
  'byTimeframe',
  void 0,
);
