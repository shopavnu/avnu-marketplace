...
export declare class PersonalizationResolver {
    ...
    createUserPreferences(createUserPreferencesDto: CreateUserPreferencesDto, context: any): Promise<UserPreferences>;
    getUserPreferences(context: any): Promise<UserPreferences>;
    updateUserPreferences(updateUserPreferencesDto: UpdateUserPreferencesDto, context: any): Promise<UserPreferences>;
    trackEntityView(entityType: 'product' | 'category' | 'brand' | 'merchant', entityId: string, context: any): Promise<boolean>;
    trackEntityFavorite(entityType: 'product' | 'category' | 'brand' | 'merchant', entityId: string, context: any): Promise<boolean>;
    ...
    trackPurchase(context: any, productId: string, quantity?: number, price?: number): Promise<boolean>;
