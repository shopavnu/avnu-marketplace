...
let AnonymousUserService = AnonymousUserService_1 = class AnonymousUserService {
    constructor(configService, sessionService) {
        ...
        this.cookieMaxAge = this.configService.get('ANONYMOUS_USER_COOKIE_MAX_AGE', 30 * 24 * 60 * 60 * 1000);
        this.cookieSecure = this.configService.get('COOKIE_SECURE', process.env.NODE_ENV === 'production');
...
exports.AnonymousUserService = AnonymousUserService = AnonymousUserService_1 = __decorate([
