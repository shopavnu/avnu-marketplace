...
let UserPreferenceProfileService =
  (UserPreferenceProfileService_1 = class UserPreferenceProfileService {
...
exports.UserPreferenceProfileService =
  UserPreferenceProfileService =
  UserPreferenceProfileService_1 =
    __decorate(
      [
        (0, common_1.Injectable)(),
        __param(
          0,
          (0, typeorm_1.InjectRepository)(user_preference_profile_entity_1.UserPreferenceProfile),
        ),
        __metadata('design:paramtypes', [typeorm_2.Repository, session_service_1.SessionService]),
      ],
      UserPreferenceProfileService,
    );
