...
export declare class UserBehaviorService {
    ...
    trackBehavior(userId: string, entityId: string, entityType: 'product' | 'category' | 'brand' | 'merchant' | 'search', behaviorType: BehaviorType, metadata?: string): Promise<UserBehavior>;
    ...
    getUserBehaviorsByType(userId: string, behaviorType: BehaviorType, limit?: number): Promise<UserBehavior[]>;
    getUserBehaviorsByEntityType(userId: string, entityType: 'product' | 'category' | 'brand' | 'merchant' | 'search', limit?: number): Promise<UserBehavior[]>;
