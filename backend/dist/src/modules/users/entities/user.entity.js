...
__decorate([
    ...
    (0, typeorm_1.Column)({ default: false }),
    __metadata("design:type", Boolean)
], User.prototype, "isMerchant", void 0);
__decorate([
...
__decorate([
    ...
    (0, typeorm_1.ManyToOne)(() => user_segment_entity_1.UserSegmentEntity, segment => segment.users, { nullable: true }),
    (0, typeorm_1.JoinColumn)({ name: 'segment_id' }),
    __metadata("design:type", user_segment_entity_1.UserSegmentEntity)
], User.prototype, "segment", void 0);
__decorate([
    (0, graphql_1.Field)(),
    __metadata("design:type", String),
