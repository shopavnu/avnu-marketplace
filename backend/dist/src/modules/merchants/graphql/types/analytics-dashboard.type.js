...
exports.PeriodComparisonData =
  exports.PeriodMetrics =
  exports.MerchantDashboardAnalytics =
  exports.DemographicAnalytics =
  exports.DeviceData =
  exports.LocationData =
  exports.AgeGroupData =
  exports.DemographicDataPoint =
  exports.ImpressionAnalytics =
  exports.ConversionAnalytics =
  exports.RevenueAnalytics =
  exports.OrganicVsPaidPerformance =
  exports.ChannelMetrics =
  exports.ConversionFunnel =
  exports.ConversionRates =
  exports.ConversionFunnelStage =
  exports.DualChannelTimeSeriesPoint =
...
exports.TopProduct = TopProduct = __decorate([(0, graphql_1.ObjectType)()], TopProduct);
...
__decorate(
  [(0, graphql_1.Field)(), __metadata('design:type', Date)],
  DualChannelTimeSeriesPoint.prototype,
  'date',
  void 0,
);
__decorate(
...
__decorate(
  [(0, graphql_1.Field)(), __metadata('design:type', String)],
  ConversionFunnelStage.prototype,
  'name',
  void 0,
);
__decorate(
...
__decorate(
  [(0, graphql_1.Field)(() => [ConversionFunnelStage]), __metadata('design:type', Array)],
  ConversionFunnel.prototype,
  'stages',
  void 0,
);
__decorate(
  [(0, graphql_1.Field)(() => ConversionRates), __metadata('design:type', ConversionRates)],
  ConversionFunnel.prototype,
  'conversionRates',
  void 0,
);
...
exports.ChannelMetrics = ChannelMetrics = __decorate([(0, graphql_1.ObjectType)()], ChannelMetrics);
let OrganicVsPaidPerformance = class OrganicVsPaidPerformance {};
exports.OrganicVsPaidPerformance = OrganicVsPaidPerformance;
__decorate(
  [(0, graphql_1.Field)(() => ChannelMetrics), __metadata('design:type', ChannelMetrics)],
  OrganicVsPaidPerformance.prototype,
  'impressions',
  void 0,
);
__decorate(
...
__decorate(
  [(0, graphql_1.Field)(() => [DualChannelTimeSeriesPoint]), __metadata('design:type', Array)],
  ImpressionAnalytics.prototype,
  'impressionsOverTime',
  void 0,
);
...
__decorate(
  [(0, graphql_1.Field)(), __metadata('design:type', String)],
  DemographicDataPoint.prototype,
  'key',
  void 0,
);
__decorate(
...
__decorate(
  [(0, graphql_1.Field)(() => [DemographicDataPoint]), __metadata('design:type', Array)],
  AgeGroupData.prototype,
  'distribution',
  void 0,
);
__decorate(
...
exports.AgeGroupData = AgeGroupData = __decorate([(0, graphql_1.ObjectType)()], AgeGroupData);
...
exports.LocationData = LocationData = __decorate([(0, graphql_1.ObjectType)()], LocationData);
...
exports.DeviceData = DeviceData = __decorate([(0, graphql_1.ObjectType)()], DeviceData);
let DemographicAnalytics = class DemographicAnalytics {};
exports.DemographicAnalytics = DemographicAnalytics;
__decorate(
  [(0, graphql_1.Field)(() => AgeGroupData), __metadata('design:type', AgeGroupData)],
  DemographicAnalytics.prototype,
  'ageGroups',
  void 0,
);
__decorate(
  [(0, graphql_1.Field)(() => LocationData), __metadata('design:type', LocationData)],
  DemographicAnalytics.prototype,
  'location',
  void 0,
);
__decorate(
  [(0, graphql_1.Field)(() => DeviceData), __metadata('design:type', DeviceData)],
  DemographicAnalytics.prototype,
  'devices',
  void 0,
);
...
__decorate(
  [(0, graphql_1.Field)(() => AnalyticsSummary), __metadata('design:type', AnalyticsSummary)],
  MerchantDashboardAnalytics.prototype,
  'summary',
  void 0,
);
__decorate(
  [(0, graphql_1.Field)(() => [TopProduct]), __metadata('design:type', Array)],
  MerchantDashboardAnalytics.prototype,
  'topProducts',
  void 0,
);
__decorate(
  [
    (0, graphql_1.Field)(() => graphql_type_json_1.GraphQLJSON, {
      deprecationReason: 'Use demographicAnalytics instead',
    }),
...
__decorate(
  [(0, graphql_1.Field)(() => ConversionFunnel), __metadata('design:type', ConversionFunnel)],
  MerchantDashboardAnalytics.prototype,
  'conversionFunnel',
  void 0,
);
...
exports.PeriodMetrics = PeriodMetrics = __decorate([(0, graphql_1.ObjectType)()], PeriodMetrics);
let PeriodComparisonData = class PeriodComparisonData {};
exports.PeriodComparisonData = PeriodComparisonData;
__decorate(
  [(0, graphql_1.Field)(() => PeriodMetrics), __metadata('design:type', PeriodMetrics)],
  PeriodComparisonData.prototype,
  'currentPeriod',
  void 0,
);
__decorate(
