...
__decorate(
  ...
  MerchantDashboardAnalyticsResolver.prototype,
...
__decorate(
  [
    ...
    __metadata('design:type', Function),
    __metadata('design:paramtypes', [merchant_entity_1.Merchant, String, String, Date, Date]),
    __metadata('design:returntype', Promise),
  ],
  MerchantDashboardAnalyticsResolver.prototype,
...
__decorate(
  [
    ...
    __param(3, (0, graphql_1.Args)('endDate', { nullable: true })),
    __metadata('design:type', Function),
    __metadata('design:paramtypes', [merchant_entity_1.Merchant, String, Date, Date]),
    __metadata('design:returntype', Promise),
  ],
  MerchantDashboardAnalyticsResolver.prototype,
...
__decorate(
  [
    ...
    __metadata('design:type', Function),
    __metadata('design:paramtypes', [merchant_entity_1.Merchant, Date, Date]),
    __metadata('design:returntype', Promise),
  ],
  MerchantDashboardAnalyticsResolver.prototype,
...
__decorate(
  [
    ...
    __param(
      4,
      (0, graphql_1.Args)('filters', {
        type: () => [demographic_filter_input_1.DemographicFilterInput],
        nullable: true,
      }),
    ),
    __metadata('design:type', Function),
    __metadata('design:paramtypes', [merchant_entity_1.Merchant, String, Date, Date, Array]),
    __metadata('design:returntype', Promise),
  ],
  MerchantDashboardAnalyticsResolver.prototype,
...
__decorate(
  [
    ...
    __param(
      4,
      (0, graphql_1.Args)('demographicFilters', {
        type: () => [demographic_filter_input_1.DemographicFilterInput],
        nullable: true,
      }),
    ),
