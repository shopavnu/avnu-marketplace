...
(0, graphql_2.registerEnumType)(ad_budget_management_service_1.BudgetAllocationStrategy, {
  name: 'BudgetAllocationStrategy',
});
const graphql_3 = require('@nestjs/graphql');
let BudgetUtilizationReport = class BudgetUtilizationReport {};
__decorate(
  [(0, graphql_3.Field)(() => graphql_1.Float), __metadata('design:type', Number)],
  BudgetUtilizationReport.prototype,
  'totalBudget',
  void 0,
);
__decorate(
...
__decorate(
  [(0, graphql_3.Field)(() => [CampaignUtilization]), __metadata('design:type', Array)],
  BudgetUtilizationReport.prototype,
  'campaignUtilization',
  void 0,
);
BudgetUtilizationReport = __decorate([(0, graphql_3.ObjectType)()], BudgetUtilizationReport);
let CampaignUtilization = class CampaignUtilization {};
__decorate(
  [(0, graphql_3.Field)(() => graphql_1.ID), __metadata('design:type', String)],
  CampaignUtilization.prototype,
  'campaignId',
  void 0,
);
__decorate(
  [(0, graphql_3.Field)(), __metadata('design:type', String)],
  CampaignUtilization.prototype,
  'name',
  void 0,
);
...
CampaignUtilization = __decorate([(0, graphql_3.ObjectType)()], CampaignUtilization);
let CampaignForecast = class CampaignForecast {};
__decorate(
  [(0, graphql_3.Field)(() => graphql_1.ID), __metadata('design:type', String)],
  CampaignForecast.prototype,
  'campaignId',
  void 0,
);
__decorate(
...
__decorate(
  [(0, graphql_3.Field)(), __metadata('design:type', Date)],
  CampaignForecast.prototype,
  'estimatedEndDate',
  void 0,
);
CampaignForecast = __decorate([(0, graphql_3.ObjectType)()], CampaignForecast);
let BudgetAllocation = class BudgetAllocation {};
__decorate(
  [(0, graphql_3.Field)(() => graphql_1.ID), __metadata('design:type', String)],
  BudgetAllocation.prototype,
  'campaignId',
  void 0,
);
__decorate(
...
BudgetAllocation = __decorate([(0, graphql_3.ObjectType)()], BudgetAllocation);
...
__decorate(
  ...
  AdBudgetManagementResolver.prototype,
  'merchantBudgetUtilization',
  null,
);
__decorate(
  [
