...
__decorate(
  [
    ...
    __param(
      3,
      (0, graphql_1.Args)('startDate', {
        type: () => graphql_2.GraphQLISODateTime,
        nullable: true,
      }),
    ),
    __param(
      4,
      (0, graphql_1.Args)('endDate', { type: () => graphql_2.GraphQLISODateTime, nullable: true }),
    ),
  ...
  MerchantAnalyticsResolver.prototype,
  'merchantAnalytics',
  null,
);
__decorate(
  [
    ...
    __metadata('design:type', Function),
    __metadata('design:paramtypes', [String, String, user_entity_1.User, String, Date, Date]),
    __metadata('design:returntype', Promise),
  ],
  MerchantAnalyticsResolver.prototype,
...
__decorate(
  [
    ...
    __metadata('design:type', Function),
    __metadata('design:paramtypes', [String, user_entity_1.User, String, Date, Date]),
    __metadata('design:returntype', Promise),
  ],
  MerchantAnalyticsResolver.prototype,
