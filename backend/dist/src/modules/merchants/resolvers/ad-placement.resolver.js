...
__decorate(
  [(0, graphql_2.Field)(() => graphql_1.ID), __metadata('design:type', String)],
...
__decorate(
  [(0, graphql_2.Field)(() => [graphql_1.ID]), __metadata('design:type', Array)],
  AdPlacement.prototype,
  'productIds',
  void 0,
);
...
__decorate(
  [(0, graphql_2.Field)(() => graphql_1.Float), __metadata('design:type', Number)],
  AdPlacement.prototype,
  'relevanceScore',
  void 0,
);
__decorate(
  [(0, graphql_2.Field)(() => Boolean), __metadata('design:type', Boolean)],
  AdPlacement.prototype,
  'isSponsored',
  void 0,
);
...
AdPlacement = __decorate([(0, graphql_2.ObjectType)()], AdPlacement);
let ProductAdRecommendation = class ProductAdRecommendation {};
__decorate(
  [(0, graphql_2.Field)(() => graphql_1.ID), __metadata('design:type', String)],
  ProductAdRecommendation.prototype,
  'productId',
  void 0,
);
__decorate(
...
ProductAdRecommendation = __decorate([(0, graphql_2.ObjectType)()], ProductAdRecommendation);
let AdPlacementOptionsInput = class AdPlacementOptionsInput {};
__decorate(
  [(0, graphql_2.Field)(() => String, { nullable: true }), __metadata('design:type', String)],
  AdPlacementOptionsInput.prototype,
  'location',
  void 0,
);
__decorate(
  [(0, graphql_2.Field)(() => [String], { nullable: true }), __metadata('design:type', Array)],
  AdPlacementOptionsInput.prototype,
  'interests',
  void 0,
);
...
AdPlacementOptionsInput = __decorate([(0, graphql_2.InputType)()], AdPlacementOptionsInput);
  ...
  async recordAdClick(campaignId, user) {
    try {
      await this.adPlacementService.recordAdClick(
        campaignId,
        user?.id,
        user ? undefined : `anonymous-${Date.now()}`,
      );
      return true;
    } catch (error) {
...
__decorate(
  [
    ...
    __metadata('design:paramtypes', [AdPlacementOptionsInput, user_entity_1.User]),
    __metadata('design:returntype', Promise),
  ],
  AdPlacementResolver.prototype,
