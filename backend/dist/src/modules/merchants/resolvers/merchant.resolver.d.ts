...
import { CreateMerchantInput, UpdateMerchantInput, CreateMerchantBrandInput, UpdateMerchantShippingInput } from '../dto';
export declare class MerchantResolver {
    ...
    createOrUpdateMerchantBrand(merchantId: string, input: CreateMerchantBrandInput, user: User): Promise<MerchantBrand>;
    merchantProducts(merchantId: string, user: User): Promise<MerchantProduct[]>;
    updateProductVisibility(merchantId: string, productId: string, isVisible: boolean, user: User): Promise<MerchantProduct>;
    updateProductPromotion(merchantId: string, productId: string, isPromoted: boolean, user: User, monthlyAdBudget?: number): Promise<MerchantProduct>;
    merchantShipping(merchantId: string, user: User): Promise<MerchantShipping>;
    updateMerchantShipping(merchantId: string, input: UpdateMerchantShippingInput, user: User): Promise<MerchantShipping>;
}
