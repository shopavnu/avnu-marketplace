...
let MerchantResolver = class MerchantResolver {
  ...
  async removeMerchant(id, user) {
    ...
    const canRemove =
      user.role === user_entity_1.UserRole.ADMIN || merchants.some(m => m.id === id);
    if (!canRemove) {
  ...
  async merchantBrand(merchantId, user) {
    const merchants = await this.merchantService.findByUserId(user.id);
    const canView =
      user.role === user_entity_1.UserRole.ADMIN || merchants.some(m => m.id === merchantId);
    if (!canView) {
...
__decorate(
  [
    ...
    __metadata('design:type', Function),
    __metadata('design:paramtypes', [dto_1.CreateMerchantInput, user_entity_1.User]),
    __metadata('design:returntype', Promise),
  ],
  MerchantResolver.prototype,
  'createMerchant',
...
__decorate(
  [
    ...
    __metadata('design:type', Function),
    __metadata('design:paramtypes', [String, dto_1.UpdateMerchantInput, user_entity_1.User]),
    __metadata('design:returntype', Promise),
  ],
  MerchantResolver.prototype,
  'updateMerchant',
...
__decorate(
  [
    ...
    __param(2, (0, current_user_decorator_1.CurrentUser)()),
    __metadata('design:type', Function),
    __metadata('design:paramtypes', [String, dto_1.CreateMerchantBrandInput, user_entity_1.User]),
    __metadata('design:returntype', Promise),
  ],
  MerchantResolver.prototype,
...
__decorate(
  [
    ...
    __metadata('design:paramtypes', [
      String,
      dto_1.UpdateMerchantShippingInput,
      user_entity_1.User,
    ]),
    __metadata('design:returntype', Promise),
  ],
