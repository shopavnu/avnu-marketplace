...
export declare class MerchantAdCampaignResolver {
    ...
    merchantAdCampaignsByType(merchantId: string, type: CampaignType, user: User): Promise<MerchantAdCampaign[]>;
    merchantAdCampaignsForProduct(merchantId: string, productId: string, user: User): Promise<MerchantAdCampaign[]>;
    createMerchantAdCampaign(merchantId: string, input: CreateAdCampaignInput, user: User): Promise<MerchantAdCampaign>;
    updateMerchantAdCampaign(id: string, merchantId: string, input: UpdateAdCampaignInput, user: User): Promise<MerchantAdCampaign>;
    updateMerchantAdCampaignStatus(id: string, merchantId: string, status: CampaignStatus, user: User): Promise<MerchantAdCampaign>;
    deleteMerchantAdCampaign(id: string, merchantId: string, user: User): Promise<boolean>;
    createRetargetingCampaign(merchantId: string, productIds: string[], budget: number, user: User): Promise<MerchantAdCampaign>;
