...
export declare class MerchantService {
    ...
    constructor(merchantRepository: Repository<Merchant>, merchantBrandRepository: Repository<MerchantBrand>, merchantProductRepository: Repository<MerchantProduct>, merchantShippingRepository: Repository<MerchantShipping>);
    ...
    createOrUpdateMerchantBrand(merchantId: string, brandData: Partial<MerchantBrand>): Promise<MerchantBrand>;
    ...
    updateProductVisibility(merchantId: string, productId: string, isVisible: boolean): Promise<MerchantProduct>;
    updateProductPromotion(merchantId: string, productId: string, isPromoted: boolean, monthlyAdBudget?: number): Promise<MerchantProduct>;
    getMerchantShipping(merchantId: string): Promise<MerchantShipping>;
    createOrUpdateMerchantShipping(merchantId: string, shippingData: Partial<MerchantShipping>): Promise<MerchantShipping>;
}
