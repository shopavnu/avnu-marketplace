...
let AppUninstalledWebhookHandler =
  (AppUninstalledWebhookHandler_1 = class AppUninstalledWebhookHandler extends (
    ...
    async deactivateConnection(connection, payload) {
      try {
        ...
        this.logger.log(
          `Successfully deactivated connection for merchant ${connection.merchantId}`,
        );
      } catch (error) {
        this.logger.error(
...
exports.AppUninstalledWebhookHandler =
  AppUninstalledWebhookHandler =
  AppUninstalledWebhookHandler_1 =
    __decorate(
      [
