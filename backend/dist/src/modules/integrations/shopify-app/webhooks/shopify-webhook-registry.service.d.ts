...
import { ProductWebhookHandler, OrderWebhookHandler, AppUninstalledWebhookHandler } from './handlers';
import { ShopifyWebhookTopic, ShopifyWebhookSubscription } from '../../../common/types/shopify-models.types';
...
export declare class ShopifyWebhookRegistryService implements IShopifyWebhookService, OnModuleInit {
    ...
    constructor(config: ConfigType<typeof shopifyConfig>, merchantPlatformConnectionRepository: Repository<MerchantPlatformConnection>, shopifyClientService: ShopifyClientService, webhookRegistry: WebhookRegistry, webhookValidator: WebhookValidator, productHandler: ProductWebhookHandler, orderHandler: OrderWebhookHandler, appUninstalledHandler: AppUninstalledWebhookHandler);
