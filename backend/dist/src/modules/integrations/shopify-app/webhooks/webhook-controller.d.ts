...
export declare class ShopifyWebhookController {
    ...
    constructor(webhookValidator: WebhookValidator, webhookProcessor: DistributedWebhookProcessor, configService: ConfigService, logger: ShopifyStructuredLogger);
    processWebhook(shop: string, topic: string, hmac: string, webhookId: string, payload: any, request: RawBodyRequest<Request>): Promise<{
        success: boolean;
        message: string;
    }>;
