...
exports.ShopifyWebhooksModule = ShopifyWebhooksModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([merchant_platform_connection_entity_1.MerchantPlatformConnection, shopify_bulk_operation_job_entity_1.ShopifyBulkOperationJob]),
        ...
        controllers: [webhook_controller_1.ShopifyWebhookController, queue_dashboard_controller_1.QueueDashboardController],
        providers: [
