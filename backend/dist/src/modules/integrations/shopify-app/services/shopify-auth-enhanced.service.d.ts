...
export declare class ShopifyAuthEnhancedService implements IShopifyAuthService {
    ...
    constructor(config: ConfigType<typeof shopifyConfig>, merchantPlatformConnectionRepository: Repository<MerchantPlatformConnection>);
    ...
    storeAccessToken(shop: string, accessToken: string, merchantId: string, metadata?: {
