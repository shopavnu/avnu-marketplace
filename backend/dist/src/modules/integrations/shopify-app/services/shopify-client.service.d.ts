...
export declare class ShopifyClientService implements IShopifyClientService {
    ...
    constructor(config: ConfigType<typeof shopifyConfig>, versionManager: ShopifyVersionManagerService, connectionPool: ShopifyConnectionPoolManager, circuitBreaker: ShopifyCircuitBreaker, cacheManager: ShopifyCacheManager, logger: ShopifyStructuredLogger);
