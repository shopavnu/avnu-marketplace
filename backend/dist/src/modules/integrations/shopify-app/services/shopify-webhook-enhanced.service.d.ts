...
export declare class ShopifyWebhookEnhancedService implements IShopifyWebhookService {
    ...
    constructor(config: ConfigType<typeof shopifyConfig>, merchantPlatformConnectionRepository: Repository<MerchantPlatformConnection>, shopifyClientService: ShopifyClientService, shopifyAuthService: ShopifyAuthEnhancedService);
