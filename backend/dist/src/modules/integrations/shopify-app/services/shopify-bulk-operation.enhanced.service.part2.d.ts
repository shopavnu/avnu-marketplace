...
export declare class ShopifyBulkOperationEnhancedServicePart2 {
    ...
    constructor(shopifyClientService: IShopifyClientService, merchantConnectionRepository: Repository<MerchantPlatformConnection>, bulkJobService: ShopifyBulkJobService);
    ...
    processResultsWithPagination<T>(jobId: string, options?: {
        entityType?: string;
        validateEntities?: boolean;
        transformEntities?: boolean;
        filters?: Record<string, any>;
    }, cursor?: string, limit?: number): Promise<BulkOperationPaginatedResults<T>>;
    processAllResults<T>(jobId: string, options?: {
        entityType?: string;
        validateEntities?: boolean;
        transformEntities?: boolean;
        batchSize?: number;
