...
exports.RedisModule = exports.REDIS_QUEUE_CLIENT = exports.REDIS_WEBHOOK_CLIENT = exports.REDIS_CACHE_CLIENT = void 0;
...
exports.RedisModule = RedisModule = __decorate([
    ...
    (0, common_1.Module)({
        ...
        exports: [exports.REDIS_CACHE_CLIENT, exports.REDIS_WEBHOOK_CLIENT, exports.REDIS_QUEUE_CLIENT],
    })
], RedisModule);
function createRedisClient(configService, options = {}) {
    ...
    client.on('connect', () => {
        console.log(`Redis client connected to ${redisOptions.host}:${redisOptions.port}, DB: ${redisOptions.db}`);
    });
    client.on('error', err => {
