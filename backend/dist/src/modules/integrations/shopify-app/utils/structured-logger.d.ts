...
export declare class ShopifyStructuredLogger implements LoggerService {
    ...
    logWebhookEvent(topic: string, shopDomain: string, webhookId: string, metadata?: ShopifyLogMetadata): void;
    logApiRequest(endpoint: string, shopDomain: string, metadata?: ShopifyLogMetadata): void;
    logApiResponse(endpoint: string, shopDomain: string, status: number, duration: number, metadata?: ShopifyLogMetadata): void;
    logBulkOperation(action: string, bulkOperationId: string, shopDomain: string, metadata?: ShopifyLogMetadata): void;
