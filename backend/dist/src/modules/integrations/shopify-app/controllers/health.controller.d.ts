...
export declare class ShopifyHealthController {
    ...
    constructor(shopifyClientService: ShopifyClientService, shopifyClientExtensions: ShopifyClientExtensions, circuitBreaker: ShopifyCircuitBreaker, configService: ConfigService, bulkJobRepository: Repository<ShopifyBulkOperationJob>);
