...
__decorate([
    ...
    (0, swagger_1.ApiHeader)({ name: 'X-Shopify-Hmac-Sha256', description: 'HMAC signature for verification' }),
...
], ShopifyWebhookController.prototype, "handleWebhook", null);
exports.ShopifyWebhookController = ShopifyWebhookController = ShopifyWebhookController_1 = __decorate([
    (0, swagger_1.ApiTags)('shopify-webhooks'),
    (0, common_1.Controller)('integrations/shopify/webhook'),
    __metadata("design:paramtypes", [shopify_webhook_service_1.ShopifyWebhookService,
