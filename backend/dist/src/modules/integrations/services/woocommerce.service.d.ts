...
export declare class WooCommerceService {
    ...
    fetchProducts(storeUrl: string, consumerKey: string, consumerSecret: string, merchantId: string, page?: number, perPage?: number): Promise<any[]>;
    syncProducts(storeUrl: string, consumerKey: string, consumerSecret: string, merchantId: string): Promise<{
        created: number;
        updated: number;
        failed: number;
    }>;
