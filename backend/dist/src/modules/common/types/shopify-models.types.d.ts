...
export type ShopifyOrderFinancialStatus = 'pending' | 'authorized' | 'partially_paid' | 'paid' | 'partially_refunded' | 'refunded' | 'voided';
...
export interface ShopifyBulkOperation {
    id: string;
    status: 'created' | 'running' | 'completed' | 'failed' | 'canceling' | 'canceled' | 'CREATED' | 'RUNNING' | 'COMPLETED' | 'FAILED' | 'CANCELING' | 'CANCELED';
...
export type ShopifyWebhookTopic = 'app/uninstalled' | 'carts/create' | 'carts/update' | 'checkouts/create' | 'checkouts/update' | 'collections/create' | 'collections/update' | 'collections/delete' | 'customer_tags/added' | 'customer_tags/removed' | 'customers/create' | 'customers/delete' | 'customers/disable' | 'customers/enable' | 'customers/update' | 'customers/email_marketing_consent_update' | 'customers/marketing_consent_update' | 'customers/purchasing_summary' | 'customers/data_request' | 'customers/redact' | 'draft_orders/create' | 'draft_orders/update' | 'draft_orders/delete' | 'fulfillments/create' | 'fulfillments/update' | 'inventory_items/create' | 'inventory_items/update' | 'inventory_items/delete' | 'inventory_levels/connect' | 'inventory_levels/update' | 'inventory_levels/disconnect' | 'orders/cancelled' | 'orders/create' | 'orders/fulfilled' | 'orders/paid' | 'orders/partially_fulfilled' | 'orders/updated' | 'products/create' | 'products/update' | 'products/delete' | 'refunds/create' | 'shop/update';
