...
export declare class AbTestingService {
    ...
    constructor(experimentService: ExperimentService, assignmentService: ExperimentAssignmentService, analysisService: ExperimentAnalysisService);
    createExperiment(createExperimentDto: CreateExperimentDto): Promise<import("../entities/experiment.entity").Experiment>;
    getAllExperiments(status?: ExperimentStatus): Promise<import("../entities/experiment.entity").Experiment[]>;
    getExperimentById(id: string): Promise<import("../entities/experiment.entity").Experiment>;
    updateExperiment(id: string, updateExperimentDto: UpdateExperimentDto): Promise<import("../entities/experiment.entity").Experiment>;
    ...
    declareWinner(experimentId: string, variantId: string): Promise<import("../entities/experiment.entity").Experiment>;
    getExperimentResults(id: string): Promise<any>;
    getVariantConfiguration(experimentType: ExperimentType, userId?: string, sessionId?: string): Promise<any>;
    ...
    calculateRequiredSampleSize(baselineConversionRate: number, minimumDetectableEffect: number, significanceLevel?: number, power?: number): number;
    ...
    getUserAssignments(userId?: string, sessionId?: string): Promise<import("../entities/user-experiment-assignment.entity").UserExperimentAssignment[]>;
}
