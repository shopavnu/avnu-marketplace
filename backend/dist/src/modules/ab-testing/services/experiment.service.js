...
let ExperimentService = ExperimentService_1 = class ExperimentService {
    ...
    async create(createExperimentDto) {
        try {
            ...
            const variants = createExperimentDto.variants.map(variantDto => this.variantRepository.create({
                ...variantDto,
    ...
    async update(id, updateExperimentDto) {
        try {
            ...
            if (updateExperimentDto.variants) {
                ...
                const variants = updateExperimentDto.variants.map(variantDto => this.variantRepository.create({
                    ...variantDto,
                    experimentId: id,
                }));
    ...
    async declareWinner(experimentId, variantId) {
        try {
            ...
            if (!variant) {
                throw new common_1.BadRequestException(`Variant with ID ${variantId} does not belong to this experiment`);
            }
...
exports.ExperimentService = ExperimentService = ExperimentService_1 = __decorate([
