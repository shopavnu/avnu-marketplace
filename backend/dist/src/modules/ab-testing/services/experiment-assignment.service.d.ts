...
export declare class ExperimentAssignmentService {
    ...
    getOrCreateAssignment(experimentId: string, userId?: string, sessionId?: string): Promise<UserExperimentAssignment>;
    getActiveExperiments(experimentType: string): Promise<Experiment[]>;
    getVariantConfiguration(experimentType: string, userId?: string, sessionId?: string): Promise<any>;
    ...
    trackConversion(assignmentId: string, value?: number, context?: string, metadata?: any): Promise<void>;
    trackCustomEvent(assignmentId: string, eventType: string, value?: number, context?: string, metadata?: any): Promise<void>;
