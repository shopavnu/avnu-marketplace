...
export declare class ExperimentAnalysisService {
    ...
    constructor(experimentRepository: Repository<Experiment>, variantRepository: Repository<ExperimentVariant>, resultRepository: Repository<ExperimentResult>);
    calculateStatisticalSignificance(experimentId: string): Promise<any>;
    private calculateZTest;
    private calculatePValue;
    calculateRequiredSampleSize(baselineConversionRate: number, minimumDetectableEffect: number, _significanceLevel?: number, _power?: number): number;
