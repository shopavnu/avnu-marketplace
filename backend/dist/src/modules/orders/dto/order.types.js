...
__decorate(
  ...
  OrderFulfillmentType.prototype,
  'id',
  void 0,
);
__decorate(
...
__decorate(
  [(0, graphql_1.Field)(() => Date), __metadata('design:type', Date)],
  OrderFulfillmentType.prototype,
  'createdAt',
  void 0,
);
...
exports.OrderItemType = OrderItemType = __decorate([(0, graphql_1.ObjectType)()], OrderItemType);
...
__decorate(
  [(0, graphql_1.Field)(() => ShippingAddressType), __metadata('design:type', ShippingAddressType)],
  OrderType.prototype,
  'shippingAddress',
  void 0,
);
__decorate(
  [(0, graphql_1.Field)(() => [OrderItemType]), __metadata('design:type', Array)],
  OrderType.prototype,
  'items',
  void 0,
);
...
__decorate(
  [(0, graphql_1.Field)(() => PlatformActionsType), __metadata('design:type', PlatformActionsType)],
  OrderType.prototype,
  'platformActions',
  void 0,
);
...
exports.OrderType = OrderType = __decorate([(0, graphql_1.ObjectType)()], OrderType);
...
__decorate(
  [(0, graphql_1.Field)(() => [OrderType]), __metadata('design:type', Array)],
  PaginatedOrdersType.prototype,
  'items',
  void 0,
);
__decorate(
