...
__decorate(
  [
    ...
    (0, typeorm_1.OneToMany)(
      () => order_fulfillment_entity_1.OrderFulfillment,
...
__decorate(
  [
    (0, graphql_1.Field)(() => String, { nullable: true, description: 'External platform type' }),
...
__decorate(
  [
    (0, graphql_1.Field)(() => String, {
      nullable: true,
      description: 'Available platform actions for this order',
    }),
    (0, typeorm_1.Column)('json', {
      nullable: true,
...
exports.Order = Order = __decorate(
  [(0, graphql_1.ObjectType)('Order'), (0, typeorm_1.Entity)('orders')],
  Order,
);
