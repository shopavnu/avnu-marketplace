...
let AnalyticsResolver = class AnalyticsResolver {
    ...
    async trackPageView(userId, sessionId, pagePath, referrer, deviceType, platform) {
        return this.userEngagementService.trackPageView(userId, sessionId, pagePath, referrer, deviceType, platform);
    }
    async trackProductView(userId, sessionId, productId, pagePath, referrer, deviceType, platform) {
        return this.userEngagementService.trackProductView(userId, sessionId, productId, pagePath, referrer, deviceType, platform);
    }
    async trackAddToCart(userId, sessionId, productId, quantity, pagePath, deviceType, platform) {
        return this.userEngagementService.trackAddToCart(userId, sessionId, productId, quantity, pagePath, deviceType, platform);
    }
    async trackCheckoutComplete(userId, sessionId, orderId, orderItems, totalAmount, pagePath, deviceType, platform, merchantId) {
        await this.analyticsService.trackOrder(orderId, userId, sessionId, orderItems, totalAmount, merchantId);
        return true;
    }
...
], AnalyticsResolver.prototype, "trackSearch", null);
__decorate([
    (0, graphql_1.Mutation)(() => user_engagement_entity_1.UserEngagement),
    __param(0, (0, graphql_1.Args)('data', { type: () => track_engagement_input_1.TrackEngagementInput })),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [track_engagement_input_1.TrackEngagementInput]),
    __metadata("design:returntype", Promise)
], AnalyticsResolver.prototype, "trackEngagement", null);
__decorate([
    (0, graphql_1.Mutation)(() => user_engagement_entity_1.UserEngagement),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], AnalyticsResolver.prototype, "trackProductView", null);
__decorate([
    (0, graphql_1.Mutation)(() => user_engagement_entity_1.UserEngagement),
    __param(0, (0, graphql_1.Args)('userId', { nullable: true })),
    __param(1, (0, graphql_1.Args)('sessionId')),
    ...
    __metadata("design:returntype", Promise)
], AnalyticsResolver.prototype, "trackAddToCart", null);
__decorate([
    (0, graphql_1.Mutation)(() => Boolean),
    __param(0, (0, graphql_1.Args)('userId', { nullable: true })),
    __param(1, (0, graphql_1.Args)('sessionId')),
    __param(2, (0, graphql_1.Args)('orderId')),
    __param(3, (0, graphql_1.Args)('orderItems', { type: () => [order_item_input_1.OrderItemInput] })),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String, Array, Number, String, String, String, String]),
    __metadata("design:returntype", Promise)
], AnalyticsResolver.prototype, "trackCheckoutComplete", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], AnalyticsResolver.prototype, "dashboardAnalytics", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number, Object]),
    __metadata("design:returntype", Promise)
], AnalyticsResolver.prototype, "searchAnalytics", null);
__decorate([
    (0, graphql_1.Query)(() => [query_count_dto_1.QueryCountDto]),
    (0, common_1.UseGuards)(gql_auth_guard_1.GqlAuthGuard),
    __param(0, (0, graphql_1.Args)('limit', { type: () => graphql_1.Int, nullable: true, defaultValue: 10 })),
    __param(1, (0, graphql_1.Args)('period', { type: () => graphql_1.Int, nullable: true, defaultValue: 30 })),
    __param(2, (0, graphql_1.Context)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Number, Object]),
    __metadata("design:returntype", Promise)
], AnalyticsResolver.prototype, "topSearchQueries", null);
__decorate([
    (0, graphql_1.Query)(() => [query_count_dto_1.QueryCountDto]),
    (0, common_1.UseGuards)(gql_auth_guard_1.GqlAuthGuard),
    __param(0, (0, graphql_1.Args)('limit', { type: () => graphql_1.Int, nullable: true, defaultValue: 10 })),
    ...
    __metadata("design:paramtypes", [Number, Number, Object]),
    __metadata("design:returntype", Promise)
], AnalyticsResolver.prototype, "zeroResultQueries", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number, Object]),
    __metadata("design:returntype", Promise)
], AnalyticsResolver.prototype, "nlpVsRegularSearchAnalytics", null);
__decorate([
    (0, graphql_1.Query)(() => graphql_type_json_1.GraphQLJSONObject),
    (0, common_1.UseGuards)(gql_auth_guard_1.GqlAuthGuard),
    __param(0, (0, graphql_1.Args)('period', { type: () => graphql_1.Int, nullable: true, defaultValue: 30 })),
    ...
    __metadata("design:paramtypes", [Number, Object]),
    __metadata("design:returntype", Promise)
], AnalyticsResolver.prototype, "personalizedVsRegularSearchAnalytics", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number, Object]),
    __metadata("design:returntype", Promise)
], AnalyticsResolver.prototype, "userEngagementAnalytics", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number, Object]),
    __metadata("design:returntype", Promise)
], AnalyticsResolver.prototype, "getUserEngagementByTypeQuery", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number, Number, Object]),
    __metadata("design:returntype", Promise)
], AnalyticsResolver.prototype, "topViewedProducts", null);
__decorate([
    (0, graphql_1.Query)(() => graphql_type_json_1.GraphQLJSONObject),
    (0, common_1.UseGuards)(gql_auth_guard_1.GqlAuthGuard),
    __param(0, (0, graphql_1.Args)('period', { type: () => graphql_1.Int, nullable: true, defaultValue: 30 })),
    ...
    __metadata("design:paramtypes", [Number, Object]),
    __metadata("design:returntype", Promise)
], AnalyticsResolver.prototype, "userEngagementFunnel", null);
__decorate([
    (0, graphql_1.Query)(() => graphql_type_json_1.GraphQLJSONObject),
    (0, common_1.UseGuards)(gql_auth_guard_1.GqlAuthGuard),
    __param(0, (0, graphql_1.Args)('period', { type: () => graphql_1.Int, nullable: true, defaultValue: 30 })),
    ...
    __metadata("design:paramtypes", [Number, Object]),
    __metadata("design:returntype", Promise)
], AnalyticsResolver.prototype, "businessMetricsAnalytics", null);
__decorate([
    (0, graphql_1.Query)(() => graphql_type_json_1.GraphQLJSONObject),
    (0, common_1.UseGuards)(gql_auth_guard_1.GqlAuthGuard),
    __param(0, (0, graphql_1.Args)('period', { type: () => graphql_1.Int, nullable: true, defaultValue: 30 })),
    ...
    __metadata("design:paramtypes", [Number, Object]),
    __metadata("design:returntype", Promise)
], AnalyticsResolver.prototype, "businessMetricsSummary", null);
__decorate([
    (0, graphql_1.Query)(() => [business_metrics_entity_1.BusinessMetrics]),
    (0, common_1.UseGuards)(gql_auth_guard_1.GqlAuthGuard),
    __param(0, (0, graphql_1.Args)('period', { type: () => graphql_1.Int, nullable: true, defaultValue: 30 })),
    __param(1, (0, graphql_1.Args)('granularity', { nullable: true, defaultValue: business_metrics_entity_1.TimeGranularity.DAILY })),
    __param(2, (0, graphql_1.Context)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, String, Object]),
    __metadata("design:returntype", Promise)
], AnalyticsResolver.prototype, "revenueMetrics", null);
