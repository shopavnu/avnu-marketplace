...
export declare class AnalyticsDashboardService {
    ...
    constructor(searchAnalyticsService: SearchAnalyticsService, sessionAnalyticsService: SessionAnalyticsService, userPreferenceService: UserPreferenceService, abTestingService: ABTestingService, elasticsearchService: ElasticsearchService, configService: ConfigService);
