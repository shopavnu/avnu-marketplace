...
export declare class AnalyticsResolver {
    ...
    trackPageView(userId: string, sessionId: string, pagePath: string, referrer: string, deviceType: string, platform: string): Promise<UserEngagement>;
    trackProductView(userId: string, sessionId: string, productId: string, pagePath: string, referrer: string, deviceType: string, platform: string): Promise<UserEngagement>;
    trackAddToCart(userId: string, sessionId: string, productId: string, quantity: number, pagePath: string, deviceType: string, platform: string): Promise<UserEngagement>;
    trackCheckoutComplete(userId: string, sessionId: string, orderId: string, orderItems: OrderItemInput[], totalAmount: number, pagePath: string, deviceType: string, platform: string, merchantId: string): Promise<boolean>;
    ...
    revenueMetrics(period: number, granularity: TimeGranularity, _context: any): Promise<BusinessMetrics[]>;
}
