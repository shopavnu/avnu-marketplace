...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.CREATED, description: 'Scrolling patterns tracked successfully' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.CREATED, description: 'Batch heatmap data tracked successfully' }),
    (0, swagger_1.ApiBody)({ type: [heatmap_data_entity_1.HeatmapData] }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, description: 'Vertical scrolling analytics retrieved successfully' }),
...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'pagePath', required: true, type: String, description: 'Page path to get heatmap data for' }),
    (0, swagger_1.ApiQuery)({ name: 'period', required: false, type: Number, description: 'Period in days (default: 30)' }),
    (0, swagger_1.ApiQuery)({ name: 'interactionType', required: false, enum: heatmap_data_entity_1.InteractionType, description: 'Interaction type filter' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, description: 'Vertical navigation funnel retrieved successfully' }),
    (0, swagger_1.ApiQuery)({ name: 'period', required: false, type: Number, description: 'Period in days (default: 30)' }),
    __param(0, (0, common_1.Query)('period')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
