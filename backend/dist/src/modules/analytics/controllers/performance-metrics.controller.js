...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.CREATED, description: 'API response time tracked successfully' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.CREATED, description: 'Client performance metrics tracked successfully' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.CREATED, description: 'Query performance tracked successfully' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, description: 'API performance metrics retrieved successfully' }),
    (0, swagger_1.ApiQuery)({ name: 'period', required: false, type: Number, description: 'Period in days (default: 30)' }),
    (0, swagger_1.ApiQuery)({ name: 'slowThreshold', required: false, type: Number, description: 'Threshold in ms to consider an API call slow (default: 1000)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, description: 'Client performance metrics retrieved successfully' }),
    (0, swagger_1.ApiQuery)({ name: 'period', required: false, type: Number, description: 'Period in days (default: 30)' }),
    __param(0, (0, common_1.Query)('period')),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'period', required: false, type: Number, description: 'Period in days (default: 30)' }),
    (0, swagger_1.ApiQuery)({ name: 'slowThreshold', required: false, type: Number, description: 'Threshold in ms to consider a query slow (default: 500)' }),
    __param(0, (0, common_1.Query)('period')),
    __param(1, (0, common_1.Query)('slowThreshold')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Number]),
