  ...
  async create(createProductDto) {
    try {
      const normalizedProduct = await this.dataNormalizationService.normalizeProductData(
        createProductDto,
        createProductDto.externalSource || data_normalization_service_1.DataSource.MANUAL,
      );
...
__decorate(
  [
    ...
    (0, swagger_1.ApiOperation)({
      summary: 'Get products with cursor-based pagination (for continuous scroll)',
    }),
    (0, swagger_1.ApiResponse)({
      status: 200,
      description: 'Return products with cursor for next page',
    }),
