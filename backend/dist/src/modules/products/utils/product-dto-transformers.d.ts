...
export declare function transformCreateProductDto(
  dto: ExtendedCreateProductDto,
): DeepPartial<Product>;
export declare function transformUpdateProductDto(
  dto: ExtendedUpdateProductDto,
): DeepPartial<Product>;
