...
let CachePerformanceMonitorService = CachePerformanceMonitorService_1 = class CachePerformanceMonitorService {
    ...
    getAverageResponseTimeWithCache() {
        if (this.responseTimeWithCache.length === 0)
            return 0;
    ...
    getAverageResponseTimeWithoutCache() {
        if (this.responseTimeWithoutCache.length === 0)
            return 0;
...
], CachePerformanceMonitorService.prototype, "logHourlyMetrics", null);
__decorate([
    (0, schedule_1.Cron)(schedule_1.CronExpression.EVERY_DAY_AT_MIDNIGHT),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], CachePerformanceMonitorService.prototype, "logDailyMetrics", null);
__decorate([
    (0, event_emitter_1.OnEvent)('cache.hit'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], CachePerformanceMonitorService.prototype, "handleCacheHit", null);
__decorate([
    (0, event_emitter_1.OnEvent)('cache.miss'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], CachePerformanceMonitorService.prototype, "handleCacheMiss", null);
__decorate([
    (0, event_emitter_1.OnEvent)('cache.invalidate'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], CachePerformanceMonitorService.prototype, "handleCacheInvalidation", null);
__decorate([
    (0, event_emitter_1.OnEvent)('cache.warming.complete'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", void 0)
], CachePerformanceMonitorService.prototype, "handleCacheWarmingComplete", null);
exports.CachePerformanceMonitorService = CachePerformanceMonitorService = CachePerformanceMonitorService_1 = __decorate([
