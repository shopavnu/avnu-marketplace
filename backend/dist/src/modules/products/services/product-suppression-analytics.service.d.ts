...
export declare class ProductSuppressionAnalyticsService {
    ...
    constructor(productRepository: Repository<Product>, merchantRepository: Repository<Merchant>, categoryRepository: Repository<Category>);
    getSuppressionMetrics(period?: number, merchantId?: string): Promise<{
        overview: {
