...
let ProgressiveLoadingService = (ProgressiveLoadingService_1 = class ProgressiveLoadingService {
  ...
  async loadProgressively(options) {
    ...
    const {
      cursor,
      limit = 20,
      priority = progressive_loading_dto_1.LoadingPriority.HIGH,
      fullDetails = false,
      withMetadata = false,
      exclude = [],
    } = options;
    ...
    if (priority === progressive_loading_dto_1.LoadingPriority.HIGH) {
      ...
      priority === progressive_loading_dto_1.LoadingPriority.LOW ||
...
exports.ProgressiveLoadingService =
  ProgressiveLoadingService =
  ProgressiveLoadingService_1 =
    __decorate(
      [
