...
let DataNormalizationService = DataNormalizationService_1 = class DataNormalizationService {
    ...
    extractWooCommerceBrand(wooProduct) {
        ...
        if (wooProduct.meta_data) {
            const brandMeta = wooProduct.meta_data.find(meta => meta.key.toLowerCase() === 'brand' || meta.key.toLowerCase() === '_brand');
            if (brandMeta) {
...
exports.DataNormalizationService = DataNormalizationService = DataNormalizationService_1 = __decorate([
