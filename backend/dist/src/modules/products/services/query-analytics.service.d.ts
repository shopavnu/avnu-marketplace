...
export declare class QueryAnalyticsService {
    ...
    constructor(eventEmitter: EventEmitter2, configService: ConfigService, cacheService: ResilientCacheService);
    ...
    recordQuery(queryPattern: string, filters: Record<string, any>, executionTime: number, resultCount: number): void;
}
export {};
