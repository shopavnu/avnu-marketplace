...
let BulkImportController = BulkImportController_1 = class BulkImportController {
    ...
    async processExistingProducts(processDto) {
        ...
        return this.bulkImportService.processExistingProducts(processDto.productIds, processDto.options);
    }
};
...
], BulkImportController.prototype, "importProducts", null);
__decorate([
    (0, common_1.Post)('import/shopify'),
    (0, swagger_1.ApiOperation)({ summary: 'Import products from Shopify' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Shopify products imported successfully' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Bad request' }),
    ...
    __metadata("design:returntype", Promise)
], BulkImportController.prototype, "importFromShopify", null);
__decorate([
    (0, common_1.Post)('import/woocommerce'),
    (0, swagger_1.ApiOperation)({ summary: 'Import products from WooCommerce' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'WooCommerce products imported successfully' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Bad request' }),
    (0, swagger_1.ApiBody)({ type: SourceImportDto }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [SourceImportDto]),
    __metadata("design:returntype", Promise)
], BulkImportController.prototype, "importFromWooCommerce", null);
__decorate([
    ...
    __metadata("design:paramtypes", [SourceImportDto]),
    __metadata("design:returntype", Promise)
], BulkImportController.prototype, "importFromEtsy", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], BulkImportController.prototype, "validateProducts", null);
__decorate([
    (0, common_1.Patch)('process'),
    (0, swagger_1.ApiOperation)({ summary: 'Process existing products to ensure data consistency' }),
    ...
    __metadata("design:returntype", Promise)
], BulkImportController.prototype, "processExistingProducts", null);
