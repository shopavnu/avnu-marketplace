...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'limit', description: 'Maximum number of products to return', required: false }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'List of suppressed products for the merchant' }),
    __param(0, (0, common_1.Param)('merchantId')),
    __param(1, (0, common_1.Query)('limit')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], MerchantProductsController.prototype, "getSuppressedProducts", null);
