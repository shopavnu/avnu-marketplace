...
import { ProgressiveLoadingDto, ProgressiveLoadingResponseDto } from '../dto/progressive-loading.dto';
...
export declare class ProgressiveLoadingController {
    ...
    constructor(progressiveLoadingService: ProgressiveLoadingService, dataNormalizationService: DataNormalizationService);
    ...
    loadMoreWithExclusions(options: ProgressiveLoadingDto): Promise<ProgressiveLoadingResponseDto<any>>;
}
