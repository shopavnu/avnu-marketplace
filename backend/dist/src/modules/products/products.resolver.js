...
UpdateProductInput = __decorate([(0, graphql_1.InputType)()], UpdateProductInput);
...
__decorate(
  [
    ...
    __param(
      0,
      (0, graphql_1.Args)('products', { type: () => [create_product_dto_1.CreateProductDto] }),
    ),
    __metadata('design:type', Function),
