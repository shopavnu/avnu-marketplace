...
__decorate([
    (0, graphql_1.Field)(),
    (0, swagger_1.ApiProperty)({ example: 'Handcrafted Ceramic Mug', description: 'Product title' }),
...
__decorate([
    ...
    (0, swagger_1.ApiProperty)({ example: 39.99, required: false, description: 'Original price for comparison' }),
    (0, class_validator_1.IsNumber)({ maxDecimalPlaces: 2 }),
    (0, class_validator_1.Min)(0),
...
__decorate([
    (0, graphql_1.Field)(() => [String]),
    (0, swagger_1.ApiProperty)({ example: ['Home', 'Kitchenware'], description: 'Product categories' }),
    (0, class_validator_1.IsArray)(),
    (0, class_validator_1.IsString)({ each: true }),
...
__decorate([
    (0, graphql_1.Field)(() => [String], { nullable: true }),
    (0, swagger_1.ApiProperty)({ example: ['ceramic', 'handmade'], required: false, description: 'Product tags' }),
    (0, class_validator_1.IsArray)(),
    (0, class_validator_1.IsString)({ each: true }),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Array)
...
__decorate([
    ...
    (0, swagger_1.ApiProperty)({ example: true, default: true, description: 'Product active status' }),
...
__decorate([
    (0, graphql_1.Field)({ defaultValue: true }),
    (0, swagger_1.ApiProperty)({ example: true, default: true, description: 'Product stock status' }),
    (0, class_validator_1.IsBoolean)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Boolean)
...
__decorate([
    ...
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Array)
], CreateProductDto.prototype, "values", void 0);
__decorate([
    (0, graphql_1.Field)(),
...
__decorate([
    (0, graphql_1.Field)(),
    (0, swagger_1.ApiProperty)({ example: 'shopify', description: 'External source (e.g., shopify, woocommerce)' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)({ message: 'External source is required' }),
    __metadata("design:type", String)
], CreateProductDto.prototype, "externalSource", void 0);
