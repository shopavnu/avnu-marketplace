...
export declare class CachePerformanceResolver {
    ...
    constructor(cachePerformanceMonitorService: CachePerformanceMonitorService, cacheWarmingService: CacheWarmingService, productCacheService: ProductCacheService, resilientCacheService: ResilientCacheService);
