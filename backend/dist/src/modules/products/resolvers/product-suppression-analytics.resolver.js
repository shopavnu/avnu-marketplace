...
__decorate(
  ...
  ProductSuppressionAnalyticsResolver.prototype,
  'suppressionMetrics',
  null,
);
...
__decorate(
  [(0, graphql_2.Field)(() => graphql_2.Int), __metadata('design:type', Number)],
  SuppressionOverview.prototype,
...
__decorate(
  [(0, graphql_2.Field)(() => graphql_2.Float), __metadata('design:type', Number)],
  SuppressionOverview.prototype,
...
SuppressionOverview = __decorate([(0, graphql_2.ObjectType)()], SuppressionOverview);
let MerchantSuppressionMetrics = class MerchantSuppressionMetrics {};
__decorate(
  [(0, graphql_2.Field)(), __metadata('design:type', String)],
  MerchantSuppressionMetrics.prototype,
  'merchantId',
  void 0,
);
__decorate(
...
MerchantSuppressionMetrics = __decorate([(0, graphql_2.ObjectType)()], MerchantSuppressionMetrics);
let CategorySuppressionMetrics = class CategorySuppressionMetrics {};
__decorate(
  [(0, graphql_2.Field)(), __metadata('design:type', String)],
  CategorySuppressionMetrics.prototype,
  'categoryId',
  void 0,
);
__decorate(
...
CategorySuppressionMetrics = __decorate([(0, graphql_2.ObjectType)()], CategorySuppressionMetrics);
let TimeframeSuppressionMetrics = class TimeframeSuppressionMetrics {};
__decorate(
  [(0, graphql_2.Field)(), __metadata('design:type', String)],
  TimeframeSuppressionMetrics.prototype,
  'date',
  void 0,
);
__decorate(
...
__decorate(
  [(0, graphql_2.Field)(), __metadata('design:type', String)],
  ResolutionTimeDistribution.prototype,
  'timeRange',
  void 0,
);
__decorate(
...
ResolutionTimeDistribution = __decorate([(0, graphql_2.ObjectType)()], ResolutionTimeDistribution);
let SuppressionMetricsResponse = class SuppressionMetricsResponse {};
__decorate(
  [(0, graphql_2.Field)(() => SuppressionOverview), __metadata('design:type', SuppressionOverview)],
  SuppressionMetricsResponse.prototype,
  'overview',
  void 0,
);
__decorate(
  [(0, graphql_2.Field)(() => [MerchantSuppressionMetrics]), __metadata('design:type', Array)],
  SuppressionMetricsResponse.prototype,
  'byMerchant',
  void 0,
);
__decorate(
  [(0, graphql_2.Field)(() => [CategorySuppressionMetrics]), __metadata('design:type', Array)],
  SuppressionMetricsResponse.prototype,
  'byCategory',
  void 0,
);
__decorate(
  [(0, graphql_2.Field)(() => [TimeframeSuppressionMetrics]), __metadata('design:type', Array)],
  SuppressionMetricsResponse.prototype,
  'byTimeframe',
  void 0,
);
__decorate(
  [(0, graphql_2.Field)(() => [ResolutionTimeDistribution]), __metadata('design:type', Array)],
  SuppressionMetricsResponse.prototype,
  'resolutionTimeDistribution',
  void 0,
);
SuppressionMetricsResponse = __decorate([(0, graphql_2.ObjectType)()], SuppressionMetricsResponse);
