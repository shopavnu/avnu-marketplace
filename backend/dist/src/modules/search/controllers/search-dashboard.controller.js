...
let SearchDashboardController = SearchDashboardController_1 = class SearchDashboardController {
    ...
    async getTopSearchQueries(limit, timeframe) {
        this.logger.log(`Fetching top search queries for timeframe: ${timeframe || 'default'}, limit: ${limit || 'default'}`);
        try {
    ...
    async getZeroResultQueries(limit, timeframe) {
        this.logger.log(`Fetching zero-result queries for timeframe: ${timeframe || 'default'}, limit: ${limit || 'default'}`);
        try {
            const periodInDays = parseTimeframeToDays(timeframe);
...
], SearchDashboardController.prototype, "getPerformanceStats", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], SearchDashboardController.prototype, "getRelevanceMetrics", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], SearchDashboardController.prototype, "getTopSearchQueries", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number, String]),
    __metadata("design:returntype", Promise)
], SearchDashboardController.prototype, "getZeroResultQueries", null);
__decorate([
    (0, common_1.Get)('entity-distribution'),
    (0, swagger_1.ApiOperation)({ summary: 'Get entity distribution in search results' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Returns entity distribution in search results' }),
    (0, swagger_1.ApiQuery)({ name: 'timeframe', enum: ['day', 'week', 'month'], required: false }),
    __param(0, (0, common_1.Query)('timeframe')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], SearchDashboardController.prototype, "getEntityDistribution", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], SearchDashboardController.prototype, "getSearchConversionRate", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], SearchDashboardController.prototype, "getExperiments", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], SearchDashboardController.prototype, "getExperiment", null);
__decorate([
    (0, common_1.Get)('experiments/:id/results'),
    (0, swagger_1.ApiOperation)({ summary: 'Get results for a specific search experiment' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Returns results for the specified search experiment' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], SearchDashboardController.prototype, "getExperimentResults", null);
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], SearchDashboardController.prototype, "getHealthStatus", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], SearchDashboardController.prototype, "getSearchPaths", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], SearchDashboardController.prototype, "getSearchRefinements", null);
__decorate([
    (0, common_1.Get)('analytics/value-alignment'),
    (0, swagger_1.ApiOperation)({ summary: 'Get value alignment metrics in search' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Returns value alignment metrics in search' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], SearchDashboardController.prototype, "getValueAlignmentMetrics", null);
exports.SearchDashboardController = SearchDashboardController = SearchDashboardController_1 = __decorate([
