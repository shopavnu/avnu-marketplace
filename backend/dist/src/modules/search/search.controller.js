...
let SearchController = class SearchController {
    ...
    searchProducts(query, paginationDto, categories, priceMin, priceMax, merchantId, inStock, values, brandName, sortField, sortOrder) {
        const filters = {
            categories,
            priceMin,
            priceMax,
...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'values', required: false, isArray: true, description: 'Filter by values' }),
    (0, swagger_1.ApiQuery)({ name: 'brandName', required: false, description: 'Filter by brand name' }),
    (0, swagger_1.ApiQuery)({ name: 'sortField', required: false, description: 'Field to sort by' }),
    (0, swagger_1.ApiQuery)({
        name: 'sortOrder',
        required: false,
        enum: ['asc', 'desc'],
    ...
    __metadata("design:paramtypes", [String, pagination_dto_1.PaginationDto, Array, Number, Number, String, Boolean, Array, String, String, String]),
...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'limit', required: false, description: 'Number of suggestions to return' }),
    __param(0, (0, common_1.Query)('query')),
    __param(1, (0, common_1.Query)('limit')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Number]),
    __metadata("design:returntype", void 0)
], SearchController.prototype, "getProductSuggestions", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String, Number]),
    __metadata("design:returntype", void 0)
], SearchController.prototype, "getRelatedProducts", null);
__decorate([
...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'userId', required: false, description: 'User ID for personalization' }),
    (0, swagger_1.ApiQuery)({ name: 'limit', required: false, description: 'Number of products to return' }),
    (0, swagger_1.ApiQuery)({ name: 'values', required: false, isArray: true, description: 'Values to prioritize' }),
    ...
    __metadata("design:returntype", void 0)
], SearchController.prototype, "getDiscoveryProducts", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], SearchController.prototype, "naturalLanguageSearch", null);
__decorate([
    (0, common_1.Get)('all'),
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], SearchController.prototype, "reindexAllProducts", null);
