...
], SearchFiltersInput.prototype, "categories", void 0);
__decorate([
    (0, graphql_1.Field)(() => graphql_1.Float, { nullable: true }),
    __metadata("design:type", Number)
], SearchFiltersInput.prototype, "priceMin", void 0);
__decorate([
    (0, graphql_1.Field)(() => graphql_1.Float, { nullable: true }),
    __metadata("design:type", Number)
], SearchFiltersInput.prototype, "priceMax", void 0);
__decorate([
    (0, graphql_1.Field)({ nullable: true }),
    __metadata("design:type", String)
], SearchFiltersInput.prototype, "merchantId", void 0);
__decorate([
    (0, graphql_1.Field)({ nullable: true }),
    __metadata("design:type", Boolean)
], SearchFiltersInput.prototype, "inStock", void 0);
__decorate([
    (0, graphql_1.Field)(() => [String], { nullable: true }),
    __metadata("design:type", Array)
], SearchFiltersInput.prototype, "values", void 0);
__decorate([
    (0, graphql_1.Field)({ nullable: true }),
    __metadata("design:type", String)
], SearchFiltersInput.prototype, "brandName", void 0);
SearchFiltersInput = __decorate([
...
__decorate([
    ...
    __metadata("design:type", Array)
], MerchantPaginatedResponse.prototype, "items", void 0);
__decorate([
    (0, graphql_1.Field)(() => graphql_1.Int),
    __metadata("design:type", Number)
], MerchantPaginatedResponse.prototype, "total", void 0);
MerchantPaginatedResponse = __decorate([
...
__decorate([
    ...
    __metadata("design:type", Array)
], BrandPaginatedResponse.prototype, "items", void 0);
__decorate([
    (0, graphql_1.Field)(() => graphql_1.Int),
    __metadata("design:type", Number)
], BrandPaginatedResponse.prototype, "total", void 0);
BrandPaginatedResponse = __decorate([
    (0, graphql_1.ObjectType)()
...
let SearchResolver = class SearchResolver {
    ...
    searchProducts(query, paginationDto, filters, sort) {
        return this.searchService.searchProducts(query, paginationDto || { page: 1, limit: 10 }, filters, sort);
    }
...
], SearchResolver.prototype, "searchProducts", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], SearchResolver.prototype, "getProductSuggestions", null);
__decorate([
    (0, graphql_1.Query)(() => [search_response_dto_1.ProductSearchResult], { name: 'relatedProducts' }),
    __param(0, (0, graphql_1.Args)('productId', { type: () => graphql_1.ID })),
    __param(1, (0, graphql_1.Args)('limit', { type: () => graphql_1.Int, nullable: true })),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Number]),
    __metadata("design:returntype", void 0)
], SearchResolver.prototype, "getRelatedProducts", null);
__decorate([
    (0, graphql_1.Query)(() => [search_response_dto_1.ProductSearchResult], { name: 'trendingProducts' }),
    __param(0, (0, graphql_1.Args)('limit', { type: () => graphql_1.Int, nullable: true })),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", void 0)
], SearchResolver.prototype, "getTrendingProducts", null);
__decorate([
    (0, graphql_1.Query)(() => [search_response_dto_1.ProductSearchResult], { name: 'discoveryProducts' }),
    ...
    __metadata("design:returntype", void 0)
], SearchResolver.prototype, "getDiscoveryProducts", null);
__decorate([
    (0, graphql_1.Query)(() => product_paginated_dto_1.ProductPaginatedResponse, { name: 'naturalLanguageSearch' }),
    __param(0, (0, graphql_1.Args)('query')),
    __param(1, (0, graphql_1.Args)('pagination', { nullable: true })),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, pagination_dto_1.PaginationDto]),
    __metadata("design:returntype", void 0)
], SearchResolver.prototype, "naturalLanguageSearch", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String, pagination_dto_1.PaginationDto]),
    __metadata("design:returntype", void 0)
], SearchResolver.prototype, "searchAll", null);
__decorate([
...
], SearchResolver.prototype, "reindexAllProducts", null);
