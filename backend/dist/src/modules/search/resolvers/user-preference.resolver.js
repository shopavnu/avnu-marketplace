...
__decorate(
  [
    ...
    __param(
      ...
      (0, graphql_1.Args)('filters', {
        nullable: true,
        type: () => search_filters_input_1.SearchFiltersInput,
      }),
    ),
  ...
  UserPreferenceResolver.prototype,
  'trackSearch',
  null,
);
__decorate(
...
__decorate(
  [
    ...
    __param(
      1,
      (0, graphql_1.Args)('filters', { type: () => search_filters_input_1.SearchFiltersInput }),
    ),
    __metadata('design:type', Function),
    __metadata('design:paramtypes', [
      user_entity_1.User,
