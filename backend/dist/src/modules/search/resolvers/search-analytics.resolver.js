...
], TrackSearchEventResponse.prototype, "success", void 0);
TrackSearchEventResponse = __decorate([
...
let SearchAnalyticsResolver = SearchAnalyticsResolver_1 = class SearchAnalyticsResolver {
    ...
    async trackSearchEvent(event, user) {
        try {
            const success = await this.searchAnalyticsService.trackEvent(event.eventType, event.data || {}, user);
            return { success };
        }
        catch (error) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [search_event_input_1.SearchEventInput,
        user_entity_1.User]),
    __metadata("design:returntype", Promise)
], SearchAnalyticsResolver.prototype, "trackSearchEvent", null);
exports.SearchAnalyticsResolver = SearchAnalyticsResolver = SearchAnalyticsResolver_1 = __decorate([
