...
__decorate([
    (0, graphql_1.Query)(() => search_response_type_1.SearchResponseType, { name: 'discoverySearch' }),
...
], DiscoverySearchResolver.prototype, "discoverySearch", null);
__decorate([
    (0, graphql_1.Query)(() => discovery_suggestions_type_1.DiscoverySuggestionsType, { name: 'discoverySuggestions' }),
    __param(0, (0, graphql_1.Args)('query')),
    __param(1, (0, graphql_1.Args)('limit', { nullable: true })),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Number]),
    __metadata("design:returntype", Promise)
], DiscoverySearchResolver.prototype, "discoverySuggestions", null);
__decorate([
    (0, graphql_1.Query)(() => discovery_homepage_type_1.DiscoveryHomepageType, { name: 'discoveryHomepage' }),
    __param(0, (0, graphql_1.Context)()),
    __param(1, (0, graphql_1.Args)('options', { type: () => search_options_dto_1.SearchOptionsInput, nullable: true })),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, search_options_dto_1.SearchOptionsInput]),
    __metadata("design:returntype", Promise)
], DiscoverySearchResolver.prototype, "discoveryHomepage", null);
