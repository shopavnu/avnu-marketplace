...
let ElasticsearchConfigModule = class ElasticsearchConfigModule {
    ...
    async onModuleInit() {
        try {
            ...
            this.logger.error(`Failed to initialize Elasticsearch indices: ${error.message}`, error.stack);
        }
    }
};
...
exports.ElasticsearchConfigModule = ElasticsearchConfigModule = __decorate([
    ...
    __metadata("design:paramtypes", [indices_config_1.IndicesConfigService,
