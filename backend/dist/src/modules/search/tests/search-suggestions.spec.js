...
describe('Search Suggestions', () => {
    ...
    beforeEach(async () => {
        ...
        const module = await testing_1.Test.createTestingModule({
            providers: [
                ...
                { provide: personalization_service_1.PersonalizationService, useValue: personalizationMock },
                { provide: analytics_service_1.AnalyticsService, useValue: analyticsMock },
                { provide: config_1.ConfigService, useValue: configMock },
                { provide: common_1.Logger, useValue: { log: jest.fn(), error: jest.fn(), warn: jest.fn() } },
            ],
        }).compile();
    ...
    describe('Advanced Features', () => {
        it('should respect category filters', async () => {
            ...
            expect(elasticsearchService.search).toHaveBeenCalledWith(expect.objectContaining({
            ...
            expect(analyticsService.getPopularSearches).toHaveBeenCalledWith('test', expect.any(Number), ['clothing'], expect.any(Number));
        });
        it('should track suggestion requests', async () => {
            ...
            expect(analyticsService.trackEngagement).toHaveBeenCalledWith(expect.objectContaining({
