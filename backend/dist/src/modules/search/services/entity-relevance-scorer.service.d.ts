...
export declare class EntityRelevanceScorerService {
    ...
    applyEntityBoosting(results: any, entityType: SearchEntityType, entityBoosting?: EntityBoostingDto): any;
    private calculateUserEntityBoosts;
    enhanceQueryWithEntityBoosting(baseQuery: any, entityType: SearchEntityType, entityBoosting?: EntityBoostingDto): any;
