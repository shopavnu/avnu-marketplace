...
export declare class RelatedProductsService {
    ...
    constructor(elasticsearchService: ElasticsearchService, personalizationService: PersonalizationService);
    getRelatedProducts(productId: string, userId?: string, options?: {
        limit?: number;
