...
export declare class NlpSearchService {
    ...
    constructor(elasticsearchService: ElasticsearchService, configService: ConfigService, nlpService: NlpService, searchCacheService: SearchCacheService, searchMonitoringService: SearchMonitoringService, personalizationService: PersonalizationService, experimentAssignmentService: ExperimentAssignmentService, searchExperimentService: SearchExperimentService);
    private getDefaultHighlightFields;
    private processHighlights;
    searchAsync(options: SearchOptionsInput, user?: User, sessionId?: string): Promise<SearchResponseDto>;
    private processQuery;
    private buildElasticsearchQuery;
    private buildAggregations;
    private getIndexForEntityType;
    searchProducts(query: string, options?: Partial<SearchOptionsInput>, _user?: User): Promise<Pick<SearchResponseDto, 'products' | 'pagination' | 'facets'>>;
    searchMerchants(query: string, options?: Partial<SearchOptionsInput>, _user?: User): Promise<Pick<SearchResponseDto, 'merchants' | 'pagination' | 'facets'>>;
    searchBrands(query: string, options?: Partial<SearchOptionsInput>, _user?: User): Promise<Pick<SearchResponseDto, 'brands' | 'pagination' | 'facets'>>;
