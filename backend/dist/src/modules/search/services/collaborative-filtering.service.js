...
let CollaborativeFilteringService =
  (CollaborativeFilteringService_1 = class CollaborativeFilteringService {
    ...
    async applyCollaborativeBoosts(query, userId, boostStrength = 1.0) {
      try {
        ...
        this.logger.error(
          `Error applying collaborative boosts for user ${userId}: ${error.message}`,
        );
        return query;
      }
    }
...
exports.CollaborativeFilteringService =
  CollaborativeFilteringService =
  CollaborativeFilteringService_1 =
    __decorate(
      [
