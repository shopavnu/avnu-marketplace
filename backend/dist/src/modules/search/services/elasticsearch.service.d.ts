...
export declare class ElasticsearchService implements OnModuleInit {
    ...
    buildProductSearchQuery(query: string, filters?: {
        categories?: string[];
        priceMin?: number;
        priceMax?: number;
        merchantId?: string;
    ...
    searchMerchants(query: string, page?: number, limit?: number): Promise<{
        items: any[];
        total: number;
    }>;
    ...
    updateDocument(index: string, id: string, body: any, refresh?: boolean | 'wait_for'): Promise<any>;
    ...
    createIndex(index: string, mappings?: Record<string, any>, settings?: Record<string, any>): Promise<any>;
