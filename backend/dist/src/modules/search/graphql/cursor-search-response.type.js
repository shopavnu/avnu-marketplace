...
exports.CursorSearchResultUnion = (0, graphql_1.createUnionType)({
  ...
  types: () => [
    search_response_type_1.ProductResultType,
    search_response_type_1.MerchantResultType,
    search_response_type_1.BrandResultType,
  ],
  resolveType(value) {
    if (value.title) {
...
__decorate(
  ...
  CursorSearchResponseType.prototype,
  'query',
  void 0,
);
__decorate(
...
__decorate(
  [(0, graphql_1.Field)(() => [exports.CursorSearchResultUnion]), __metadata('design:type', Array)],
  CursorSearchResponseType.prototype,
  'results',
  void 0,
);
