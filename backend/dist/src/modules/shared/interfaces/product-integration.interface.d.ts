...
export interface ProductIntegrationService {
    ...
    updateProduct(productId: string, productUpdate: Partial<PlatformProductDto>, merchantId: string): Promise<PlatformProductDto>;
    ...
    processIncomingProduct(product: Record<string, unknown>, platformType: PlatformType, merchantId: string): PlatformProductDto;
    prepareOutgoingProduct(product: PlatformProductDto, platformType: PlatformType): Record<string, unknown>;
}
