...
let KeyboardNavigationResolver = class KeyboardNavigationResolver {
    ...
    async saveUserShortcut(userId, name, description, key, altKey, ctrlKey, shiftKey, metaKey, action, route, sectionId) {
    ...
    async createNavigationSection(name, route, selector, priority, description, ariaLabel, parentSectionId, childSelectors) {
    ...
    async updateNavigationSection(id, name, route, selector, priority, description, ariaLabel, parentSectionId, childSelectors, isActive) {
...
], KeyboardNavigationResolver.prototype, "navigationSections", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], KeyboardNavigationResolver.prototype, "keyboardShortcuts", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], KeyboardNavigationResolver.prototype, "lastFocusState", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], KeyboardNavigationResolver.prototype, "saveFocusState", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", Promise)
], KeyboardNavigationResolver.prototype, "clearFocusStates", null);
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String, String, Boolean, Boolean, Boolean, Boolean, String, String, String]),
    __metadata("design:returntype", Promise)
], KeyboardNavigationResolver.prototype, "saveUserShortcut", null);
__decorate([
    (0, graphql_1.Mutation)(() => Boolean),
    __param(0, (0, graphql_1.Args)('userId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], KeyboardNavigationResolver.prototype, "resetUserShortcuts", null);
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String, Number, String, String, String, Array]),
    __metadata("design:returntype", Promise)
], KeyboardNavigationResolver.prototype, "createNavigationSection", null);
__decorate([
    (0, graphql_1.Mutation)(() => navigation_section_entity_1.NavigationSection),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String, String, Number, String, String, String, Array, Boolean]),
    __metadata("design:returntype", Promise)
], KeyboardNavigationResolver.prototype, "updateNavigationSection", null);
__decorate([
    (0, graphql_1.Mutation)(() => Boolean),
    __param(0, (0, graphql_1.Args)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], KeyboardNavigationResolver.prototype, "deleteNavigationSection", null);
