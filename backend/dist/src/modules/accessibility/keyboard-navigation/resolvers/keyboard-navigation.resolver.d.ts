...
export declare class KeyboardNavigationResolver {
    ...
    saveFocusState(userId: string, sessionId: string, route: string, sectionId: string, elementId?: string, elementSelector?: string, context?: string): Promise<FocusState>;
    clearFocusStates(userId: string, sessionId: string): Promise<boolean>;
    saveUserShortcut(userId: string, name: string, description: string, key: string, altKey?: boolean, ctrlKey?: boolean, shiftKey?: boolean, metaKey?: boolean, action?: string, route?: string, sectionId?: string): Promise<KeyboardShortcut>;
    resetUserShortcuts(userId: string): Promise<boolean>;
    createNavigationSection(name: string, route: string, selector: string, priority: number, description?: string, ariaLabel?: string, parentSectionId?: string, childSelectors?: string[]): Promise<NavigationSection>;
    updateNavigationSection(id: string, name?: string, route?: string, selector?: string, priority?: number, description?: string, ariaLabel?: string, parentSectionId?: string, childSelectors?: string[], isActive?: boolean): Promise<NavigationSection>;
