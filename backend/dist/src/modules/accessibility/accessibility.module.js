...
const keyboard_navigation_module_1 = require("./keyboard-navigation/keyboard-navigation.module");
...
exports.AccessibilityModule = AccessibilityModule = __decorate([
    (0, common_1.Module)({
        imports: [keyboard_navigation_module_1.KeyboardNavigationModule],
        exports: [keyboard_navigation_module_1.KeyboardNavigationModule],
    })
], AccessibilityModule);
