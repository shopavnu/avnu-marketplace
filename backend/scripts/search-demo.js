...
const products = [
  {
    ...
    description: 'Powerful laptop for professionals with excellent battery life',
    price: 2499,
    brandName: 'Apple',
    categories: ['laptops', 'electronics'],
    tags: ['premium', 'professional'],
    values: ['16GB RAM', '1TB SSD', 'M1 Pro'],
  },
  {
    id: '2',
    title: 'Dell XPS 15',
    ...
    categories: ['laptops', 'electronics'],
    tags: ['premium', 'professional'],
    values: ['16GB RAM', '512GB SSD', 'Intel i7'],
  },
  {
    id: '3',
    title: 'ASUS ROG Strix G15 Gaming Laptop',
    description: 'Powerful gaming laptop with RGB lighting and high refresh rate',
    price: 1299,
    brandName: 'ASUS',
    categories: ['laptops', 'gaming', 'electronics'],
    tags: ['gaming', 'performance'],
    values: ['16GB RAM', '1TB SSD', 'RTX 3070'],
  },
  {
    id: '4',
    ...
    price: 1599,
    brandName: 'Lenovo',
    categories: ['laptops', 'business', 'electronics'],
  ...
  },
  {
    ...
    description: 'Affordable gaming laptop with powerful graphics',
    price: 1199,
    brandName: 'Acer',
    categories: ['laptops', 'gaming', 'electronics'],
    tags: ['gaming', 'budget'],
    values: ['16GB RAM', '512GB SSD', 'RTX 3060'],
  },
  {
    id: '6',
    ...
    price: 1399,
    brandName: 'HP',
    categories: ['laptops', 'convertible', 'electronics'],
    tags: ['premium', 'touchscreen'],
    values: ['16GB RAM', '512GB SSD', 'Intel i7'],
  },
  {
    id: '7',
    title: 'Microsoft Surface Laptop 4',
    description: 'Sleek and lightweight laptop with excellent display',
    price: 1299,
    brandName: 'Microsoft',
    categories: ['laptops', 'electronics'],
    tags: ['premium', 'lightweight'],
    values: ['16GB RAM', '512GB SSD', 'AMD Ryzen'],
  },
  {
    id: '8',
    ...
    categories: ['laptops', 'gaming', 'electronics'],
    tags: ['premium', 'gaming'],
    values: ['16GB RAM', '1TB SSD', 'RTX 3080'],
  },
  {
    id: '9',
    ...
    brandName: 'Apple',
    categories: ['laptops', 'electronics'],
    tags: ['lightweight', 'portable'],
    values: ['8GB RAM', '256GB SSD', 'M2'],
  },
  {
    id: '10',
    title: 'MSI GS66 Stealth Gaming Laptop',
    description: 'Powerful gaming laptop with sleek design',
    price: 1799,
    brandName: 'MSI',
    categories: ['laptops', 'gaming', 'electronics'],
    tags: ['gaming', 'premium'],
    values: ['32GB RAM', '1TB SSD', 'RTX 3070'],
  },
];
...
function enhancedSearch(query, products, userPreferences = null) {
  ...
  if (brandEntity) {
    filteredProducts = filteredProducts.filter(
      p => p.brandName.toLowerCase() === brandEntity.value.toLowerCase(),
    );
  }
  ...
  const results = filteredProducts
    .map(product => {
      ...
      const baseScore = titleMatches * 3 + descriptionMatches * 1;

      // Intent-based scoring
      let intentScore = 0;
      if (
        intent === 'gaming' &&
        (product.categories.includes('gaming') || product.tags.includes('gaming'))
      ) {
        intentScore += 5;
      } else if (
        intent === 'business' &&
        ...
        intent === 'portable' &&
        (product.tags.includes('lightweight') || product.tags.includes('portable'))
      ) {
        intentScore += 5;
      }
      ...
      for (const entity of entities) {
        if (entity.type === 'category' && product.categories.includes(entity.value)) {
          entityScore += 3;
        }
...
function displayResults(results, limit = 5) {
  ...
  results.slice(0, limit).forEach((product, index) => {
    ...
    if (product.scoreBreakdown) {
      console.log(
        `   Score Breakdown: Base=${product.scoreBreakdown.base.toFixed(2)}, ` +
